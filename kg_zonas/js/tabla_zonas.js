...
// listar datos en la tabla de comisiones
		var listar = function(){
			...
			obtener_data_editar("#dt_zonas tbody", table);
			obtener_id_eliminar("#dt_zonas tbody", table);
		}
// editamos estado civil
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				var data = table.row( $(this).parents("tr") ).data();
				var id_zona = $("#frmedit #idzona").val( data.id_zona),
					   desc_zona = $("#frmedit #edit1").val( data.desc_zona),
...
// eliminndo la comision
		var obtener_id_eliminar = function(tbody, table){
			$(tbody).on("click", "button.eliminar", function(){
				var data = table.row( $(this).parents("tr") ).data();
				var id_zona = $("#frmEliminarzona #idzona").val( data.id_zona);
				 desc_zona =$("#frmEliminarzona #zona").val(data.desc_zona);
