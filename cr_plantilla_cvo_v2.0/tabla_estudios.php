...
<head><meta charset="UTF-8"">
	...
	<title>Plantilla Cultivos</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  include("formularios/formularios_estudio.php"); // CAMBIO programa de la forma
  ?>

  	<div class="container" style="margin-top: 20px;">
      	<h1>Estudios de Plantilla Cultivos  <!-- CAMBIO Se cambia el titulo de la tabla -->
          	<button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals" style="float: right;"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nuevo Estudio</button> <!-- CAMBIO Se cambia el boton de altas -->
      	</h1>
  	</div>
	...
	<script language="javascript" src="js/tabla_estudios.js"></script> <!-- CAMBIO este JS -->
	<script>
