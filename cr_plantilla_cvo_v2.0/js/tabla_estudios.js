				...
				"columns":[
					...
					//{"defaultContent": "<button type='button' class='editar btn btn-primary' data-toggle='modal' data-target='#modalEditar'><i class='fas fa-edit'></i></button>"},
					{
						render:function(data,type,row){
							...
							"<a id='printer'  href='../cr_plantilla_cvo_v2.0/tabla_plantilla_1.php?studio="+row['id_estudio']+"' class='btn btn-success btn-md' role='button'><span class='fas fa-edit' style='color: white;'></span></a>"+
							"</form-group>";
						},
					...
					//{"defaultContent":"<button type='button' class='eliminar btn btn-danger'><i class='fas fa-print'></i></button>"}
					{
						...
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='./reports/print_result_cvo.php?studio="+row['id_estudio']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
