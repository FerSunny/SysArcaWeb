...
<head>
  ...
  <title>Piezas</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <?php
    ...
    include("formularios/formularios_equipo_pza.php"); // CAMBIO programa de la forma
  ...
  <div class="container" style="margin-top: 30px;">
    ...
    <h1 style="text-align: center;">Tabla de Piezas  <!-- CAMBIO Se cambia el titulo de la tabla -->

      <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nueva Pieza</button> <!-- CAMBIO Se cambia el boton de altas -->

    </h1>

    <h3 style="text-align: center;">Servicio para el equipo:  <?php echo $equipo ?>  </h3> <!-- CAMBIO Se cambia el titulo de la tabla -->
    <h4 style="text-align: center;">Servicio ID:  <?php echo $id_manto ?>  </h3>
  ...
  <script language="javascript" src="js/tabla_equipo_pza.js"></script>
