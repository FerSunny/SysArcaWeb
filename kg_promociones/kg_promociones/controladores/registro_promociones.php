...
$query = "INSERT INTO kg_promociones(fk_empresa,desc_promocion,porcentaje,fecha_inicio,fecha_final,lunes,martes,miercoles,jueves,viernes,sabado,domingo,tuly,tuly2,greg,xochi,sant,pablo,pedro,teco,tete,estado) VALUES ('$empresa','$edit1','$edit3','$edit4','$edit5','$fn_lunes','$fn_martes','$fn_miercoles','$fn_jueves','$fn_viernes','$fn_sabado','$fn_domingo', '$fn_tul','$fn_tu2','$fn_gre','$fn_xoc','$fn_san','$fn_pab','$fn_tec','$fn_tet','$fn_ped','$edit2')";
