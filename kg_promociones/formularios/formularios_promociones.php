          ...
          <table>
            ...
            <div class="form-group row" align="">
              <div class="col-xs-8">
                ...
                <td><input type="text" class="form-control" id="edit3" required name="edit3"  maxlength="50" size="40" placeholder="Porcentaje"></td>
              </div>
            </div>
            </tr>
...
<!-- sucursal --> 
              <table>
                ...
                <tr>
                  ...
                  <th width="50" style="text-align:center;"  ><label>DiN</label></th>
                  <th width="50" style="text-align:center;"  ><label>Tla</label></th>
				  <th width="50" style="text-align:center;"  ><label>Mil</label></th>
                </tr>
                <tr>
                  <td style="text-align:center;">
                  ...
                  <td style="text-align:center;">
                      <select class="" name="fn_din" id="fi_din">
                        <option value="S">Si</option>
                        <option value="N">No</option>
                      </select>
                  </td>    
                  ...
                  <td style="text-align:center;">
                      <select class="" name="fn_tla" id="fi_tla">
                        <option value="S">Si</option>
                        <option value="N">No</option>
                      </select>
                  </td> 
                  <td style="text-align:center;">
                      <select class="" name="fn_mil" id="fi_mil">
                        <option value="S">Si</option>
                        <option value="N">No</option>
                      </select>
                  </td> 
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="opcion" name="opcion" value="modificar">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-8"><input id="edit3" name="edit3" maxkength="50" required type="text" class="form-control" ></div>
                    </div>
