				...
				"columns":[
					...
					{ "data": "participacion" },
					{
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='reports/participa_resumen_zona.php?id_zona="+row['id_zona']+"&periodo="+row['periodo']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					},
					{
						render:function(data,type,row){
							return "<form-group style='text-align:center;'>"+
							"<a id='printer' target='_blank' href='reports/recibos_pago_zona.php?id_zona="+row['id_zona']+"&periodo="+row['periodo']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					},
					{
						render:function(data,type,row){
							return "<form-group style='text-align:center;'>"+
							"<a id='printer' target='_blank' href='reports/participa_firmas_zona.php?id_zona="+row['id_zona']+"&periodo="+row['periodo']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					}
