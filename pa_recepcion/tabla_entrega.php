...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Reporte de ventas por recepcionista
        <!--
      ...
      <div class="form-group">
        ...
        <label class="font-weight-normal lead"><?php $periodo=date("F", strtotime('month')).'-'.date("o", strtotime('month')); echo $periodo ?></label>
      </div>
      -->
  </div>
        <div class="row">
