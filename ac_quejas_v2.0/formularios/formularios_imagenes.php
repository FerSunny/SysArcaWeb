<?php 
  ...
  $sql="SELECT  ui.id_imagen,ui.nombre FROM ac_quejas_img ui
        WHERE ui.fk_id_queja = ".$id_queja
        ;
//echo $sql;
  ...
  $imagen='img_quejas/'.$id_queja.'/'.$nombre;
   ...
   <form name="AltasEstudio" action="controladores/registro_imagenes.php" method="post" enctype="multipart/form-data" id="fileForms" >
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 style="color:blue;text-align:center" class="modal-title">Nuevas Imagenes</h2>
...
<!-- imagen, seleccion -->       
             <tr>
              Nota*** Por seguridad, solo se permite subir imagenes. No Ficheros PDF, convertirlo a imagen.
...
<!-- Nota -->              
              <div class="form-group">
                <label for="descripcion" class="col-sm-2 control-label">Id Queja</label>
                <div class="col-sm-8">
