		...
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				"columns":[
					...
					{"defaultContent": "<button type='button' disabled class='sigue btn btn-warning btn-md'><i class='fas fa-check'></i></button>"},
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_mejora)

				$("#frmedit  #pro").val(data.id_mejora)

				$("#frmedit  #codigo").val(data.id_mejora)

				$("#frmedit  #situacion").val(data.situacion)
				...
				$("#frmedit  #objetivo").val(data.objetivo)

				$("#frmedit  #doc").val(data.fk_id_boleana)
