...
// listar datos en la tabla de comisiones
		var listar = function(){
			...
			obtener_data_editar("#dt_dosis tbody", table);
			obtener_id_eliminar("#dt_dosis tbody", table);
		}
// editamos estado civil
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				var data = table.row( $(this).parents("tr") ).data();
				var id_dosis = $("#frmedit #id_dosis").val( data.id_dosis),
					   desc_dosificacion = $("#frmedit #fi_dosis").val( data.desc_dosificacion),
...
// eliminndo la comision
		var obtener_id_eliminar = function(tbody, table){
			$(tbody).on("click", "button.eliminar", function(){
				var data = table.row( $(this).parents("tr") ).data();
				var id_dosis= $("#frmEliminaredocivil #id_dosis").val( data.id_dosis );
				 desc_dosificacion =$("#frmEliminaredocivil #fi_dosis").val(data.desc_dosificacion);
