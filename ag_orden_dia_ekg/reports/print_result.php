...
// se aplicaron estos cambios, para poder mostrar la hoja sin resultados
// solicitado por marisol briceño 23marzo2022
      ...
      $fk_id_medico=''; 
//eof
$sql_usg="SELECT us.fk_id_medico, us.nombre_plantilla, us.titulo_desc, us.descripcion, us.firma 
FROM cr_plantilla_ekg_re us 
WHERE us.estado = 'A'
...
// Pie de página
  function Footer()
  {
    ...
    switch ($fk_id_medico) {
      case 178:
        $this->Image('../imagenes/firma_dr_omar_hernandez.jpg',82,225,70,0);
        break;
      case 165; //165:
        $this->Image('../imagenes/firma_dr_uriel_sanchez.jpg',77,215,75,0);
        break;
      case 185: //185:
        $this->Image('../imagenes/firma_dr_alvaro_martinez.jpg',77,215,75,0);
        break;
      case 164: //185:
        $this->Image('../imagenes/firma_dr_armando.jpg',77,215,75,0);
        break;
      case 282: //185:
        $this->Image('../imagenes/firma_dra_mariana.jpg',77,210,49,0);
        break;
    }
    //$this->Image('../imagenes/firma_dr_omar_hernandez.jpg',82,225,60,0);
