<?php
  ...
  $id_usr_login=$_SESSION['id_usuario'];
  
  //$id_usuario= ' = '.$_SESSION['id_usuario'];


  if ($fk_id_perfil==1 or $fk_id_perfil==45 or $fk_id_perfil==46 or $fk_id_perfil==33 or $fk_id_perfil==43) 
    {
        $agenda = ' ';
...
LEFT OUTER JOIN cr_plantilla_ekg_re p2 ON (p2.fk_id_factura = res.id_factura AND p2.fk_id_estudio = res.fk_id_estudio)
  ...
  SELECT 
  DISTINCT '".$fk_id_perfil."' as perfil,
  ' ".$id_usr_login."' as usr_login,
  fa.id_factura,
  df.fk_id_estudio,
  CASE
