    ...
    <div class="modal fade" id="resultado_usg" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel" style="size: 40%">
      <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          ...
          <div class="md-form">
            <!--Material textarea-->
              <textarea id="descripcion" name="descripcion" class="md-textarea form-control" rows="35" required=""></textarea>
...
-->
                <div class="md-form">
                  <textarea  class="md-textarea form-control"  name="firma" id="firma" rows="3" cols="50" wrap="hard"></textarea>
