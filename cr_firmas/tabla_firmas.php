...
<head>
	<meta charset="UTF-8">
	<title>Administracion de Firmas</title>
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Tabla de Firmas
          <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nueva Firma</button>
      </h1>
      <h5>Version 3.4.2 </h5>
  </div>
		<div class="row">
