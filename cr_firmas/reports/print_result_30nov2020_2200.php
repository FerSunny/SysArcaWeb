...
$sql_max="select max(num_imp) as num_imp FROM cr_plantilla_usg_re
...
if ($result = mysqli_query($con, $sql_max)) {
  while($row = $result->fetch_assoc())
  {
      $veces=$row['num_imp']+1;
      //echo $veces;
      $sql_update="UPDATE cr_plantilla_usg_re SET num_imp = '".$veces."'
      where fk_id_factura=".$numero_factura." and fk_id_estudio=".$studio;
      //echo $sql_update;
...
function Header()
{
    ...
    $this->Image('../imagenes/logo_lab.jpg',20,3,175,35);
    $this->Image('../imagenes/codigo3.png',179,60,20,20);
...
*/
   ...
   //$this->SetFillColor(230,230,0);
    ...
    $this->Cell(195,5,'BLVD San Buenaventura, Col. La Venta, Ixtapaluca EdoMex',0,0,'C');
    $this->Ln(3);
    $this->SetTextColor(0,0,255);
...
// Pie de página
  function Footer()
  {
    ...
    //$this->ln(10);
    $this->Cell($posiniv);
	  $this->Image('../imagenes/firmajoaquinramirez.jpg',77,225,40,0);
    ...
    $this->SetXY(40,257); 
    $this->Write(0,'www.estudioscliniosanbuenaventura.com.mx');

    $this->Image('../../imagenes/whatsapp.jpg',10,262,7,0);
    $this->SetTextColor(27,94,32); 
    $this->SetFont('Arial','B',12);
    $this->SetXY(26,266); 
    $this->Write(0,'5559725169 - 5562982670');
    $this->SetTextColor(0,0,0);

    $this->Image('../../imagenes/telefono.jpg',18,262,7,0);
    ...
    $this->SetFont('Arial','B',11);
    $this->SetXY(90,266); 
    $this->Write(0,'atencion.cliente@estudioscliniosanbuenaventura.com.mx');
    $this->SetTextColor(0,0,0);

    $this->SetTextColor(26,35,126); 
    $this->SetFont('Arial','B',10);
    $this->SetXY(80,274); 
    $this->Write(0,'Ixtapaluca - Chalco');
    $this->SetTextColor(0,0,0);
