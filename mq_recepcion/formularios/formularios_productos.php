			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div style="color:#000000;background:#EFFBF5" class="modal-body">
						...
						<div class="md-form">
							<input type="text" name="id_factura" id="id_factura" class="form-control" required disabled>
							<label for="codigo">Id Folio</label>
						</div>

						<div class="md-form">
							<input type="text" name="id_estudio" id="id_estudio" class="form-control" required disabled>
							<label for="codigo">Id Estudio Maquila</label>
						</div>
						...
						<div class="row">
							<div class="col">
								<div class="md-form mt-0">
									<div class="md-form">
										<input type="text" name="costo_maq" id="costo_maq" class="form-control" required >
										<label for="costo_maq">Precio</label>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col">
								<div class="md-form mt-0">
									<div class="md-form">
										<input type="text" name="observa" id="observa" class="form-control" required disabled>
					...
					<div class="row">
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="date" name="caducidad" id="caducidad" class="form-control" required values=" <?php echo $FechaHoy; ?>">
									<label for="producto">Fecha de envio</label>
								</div>
							</div>
						</div>
					</div>
