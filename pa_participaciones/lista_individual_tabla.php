...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
      ...
      <div class="form-group">
        ...
        <label class="font-weight-normal lead"><?php $periodo=date("F", strtotime('-1 month')).'-'.date("o", strtotime('-1 month')); echo $periodo ?></label>
        </div>
  </div>
        <div class="row">
    ...
    <script language="javascript" src="js/lenguajeusuario_individual.js"></script>
    <script>
