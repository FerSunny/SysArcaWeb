					...
					success: function(data)            

						{
...

							{
								...
								swal('El usuario esta asignado ya a una sucursal')
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_usuario)

				$("#frmedit  #pro").val(data.id_usuario)

				$("#frmedit  #codigo").val(data.id_usuario)

				$("#frmedit  #sucursal").val(data.fk_id_sucursal)

				$("#frmedit  #usuario").val(data.id_usuario)
