			...
			<div class="modal-content">
				...
				<div style="color:#000000;background:#EFFBF5" class="modal-body">
					...
					<div class="md-form">
						...
						<input type="number" name="codigo" id="codigo" class="form-control"  maxlength="15" readonly>
								...
								<select class="form-control form-control-sm" name="usuario" id="usuario" required>
									...
									<option value="" class="z-depth-5">Seleccione</option>
										...
										<?php 
												...
												$query = $conexion -> query("SELECT id_usuario, CONCAT(u.`nombre`,' ',u.`a_paterno`,' ',u.`a_materno`) AS usuario 
												FROM se_usuarios u 
												WHERE activo = 'A'");
						...
						<div class="row">
							...
							<div class="col-9">
								...
								<div class="md-form mt-0">
									...
									<select class="form-control form-control-sm" name="usuario" id="usuario" required   disabled="disabled"  readonly   > 

										<option value="" class="z-depth-5">Seleccione</option readonly >
