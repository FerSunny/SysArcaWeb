...
$numero_factura= 180556;  // $_POST['numero_factura'];
$studio= 1196; //  $_POST['studio'];
...
//../ag_orden_dia_pacientes/ag_orden_dia/services/send_mail.php
