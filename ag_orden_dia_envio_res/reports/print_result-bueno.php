...
function Header()
{
        ...
        $this->Image('../imagenes/codigo1.jpg',160,45,30,30);
            ...
            while($row = $result->fetch_assoc())
                {
                    ...
                    $firma=$row['concepto'];
                    $this->Image('../imagenes/firma.gif',150,234,40,0);
...
$pdf->SetAutoPageBreak(true,30);//para determinar el tamaño de espacio para el body 
