...
<html lang="en">
  ...
  <div class="container">
      <div class="card">
        <h4 class="card-header">Modificacion de resultados</h4>
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-body">
          <h4 class="card-title">Modificacion de resultados</h4>
            ...
            <tbody>
              ...
              ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <input  class="form-control" type="text" required name="fn_resultado<?php echo $i?>" id="fi_resultado<?php echo $i?>" maxlength="40" size="10" placeholder="Escriba el valor"/>
                          </td>
          ...
          <?php if($i>0){ ?>
            <button id="btn_guardar" type="button" class="btn btn-success">Guardar</button><?php }  ?>
