				...
				"columns":[
					...
					{ "data": "participacion" },
					{
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='reports/recibos_pago_individual.php?id_medico="+row['id_medico']+"&periodo="+row['periodo']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					}
