				...
				<div class="modal-content">
					...
					<div style="color:#000000;background:#EFFBF5" class="modal-body">
						...
						<div class="md-form">
							...
							<input type="text" readonly name="id_medico" id="id_medico" class="form-control" required>

							<label for="codigo">Id Medico</label>
							...
							<div class="col">
								...
								<div class="md-form mt-0">
									...
									<div class="md-form">
										...
										<input type="number" name="numpac" id="numpac" class="form-control" required>

										<label for="producto">No. de pacientes (aprox)</label>
							...
							<div class="col">
								...
								<div class="md-form mt-0">
									...
									<div class="md-form">
										...
										<input type="text" name="diavis" readonly id="diavis" class="form-control" required>

										<label for="desc_p">Dia Visita</label>
							...
							<div class="col">
								...
								<div class="md-form mt-0">
									...
									<div class="md-form">
										...
										<input type="time" name="hora" id="hora" readonly class="form-control"  required>
							...
							<div class="col">
								...
								<div class="md-form mt-0">
									...
									<div class="md-form">
										...
										<input type="number" readonly name="dia" id="dia" class="form-control"  required>

										<label for="utilidad">Dia Mes Visita </label>
						...
						<div class="row"><br>
							...
							<div class="col-9">
								...
								<div class="md-form mt-0">
									...
									<select class="form-control form-control-sm" name="merec" 
									...
									id="merec" required>
										...
										<option value="" class="z-depth-5">Seleccione</option>
											...
											<?php 
													...
													$query = $conexion -> query("SELECT * FROM kg_si_no WHERE estado = 'A'");
						...
						<div class="row">
							...
							<div class="col">
								...
								<div class="md-form mt-4">
									...
									<label for="">Tiene Mis Pacientes</label>
							...
							<div class="col-9">
								...
								<div class="md-form mt-0">
									...
									<select class="form-control form-control-sm" name="mispac" id="mispac" required>
