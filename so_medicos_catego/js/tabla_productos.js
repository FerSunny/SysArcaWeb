...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_catego)

				$("#frmedit  #pro").val(data.id_catego)

				$("#frmedit  #id_medico").val(data.id_medico)

				$("#frmedit  #codigo").val(data.id_catego)

				$("#frmedit  #merec").val(data.me_atiende)

				$("#frmedit  #mispac").val(data.mis_pacientes)

				$("#frmedit  #numpac").val(data.pacientes_dia)

				$("#frmedit  #diavis").val(data.dia_visita)

			 	$("#frmedit  #hora").val(data.hora_visita)

			 	$("#frmedit  #dia").val(data.dia_visita_mes)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_catego}  , function(data,status)
