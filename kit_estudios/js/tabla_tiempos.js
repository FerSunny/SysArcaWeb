...
// listar datos en la tabla de perfiles
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				"ajax":{
					"method":"POST",
					"url": "listar_tiempos.php?studio="+studio
				},
				"columns":[
					{"data" : "id_tiempo"},
					{"data" : "desc_puesto"},
...
$("#form_productos").on('submit', function (e) 
	{
			...
			$.ajax({
					type: "POST",                 
					url: "controladores/agregar_tiempo.php",                    
...
var editar = function(tbody, table) {
		$(tbody).on("click", "button.editar", function() 
		{
				...
				$("#frmedit  #pro").val(data.id_tiempo)

				$("#frmedit  #id_tiempo").val(data.id_tiempo)
				$("#frmedit  #puesto").val(data.fk_id_puesto)
...
$("#frmedit").on('submit', function (e) 
	{
			...
			$.ajax({
					type: "POST",                 
					url: "controladores/editar_tiempo.php",                    
...
//alert (data.id_folio_producto)

					 $.post("./controladores/eliminar_tiempo.php", {'id_tiempo' : data.id_tiempo}  , function(data,status)
					{
						swalWithBootstrapButtons(
						'Eliminado!',
