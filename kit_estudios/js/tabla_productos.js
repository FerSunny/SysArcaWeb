...
var editar = function(tbody, table) {
		$(tbody).on("click", "button.editar", function() 
		{
				...
				$("#frmedit  #id_costo_estudio").val(data.id_costo_estudio)
...
//alert (data.id_folio_producto)
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_costo_estudio}  , function(data,status)
					{
						swalWithBootstrapButtons(
						'Eliminado!',
