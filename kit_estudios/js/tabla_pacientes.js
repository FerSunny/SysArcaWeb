...

					{
						render:function(data,type,row){
							...
							var costo
								...
								return "<form-group style='text-align:center;'>"+
								"<a id='muestras' target='_blank' href='./tabla_tiempo.php?numero_factura="+row['id_factura']+"&studio="+row['id_estudio']+"' class='btn btn-warning btn-md' role='button'><span  class='fas fa-clock'></span></a>"+
								"</form-group>";								
