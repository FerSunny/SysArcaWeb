...
AND p1.origen = 'C' AND fa.fk_id_sucursal$condicion AND p1.validado = 1
...
AND DATE(fa.fecha_factura) BETWEEN DATE_SUB(CURDATE(), INTERVAL 25 DAY) AND DATE_ADD(CURDATE(), INTERVAL 25 DAY)
AND p2.origen = 'C' AND fa.fk_id_sucursal$condicion AND p2.validado = 1
...
AND DATE(fa.fecha_factura) BETWEEN DATE_SUB(CURDATE(), INTERVAL 25 DAY) AND DATE_ADD(CURDATE(), INTERVAL 25 DAY)
AND fa.fk_id_sucursal".$condicion." AND p3.validado = 1 ");
