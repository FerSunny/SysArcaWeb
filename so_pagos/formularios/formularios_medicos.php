...
<div class="modal fade" id="myModals" role="dialog">
  <div class="modal-dialog">
      ...
      <!-- Modal content-->
   <form name="AltasMedico" action="controladores/registro_medicos.php" method="post">
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h2 style="color:blue;text-align:center" class="modal-title" id="modalEliminarLabel">Pagar Saldo</h2>
              <h5 style="color:blue;text-align:center" class="modal-title">Nota con saldo</h5>
            </div>
            <!-- INICIA EL BODY -->
            <div style="color:#000000;background:#EFFBF5" class="modal-body">
             ...
             <table border="0" align="center" BGCOLOR=#F5FBEF style="border-bottom:1px solid #819FF7">
              <!-- Id factura -->
              <tr>
                <td class="renglon_titulo"> Id factura: </td>
                <td class="renglon_valor" class="form-control" >
                    <input type="text" name="fn_id_factura" id="fi_id_factura" readonly="readonly" maxlength="12" size="19" placeholder="Asignado por el sistema"/>
                </td>
              </tr>
              ...
              <tr>
                  <td class="renglon_titulo">Nombre:</td>
                  <td class="renglon_valor" class="form-control">
                      <input type="text" required name="fn_nombre" id="fi_nombre" readonly="readonly"  maxlength="35" size="35" placeholder="Nombre"/>
                   </td>
              </tr>
              <!-- Total -->
              <tr>
                  <td class="renglon_titulo">Total:</td>
                  <td class="renglon_valor" class="form-control">
                      <input type="text" required name="fn_imp_total" id="fi_imp_total"  readonly="readonly"  maxlength="35" size="35" placeholder="total"/>
                   </td>
              </tr>
              <!-- A cuenta -->
              <tr>
                  <td class="renglon_titulo">A Cuenta:</td>
                  <td class="renglon_valor" class="form-control">
                      <input type="text" required name="fn_a_cuenta" id="fi_a_cuenta" readonly="readonly"  maxlength="35" size="35" placeholder="A cuenta"/>
                   </td>
              </tr>   

              <!-- Resta -->
              <tr>
                  <td class="renglon_titulo">Saldo:</td>
                  <td class="renglon_valor" class="form-control">
                      <input type="text" required name="fn_resta" id="fi_resta" maxlength="15" size="20" placeholder="Saldo"/>
                   </td>
              </tr>      
              ...
              <tr>
                <td>Forma de Pago:</td>
                <td>
                    <select class="" name="fn_f_pago"  id="fi_f_pago">
