...
$sql_insert="INSERT INTO so_pagos(fk_id_factura,fk_id_sucursal_ori,fk_id_sucursal_pag,imp_pagado,fecha_pago,tipo_pago,fecha) VALUES ('$id_factura','$fk_id_sucursal_ori','$fk_id_sucursal_pag','$fn_resta','$fecha_pago','$fn_f_pago','$fecha')";
