...
// Cabecera de página
  function Header()
  {
    ...
    global $sucursal,
      ...
      $this->Cell(3);
      // Título
      $this->Cell(240,5,'ELABORATORIOS CLINICOS ARCA',0,0,'C');
      $this->Ln(5);
...
*/
      ...
      $this->SetFont('Arial','B',7);
	    $this->Cell(30,10,'Id-Cod',0,0,'C');
      $this->Cell(35,10,utf8_decode('Proveedor'),0,0,'C');
      $this->Cell(70,10,utf8_decode('Producto'),0,0,'C');
  ...
  while($row = $result->fetch_assoc())
      {
        ...
        $pdf->SetFont('Courier','',7);
	      ...
	      $pdf->Cell(30,5,$row['fk_id_producto'].'-'.$row['cod_producto'],0,0,'L');
        $pdf->cell(3);
        $pdf->Cell(45,5,utf8_decode(substr($row['razon_social'],0,30)),0,0,'L');
