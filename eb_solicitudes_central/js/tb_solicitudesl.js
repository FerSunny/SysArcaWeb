...
// listar datos en la tabla de comisiones
        ...
        var view_solicitudes = function(tbody, table){
            $(tbody).on("click", "button.view", function(){
                ...
                detail_solicitudes(id_detalle,fk_id_sucursal)
...
// eliminndo la comision
        ...
        function detail_solicitudes(id_detalle,fk_id_sucursal)
        {
            console.log(fk_id_sucursal)
            tabla = $('#de_sol').dataTable(
                {
                    ...
                    "ajax":
                          {
                            //url : "./forms/listar.php?id="+id_detalle,fk_id_sucursal,
                            url : "./forms/listar.php?id="+id_detalle+"&sucursal="+fk_id_sucursal,
                            type : "get",
                            dataType : "json",
                            error: function(e)
                            {
