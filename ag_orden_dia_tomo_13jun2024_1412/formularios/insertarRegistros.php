...
*/
    $sql="INSERT INTO cr_plantilla_rx_re(fk_id_empresa,fk_id_factura,fk_id_estudio,orden,tipo,concepto,valor,observaciones,num_imp,tamfue,tipfue,posini) VALUES (1,'$id_factura','$id_studio','$orden','$tipo','$concepto','$resultado','$observaciones',0,'$tamfue','$tipfue','$posini')";
    //echo $sql;
