...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Estado de los resultados</h1>

      <div class="form-group">
        <label class="font-weight-bold lead">Periodo:</label>
        <label class="font-weight-normal lead"><?php $fecha_actual = date("d-m-Y"); echo date("l jS \of F Y ",strtotime($fecha_actual."- 20 days")); echo "--";   echo date('l jS \of F Y ');  ?></label>
      </div>
    ...
    <script language="javascript" src="js/tabla_entrega.js"></script>
    <script>
