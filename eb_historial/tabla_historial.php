...
<head>
  ...
  <title>Historial</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    <h1 style="text-align: center;">Tabla Historial</h1>
  </div>
  ...
  <div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12"> <!-- REVISAR -->
    ...
    <div class="container table-responsive">
      <div class="container table-responsive">
      <table id="dt_historial" class="table table-bordered table-hover" cellspacing="1" width="100%">
        <thead>
          <tr>
            <th>Folio</th>
