...
<head>
  ...
  <title>Detalles</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    <h1 style="text-align: center;">Tabla Detalles de Solicitud <!-- CAMBIO Se cambia el titulo de la tabla -->
    </h1>
  </div>
  ...
  <div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12"> <!-- REVISAR -->
    ...
    <input type="hidden" name="id_detalle" id="id_detalle" value="<?php echo $_GET['val']; ?>">

    <div class="container table-responsive">
      <div class="container table-responsive">
        <table id="dt_detalles" class="table table-bordered table-hover" cellspacing="1" width="100%">
          <thead>
            <tr>
              <th>Código </th>
              <th>Producto</th>
  ...
  <script language="javascript" src="../js/tabla_historial.js"></script>
</body>
</html>
<?php
