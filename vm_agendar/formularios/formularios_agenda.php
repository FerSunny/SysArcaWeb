...
<!-- Medico -->      
          ...
          <div class="row">
            ...
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  <input type="time" required name="fn_hora" id="fi_hora" min="09:00" max="17:00" class="form-control">
                  <label>Hora</label>
                </div>
              </div>
            </div>
...
<form name ="formupd" id="frmedit" action="" method="post" onsubmit="return validar();">
      ...
      <div class="modal-content">
        ...
        <div class="row">
          ...
          <div class="row">
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  <input type="date" required name="fn_fecha" id="fi_fecha">
                  <label>Fecha__</label>
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  <input type="time" required name="fn_hora" id="fi_hora" min="09:00" max="18:00" class="form-control">
                  <label>Hora</label>
                </div>
              </div>
            </div>
        ...
        <div class="modal-footer">
          <button onclick="validar();" type="submit" class="btn btn-success" id="btniniciar"  >Ingresar</button>
          <button type="button" class="btn btn-danger" data-dismiss="modal">Cancelar</button>
        </div>
      </div>
    </div>
...
<script type="text/javascript">
  ...
  function validar(){
	...
	hoy = anio + "-" + mes_c + "-" + dia_c;  
		  




    fe2 = form.fn_fecha.value;
// console.log("Fecha capturada: "+fe2);
//console.log("Fecha hoy: "+hoy);
    if(fe2 < hoy){
      alert("La fecha agendada, no puede ser menor a la fecha de hoy");
      form.fn_fecha.value="";
      form.fn_fecha.focus();
      return false;
    }
