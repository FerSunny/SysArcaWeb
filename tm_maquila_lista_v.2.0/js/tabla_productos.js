		...
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				"columns":[
					...
					//{"defaultContent":"<button type='button' class='eliminar btn btn-success btn-md'><i class='fa fa-print'></i></button>"}
					{
						...
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='./reports/repo_maquila_unidad.php?fk_id_sucursal="+row['fk_id_sucursal']+"&lote="+row['lote']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
