					...
					success: function(data)            

						{
...

							{
								...
								swal('El codigo del horario ya existe')
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #horario").val(data.desc_horario)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_horario' : data.id_horario}  , function(data,status)
