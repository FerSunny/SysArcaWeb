...
<head>
  ...
  <title>Pacientes</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    <h1 style="text-align: center;">Lista de espera recepcion <?php date_default_timezone_set('America/Chihuahua'); echo date("F j, Y, g:i a"); ?>  <!-- CAMBIO Se cambia el titulo de la tabla -->
      <!--
  ...
  <script language="javascript" src="js/tabla_muestra.js"></script>
</body>
</html>
<?php
