          ...
          <div class="row">
            ...
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                Estado
                <select required name="Estado" id="fi_estado"  class="form-control">
                    <?php
           ...
           <div class="row">
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                 Municipio 
                <select required name="Municipio" id="fi_Municipio" class="form-control">
            ...
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  Localidad
                <select required name="Localidad" id="fi_Localidad" class="form-control">
            ...
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  ...
                  Tipo Consultorio
                   <select  required name="tc" id="tc" class="form-control" data-width="fit">
                    <?php
