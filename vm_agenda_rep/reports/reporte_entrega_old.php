...
en.recibidigital
FROM vm_agenda ag 
LEFT OUTER JOIN vm_hoja_visita hv ON (hv.`fk_id_medico` = ag.`fk_id_medico` AND hv.`fecha_visita` = ag.`fecha` and hv.fk_id_usuario = ag.fk_id_usuario)
LEFT OUTER JOIN vm_encuesta en ON (en.`idmedico` = ag.`fk_id_medico` and en.estado = 'A')
