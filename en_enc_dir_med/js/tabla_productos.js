						...
						render: function(data,type,row)
	                    {
	                        ...
	                        switch (valid) {
								...
								case '1':
									...
									break;
								case '2':
									return "<button type='button' class='alta btn btn-primary btn-md'><i class='fa fa-user-md'></i></button>"
									break;		
								case '3':
									return "<button type='button' class='alta btn btn-info btn-md'><i class='fa fa-user-md'></i></button>"
									break;	
								case '4':
