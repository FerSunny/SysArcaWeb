		...
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				"columns":[
					...
					{"defaultContent": "<button type='button' class='registrar btn btn-warning btn-md'><i class='fas fa-edit'></i></button>"},

					{"defaultContent":"<button type='button' class='eliminar btn btn-danger btn-md'><i class='fa fa-undo'></i></button>"}
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_toma' : data.id_toma}  , function(data,status)

					{
						...
						'La asignacion del lote se ha revertido',
