		...
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				"columns":[
					...
					{"data" : "desc_puesto_larga"},

					{"data" : "desc_nivel"},

					{"data" : "sdo_mes_integrado"},
					...
					success: function(data)            

						{
...

							{
								...
								swal('El codigo del puesto ya existe')
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_puesto)

				$("#frmedit  #pro").val(data.id_puesto)

				$("#frmedit  #codigo").val(data.codigo)

				$("#frmedit  #puesto_c").val(data.desc_puesto)

				$("#frmedit  #puesto_l").val(data.desc_puesto_larga)

				$("#frmedit  #nivel").val(data.fk_id_nivel)

				$("#frmedit  #smi").val(data.sdo_mes_integrado)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_puesto' : data.id_puesto}  , function(data,status)
