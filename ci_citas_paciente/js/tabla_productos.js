				...
				"columns":[
...

					{
						render:function(data,type,row){
							...
							if (paciente == 0){
								//return "<button type='button'  class='eliminar btn btn-outline-success btn-md'>Libre</button>"
								return "<button type='button'  class='editar btn btn-outline-success btn-sm'>Libre</button>"
							}else{
								return '<button type="button" disabled=true class="btn btn-outline-info btn-sm">Ocupado</button>'
							}
						}
					},
...

					{
						render:function(data,type,row){
							var paciente=row['fk_id_paciente']
							if (paciente == 0){
								return "<button type='button' disabled=true class='eliminar btn btn-outline-danger btn-sm'>Cancelar</button>"
							}else{
