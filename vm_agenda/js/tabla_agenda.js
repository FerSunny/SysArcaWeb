...
// editamos medicos
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				...
				fi_medico = $("#frmedit #fi_medico").val( data.fk_id_medico)
				fi_fecha = $("#frmedit #fi_fecha").val( data.fecha)
		...
		var obtener_id_eliminar = function(tbody, table){
			$(tbody).on("click", "button.eliminar", function(){
				...
				swalWithBootstrapButtons({
					...
					if(result.value) {
						$.post("./controladores/eliminar_agenda.php", {'id_agenda' : data.id_agenda} , function(data,status)
						{
							swalWithBootstrapButtons(
								'Eliminado!',
