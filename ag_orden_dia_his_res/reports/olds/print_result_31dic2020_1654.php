...
function Header()
{
    ...
    $this->Image('../imagenes/codigo3.png',170,50,25,25);
   ...
   //$this->SetFillColor(230,230,0);
    ...
    $this->Cell(185,5,'BLVD San Buenaventura #51 Col. La Venta, Ixtapaluca Edo de Mex Entre Jaral Capulin.',0,0,'C');
    $this->Ln(3);
...
// Pie de página
  function Footer()
  {
    ...
    $this->Cell(2);
    $this->SetTextColor(0,0,255);
    $this->Cell(185,5,'__________________________________________________________________________________________________',0,0,'L');
