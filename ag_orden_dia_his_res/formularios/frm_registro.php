				...
				<table id="t_plantilla2" class="table table-bordered table-hover" cellspacing="1" width="100%">
						<thead>
							<tr>
								...
								<th> Concepto </th>
								<th> Resultado </th>
								<th style="display:none;"> TaFu </th>
								<th style="display:none;"> TiFu </th>
								<th style="display:none;"> PosIni </th>
							</tr>
						</thead>
						<tbody>
												<?php
							...
							?>
												...
												<tr>
													...
													<td>
														<input class="form-control" type="text" required name="fn_resultado<?php echo $i?>" id="fi_resultado<?php echo $i?>" maxlength="700" placeholder="Escriba el valor" />
													</td>

													<td style="display:none;"> <?php echo $tamfue?> </td>
													<td style="display:none;"> <?php echo $tipfue?> </td>
													<td style="display:none;"> <?php echo $posini?> </td>
												</tr>
											<!--
											<?php?>
											-->
