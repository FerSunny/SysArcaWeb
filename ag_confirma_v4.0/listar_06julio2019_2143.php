...
AND p1.origen = 'C' AND fa.fk_id_sucursal$condicion AND fa.id_factura = $buscar
...
AND p2.origen = 'C' AND fa.fk_id_sucursal$condicion AND fa.id_factura = $buscar
...
AND fa.fk_id_sucursal$condicion AND fa.id_factura = $buscar");
