...
foreach($data as $objeto)
{
    ...
    $sql="UPDATE cr_plantilla_1_re SET valor = '$resultado', verificado = '$verificado',  valor_refe = '$valor_refe', unidad_medida = '$unidad_medida', observaciones = '$observaciones' WHERE fk_id_factura = $id_factura AND fk_id_estudio = $id_studio AND orden = '$orden'";
    //echo $sql;
