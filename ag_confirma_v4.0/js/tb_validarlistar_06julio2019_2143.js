...
function buscar()
{
    var buscar = $("#buscar_folio").val()
   $("#dt_resultados").DataTable({
            "aTargets": [ "_all" ],
            "destroy": true,
            "sRowSelect": "multi",
            "ajax": {
                "method": "GET",
                "url": "listar.php?buscar="+buscar
            },
            "columns": [
                { "data": "fk_id_factura" },
                { "data": "desc_sucursal" },
 ...
 var print = function(tbody) {
    $(tbody).on("click", "button.print", function()
    {
        var tabla = $('#dt_resultados').DataTable();
