<?php
  ...
  if (isset($_SESSION['nombre']) && $_SESSION['ingreso']=='YES')
  {
    ...
    $mesagendanum=$_GET['mesagendanum'];
    $anioagenda=$_GET['anioagenda'];
    $id_usuario=$_GET['id_usuario'];


    $_SESSION['mesagendanum']=$mesagendanum;
    $_SESSION['anioagenda']=$anioagenda;
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    ...
    <h1 style="text-align: center;">Tabla de dias agenda  <!-- CAMBIO Se cambia el titulo de la tabla -->
<!--
  ...
  <script language="javascript" src="js/tabla_dias.js"></script>
