...
// editamos estado civil
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				...
				var id_imagen = $("#frmedit #anio").val( data.anioagenda)
					   desc_imagen = $("#frmedit #mes").val( data.mesagenda)
					   desc_estudio = $("#frmedit #dia").val( data.diagenda)
						nombre = $("#frmedit #medicos").val( data.medicos)
