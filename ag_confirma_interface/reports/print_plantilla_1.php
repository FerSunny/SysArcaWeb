...
$sql_max="select max(num_imp) as num_imp FROM cr_plantilla_1_re_i
...
if ($result = mysqli_query($con, $sql_max)) {
  while($row = $result->fetch_assoc())
  {
      ...
      //echo $veces;
      $sql_update="UPDATE cr_plantilla_1_re_i SET num_imp = '".$veces."',fecha_impresion = '".$fecha_impresion."'
      where fk_id_factura=".$numero_factura." and fk_id_estudio=".$studio;
      //echo $sql_update;
...
CASE
  ...
  END AS valor_refe,tamfue,posini,tipfue FROM cr_plantilla_1_re_i
  where fk_id_factura=".$numero_factura." and fk_id_estudio=".$studio.") 
  UNION
