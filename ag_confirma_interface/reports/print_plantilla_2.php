...
$sql_max="select max(num_imp) as num_imp FROM cr_plantilla_2_re_i
...
if ($result = mysqli_query($con, $sql_max)) {
  while($row = $result->fetch_assoc())
  {
      $veces=$row['num_imp']+1;
      //echo $veces;
      $sql_update="UPDATE cr_plantilla_2_re_i SET num_imp = '".$veces."'
      where fk_id_factura=".$numero_factura." and fk_id_estudio=".$studio;
      //echo $sql_update;
...
$sql="(select tipo,orden,concepto,valor,verificado,observaciones from cr_plantilla_2_re_i
