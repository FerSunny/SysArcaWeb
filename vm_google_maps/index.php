        ...
        <div class="container text-center mt-5">
          ...
          <div class="row">
            ...
            <div class="col-md-12">
              ...
              <h1 class="mb-4">Mostrar las ubicaciones de las visitas medicas</h1>

              <p>"Coloca el puntero del Mouse en cada marcador rojo del Mapa para ver la dirección correspondiente"</p>
<!--
              <p>
                <strong>Nota:</strong><br>
                El mapa, marcadores y direcciones pueden dar errores de visualización por restricciones de haber excedido la quota diaria gratis de la API de Google Maps Javascript 
              </p>
-->
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-12">
              ...
              <h2 class="h2s">Direcciónes de las visitas</h2>
...
-->
    ...
    <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD42XI0gCTMtlDsaFucKTSTewZSNdl9GdQ&callback=initMap"></script>
