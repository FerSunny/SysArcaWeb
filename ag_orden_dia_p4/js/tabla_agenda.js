							...
							$.ajax({
								...
								success:function(data){
									...
									for (var i=0;i<dataForTable.length;i++){
										//console.log(dataForTable[i][3]=dataForTable[i][3].substring(0,dataForTable[i][3].length-11)+' '+data.array_datos[i]+' </textarea>');
										dataForTable[i][3]=dataForTable[i][3].substring(0,dataForTable[i][3].length-11).trim()+' '+data.array_datos[i]+' </textarea>';
										//dataForTable[i][3]=dataForTable[i][3].substring(0,dataForTable[i][3].length-1)+'values='+data.array_datos[i]+'>';
