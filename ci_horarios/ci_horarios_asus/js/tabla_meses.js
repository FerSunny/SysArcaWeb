				...
				"columns":[
...

					{
						render:function(data,type,row){
							...
							"<a id='printer'  href='../ci_horarios/tabla_horarios.php?fk_id_sucursal="+row['fk_id_sucursal']+"&anio="+row['anio']+"&mes="+row['mes']+"' class='btn btn-success btn-md'  role='button'><span class='far fa-bell' style='color:white;'></span></a>"+
							"</form-group>";
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #pro").val(data.id_horario)

				$("#frmedit  #codigo").val(data.id_horario)
