...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_duplica  #dc").val(data.fk_id_cliente)

				$("#form_duplica  #pro").val(data.id_producto)

				$("#form_duplica").modal("show")
...
$("#form_duplica").on('submit', function (e) 
					...
					success: function(data)            

						{
...

							{
								...
								document.getElementById("form_duplica").reset();
...

{
...

	{
			...
			$("#form_duplica #lbl_total").attr('class','active')
