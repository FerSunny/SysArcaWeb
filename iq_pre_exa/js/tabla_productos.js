				...
				"columns":[
...

					{
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='reports/reporte_tiempos.php?diafactura="+row['diafactura']+"&id_sucursal="+row['id_sucursal']+"&desc_sucursal="+row['desc_corta']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					}
