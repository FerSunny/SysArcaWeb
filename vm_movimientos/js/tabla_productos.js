...

					{
						render:function(data,type,row){
							var registrado;
									...
									"<a id='printer' target='_blank' href='reports/mueve_mes.php?anio="+row['anio']+"&mes="+row['mesnum']+"&id_usuario="+row['id_usuario']+"&dia="+row['dia']+"' class='btn btn-dark btn-md' role='button'><i class='fas fa-file-pdf' style='color: white;'></i></a>"+
									"</form-group>";
