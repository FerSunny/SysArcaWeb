...
// titulos 
    ...
    $this->Cell(70,5,'Cliente',0,0,'C');
    $this->Cell(13,5,'Edo',0,0,'C');
    $this->Cell(14,5,'T.P.',0,0,'C');
    $this->Cell(21,5,'Importe',0,0,'C');
...
*/
      ...
      $pdf->Cell(70,5,utf8_decode($row['cliente']),0,0,'L');
      $pdf->Cell(13,5,$row['estado'],0,0,'C');
