				...
				"columns":[
					...
					{ "data": "efectivo" },
					{
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='./reports/print_folios_empresa.php?id_sucursal="+row['id_sucursal']+"&fecha_factura="+row['fecha_factura']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					},
					{
						render:function(data,type,row){
							return "<form-group style='text-align:center;'>"+
							"<a id='printer' target='_blank' href='./reports/export_folios_empresa.php?id_sucursal="+row['id_sucursal']+"&fecha_factura="+row['fecha_factura']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-exchange'></span></a>"+
							"</form-group>";
							},
					}
				],
