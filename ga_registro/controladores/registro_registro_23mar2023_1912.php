...
$query= "INSERT INTO ga_registro (fk_id_empresa, fk_id_sucursal, fk_id_gasto, importe, fecha_mov, nota, estado,fk_id_beneficiario,num_comprobante,num_autoriza,autorizo,fecha_aut) VALUES('$fk_id_empresa', '$fk_id_sucursal', '$fk_id_gasto','$importe','$fecha_mov','$nota','$estado','$fk_id_beneficiario','$num_comprobante','0','0',NULL)";
