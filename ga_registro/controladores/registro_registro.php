...
$query= "INSERT INTO ga_registro (fk_id_empresa, fk_id_sucursal, fk_id_gasto, importe, fecha_mov, nota, estado,fk_id_beneficiario,num_comprobante,num_autoriza,autorizo,fecha_aut,fk_id_usuario) VALUES('$fk_id_empresa', '$fk_id_sucursal', '$fk_id_gasto','$importe','$fecha_mov','$nota','$estado','$fk_id_beneficiario','$num_comprobante','0','0',NULL,$fk_id_usuario)";
