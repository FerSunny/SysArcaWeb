					...
					<div class="row">
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<textarea class="form-control" id="descripcion" name="descricpion"rows="3"required ></textarea>
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<input type="date" name="fecha_exipra_g" id="fecha_exipra_g" class="form-control"  required>
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<input type="date" name="fcalibra" id="fcalibra" class="form-control" maxlength="100" required>

									<label for="producto"> Fecha Calibracion </label>
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<input type="date" name="fultimo" id="fultimo" class="form-control" maxlength="100" required>

									<label for="producto"> Fecha U. Mnto. </label>
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<label for="costo">V. Minimo</label>
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<label for="c_total" id="lbl_total">V. Maximo</label>
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<input type="number" name="vcorrige" id="vcorrige" class="form-control" step="0.01" required>

									<label for="c_total" id="lbl_total">Valor Corr.</label>
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<input type="number" name="dmto" id="dmto" class="form-control" step="1" required>

									<label for="c_total" id="lbl_total">Dias Mto.</label>
