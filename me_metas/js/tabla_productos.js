...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_meta)

				$("#frmedit  #pro").val(data.id_meta)

				$("#frmedit  #codigo").val(data.id_meta)

				$("#frmedit  #anio").val(data.anio)

				$("#frmedit  #mes").val(data.fk_id_mes)

				$("#frmedit  #importe").val(data.importe)

				$("#frmedit  #notas").val(data.notas)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_meta}  , function(data,status)
