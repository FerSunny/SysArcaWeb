...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_registro)

				$("#frmedit  #pro").val(data.id_registro)

				$("#frmedit  #codigo").val(data.id_registro)

				$("#frmedit  #sucursal").val(data.fk_id_sucursal)

				$("#frmedit  #usuario").val(data.fk_id_usuario)

				$("#frmedit  #beneficiario").val(data.fk_id_beneficiario)

				$("#frmedit  #fecha").val(data.fecha_mov)

				$("#frmedit  #importe").val(data.importe)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_registro}  , function(data,status)
