...
<body background="../imagenes/logo_arca_sys_web.jpg">
	<?php
  	...
  	<div class="container" style="margin-top: 30px;">
      	<h1 style="text-align: center;">Tabla de Asistencias  <!-- CAMBIO Se cambia el titulo de la tabla -->
      	</h1>
  	</div>
	...
	<div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12"> <!-- REVISAR -->
		...
		<div class="container table-responsive">
			<table id="dt_asistencia" class="table table-bordered table-hover" cellspacing="1" width="100%">
				<thead>
					<tr>
	...
	<script language="javascript" src="js/tabla_asistencia.js"></script>
</body>
</html>
<?php
