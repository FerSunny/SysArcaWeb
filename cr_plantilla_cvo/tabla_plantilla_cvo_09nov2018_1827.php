...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  include("formularios/formularios_plantilla_cvo.php"); // CAMBIO programa de la forma
  ?>
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Tabla de Plantilla Cultivos<!-- CAMBIO Se cambia el titulo de la tabla -->
		...
		<div class="row">
			<div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12"> <!-- REVISAR -->
				...
				<!-- REVISAR -->
					<table id="dt_plantilla_cvo" class="table table-bordered table-hover" cellspacing="1" width="100%" >
						<thead>
							<tr>
	...
	<script language="javascript" src="js/tabla_plantilla_cvo.js"></script> <!-- CAMBIO este JS -->
	<script>
