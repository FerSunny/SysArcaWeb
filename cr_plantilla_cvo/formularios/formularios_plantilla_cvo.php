...
<div class="modal fade" id="myModals" role="dialog">
  <div class="modal-dialog">
      ...
      <!-- Modal content-->
   <form name="AltasPlantilla_cvo" action="controladores/registro_plantilla_cvo.php" method="post">
        ...
        <div style="color:##fff;background:#e3f2fd" class="modal-body">
          <table border="0" align="center" BGCOLOR=#F5FBEF style="border-bottom:1px solid #819FF7">
              ...
              <tr>
                  ...
                  <td class="renglon_valor" class="form-control">
                        <input type="text"  name="fn_concepto" id="fi_concepto" maxlength="90" size="50" placeholder="Concepto"/>
                  </td> 
              </tr>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmEliminarvalor" action="controladores/eliminar_plantilla_cvo.php" method="POST">
