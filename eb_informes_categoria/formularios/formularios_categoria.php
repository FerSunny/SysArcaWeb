            ...
            <div class="modal-header">
              <h2 style="color:blue;text-align:center" class="modal-title">
                  ...
                  <div class="row">
                   <div class="col">
                      <div class="md-form mt-0">
                        <div class="md-form">                
                        <input type="text" name="cat" id="cat" class="form-control" maxlength="30" required>
                ...
                <div class="col">
                  <div class="md-form mt-0">
                    <div class="md-form">
                        <input type="text" name="descrip" id="descrip" class="form-control" maxlength="35" required>
