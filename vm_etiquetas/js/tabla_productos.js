...

					{
						render:function(data,type,row){
							var registrado;
									...
									"<a id='printer' target='_blank' href='reports/tikets.php?id_medico="+row['id_medico']+"' class='btn btn-dark btn-md' role='button'><i class='fas fa-file-pdf' style='color: white;'></i></a>"+
									"</form-group>";
