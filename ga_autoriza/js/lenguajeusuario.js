				...
				"columns":[
					...
					{ "data": "importe" },
					{
						render:function(data,type,row){
							...
							"<a id='printer'  href='./servicios/autoriza_pago.php?id_registro="+row['id_registro']+"&importe="+row['importe']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-check-circle'></span></a>"+
							"</form-group>";
							},
					}
				],
