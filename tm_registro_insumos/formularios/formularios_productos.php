							...
							<div class="md-form mt-0">
								...
								id="articulo" >
									<option value="" class="z-depth-5">Seleccione</option>
										<?php 
												$query = $conexion -> query("SELECT pr.id_producto, pr.desc_producto FROM eb_productos pr, km_insumos_estudio ie WHERE pr.estado = 'A' AND ie.fk_id_producto = pr.id_producto AND ie.fk_id_estudio = $studio  and pr.fk_id_sucursal = $fk_id_sucursal");
			...
			<div class="modal-dialog" role="document">
				<div class="modal-content">
					...
					<div style="color:#000000;background:#EFFBF5" class="modal-body">
						...
						<div class="md-form">
							<input type="hidden" noetry  name="id_folio_producto" id="id_folio_producto" class="form-control" required>
