...
// listar datos en la tabla de perfiles
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				"ajax":{
					"method":"POST",
					"url": "listar_productos.php?factura="+factura+"&studio="+studio
				},
				"columns":[
					{"data" : "desc_sucursal"},
					{"data" : "fk_id_producto"},
...
var editar = function(tbody, table) {
		$(tbody).on("click", "button.editar", function() 
		{
				...
				$("#frmedit  #id_folio_producto").val(data.id_folio_producto)
...
//alert (data.id_folio_producto)
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_folio_producto}  , function(data,status)
					{
						swalWithBootstrapButtons(
						'Eliminado!',
