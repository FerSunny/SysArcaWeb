...
$query="SELECT  * FROM cr_plantilla_ekg_img WHERE id_imagen='$idimagen'";
...
if($row = mysqli_fetch_array($resultado))
  ...
  if($row['estado'] == $activo)
    {
       $imagen="../img_ekg/".$row['fk_id_factura']."/".$row['nombre'];
      ...
      $query1="UPDATE cr_plantilla_ekg_img SET  estado='$suspendido' WHERE id_imagen='$idimagen'";
