...
{ 
	...
	$query = "INSERT INTO cr_plantilla_ekg_img(fk_id_empresa,fk_id_factura,fk_id_estudio,id_imagen,nombre,ruta,fecha_registro,estado,alto,ancho,img_x_hoja) VALUES ('$empresa','$numero_factura','$studio',0,'$nombre','$ruta','$fecha_registro' ,'$estado','$alt','$anc','$img_x_hoja')";
