...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  include("formularios/formularios_indicaciones.php");
  ?>

  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Tabla de Indicaciones
          <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nueva Indicacion</button>
      </h1>
  </div>
		<div class="row">
	...
	<script language="javascript" src="js/tabla_indicaciones.js"></script>
	<script>
