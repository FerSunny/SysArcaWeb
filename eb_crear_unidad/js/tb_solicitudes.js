...
function  productos(){
        ...
        {"data" : "desc_producto"},
                ...
                },
                {
                    render:function(data,type,row)
                    {
                        var existencias = row['existencias']
                        if(existencias == 'No')
                        {
                            return 'No Existe en almacen'
                        }else
        ...
        {"defaultContent" : "<button type='button' class='add btn btn-primary' data-toggle='modal' data-target='#modalEditar'><i class='fa fa-plus-circle'></button>"}
        ],
