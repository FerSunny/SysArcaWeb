...
session_start();
  ...
  $id_usuario=$_SESSION['id_usuario'];
    ...
    if ($fk_id_perfil==1 or $fk_id_perfil==13 or $fk_id_perfil==45 or $fk_id_perfil==46 or $fk_id_perfil==33) 
    {
      $condicion=' > 0';
    }
    else
...
WHERE pq.estado = 'A'
  ...
  AND DATE(fa.fecha_entrega) BETWEEN DATE_SUB(CURDATE(), INTERVAL 10 DAY) AND DATE_ADD(CURDATE(), INTERVAL 15 DAY)
