...
WHERE pq.estado = 'A'
  ...
  AND DATE(fa.fecha_entrega) BETWEEN DATE_SUB(CURDATE(), INTERVAL 36 DAY) AND DATE_ADD(CURDATE(), INTERVAL 15 DAY)
  AND pq.fk_id_estudio IN (SELECT DISTINCT fk_id_estudio FROM cr_plantilla_ekg WHERE estado = 'A')
 ) res
