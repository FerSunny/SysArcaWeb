...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  include("formularios/formularios_plantilla_colpo.php"); // CAMBIO programa de la forma
  ?>

  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Tabla de Plantillas Colposcopia<!-- CAMBIO Se cambia el titulo de la tabla -->
	...
	<script language="javascript" src="js/tabla_plantilla_colpo.js"></script> <!-- CAMBIO este JS -->
	<script>
