...
<div class="modal fade" id="myModals" role="dialog">
  <div > <!--class="modal-dialog"> Tamaño de la pantalla--> 
      ...
      <!-- Modal content-->
   <form name="AltasPlantilla_usg" action="controladores/registro_plantilla_colpo.php" method="post" >
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmEliminarvalor" action="controladores/eliminar_plantilla_colpo.php" method="POST">
