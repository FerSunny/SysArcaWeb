						...
						<form class="form-horizontal" role="form" id="form-factura" action="">
							...
							<!-- Mail  -->
								<label for="mail" class="col-md-1 control-label">Edad</label>
										<div class="col-md-3">
											<input type="text" class="form-control input-sm" id="mail" placeholder="Edad" >
										</div>
							</div>
							 ...
							 <div class="form-group row">
								...
								<!-- Botones  -->
									...
									<div class="form-group row">
								        ...
								        <div class="col-md-3">
								            <input type="text" class="form-control col-md-1" id="email-fac" name="email-fac" placeholder="Email del Medico" >
								        </div>
									</div>
