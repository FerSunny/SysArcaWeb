...
//echo $stmt;
	...
	while($row = $result->fetch_assoc())
    {
    	  ...
    	  $data[] = array(
					...
					"8" => $row['imp_total'],
					"9" => "
							<button type='button' class='btn btn-info btn-sm' onclick=update(".$row['estado_factura'].",". $row['id_factura'].",". $row['se_modifica'].",'".$row['telefono_fijo']."','".$row['anios']."')><span  class='fa fa-pencil fa-1x'></span></button>
