...
// listar datos en la tabla de perfiles
		var listar = function(){
					...
					*/
					//{"defaultContent": "<button type='button' class='editar btn btn-warning btn-md'><i class='fas fa-edit'></i></button>"},
					{
						render:function(data,type,row){
							var sigue_orden=row['sigue_orden']
							var maquila = row['maquila']

							if(sigue_orden == 2){
								return "<button disabled=true type='button' class='editar btn btn-warning btn-md'><i class='fas fa-edit'></i></button>"
							}else{
			...
			editar_maq("#dt_productos tbody", table)
...
var editar = function(tbody, table) {
		$(tbody).on("click", "button.editar", function() 
		{
				...
				$("#frmedit  #zapo").val(data.id_orden)
										 
				$("#frmedit  #estudio").val(data.estudio)

			
				$("#frmedit  #id_orden").val(data.id_orden)
					
				$("#frmedit  #pago").val(data.pago)
				/*
