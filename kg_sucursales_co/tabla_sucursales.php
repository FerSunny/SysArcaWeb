...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Tabla de Sucursales <!-- CAMBIO Se cambia el titulo de la tabla -->
          <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals" disabled><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nueva Sucursal</button> <!-- CAMBIO Se ca,bia el boton de altas -->
      </h1>
  </div>
		<div class="row">
