...
<head>
  ...
  <title>Diccionario conceptos</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    ...
    <h1 style="text-align: center;">Tabla de Conceptos  <!-- CAMBIO Se cambia el titulo de la tabla -->
...
// tomar el evento de municipios
    $("#form_productos select[name=estudio]").change(function()
    {
        select = $('#form_productos select[name=estudio]').val();
        //alert(select)
        ...
        $.ajax({
          type: "POST",                 
          url: "in_select_estudios.php?val=1",
          data:parametros ,
          beforeSend: function(){
          },
          success: function(data)            
            {
              $("#form_productos #concepto").html(data);
