...
// si viene vacio el estado 
if($_POST["fn_Estado_fed"] == '')
{
	$estado = 999;
}else
{
	$estado = $fn_Estado=$_POST["fn_Estado_fed"];
}
// si viene vacio municipio 
if($_POST["fn_municipio"] == '')
{
	$municipio = 999;
}else
{
	$municipio = $fn_Estado=$_POST["fn_municipio"];
}
...
{
	$localidad = $fn_Estado=$_POST["fn_Localidad"];
}
