...
*/
      ...
      $pdf->Cell(13,5,$row['hora'],0,0,'L');
      $pdf->Cell(22,5,$row['sucursal'],0,0,'L');
      $pdf->Cell(60,5,utf8_decode($row['cliente']),0,0,'L');
      $pdf->Cell(6,5,$row['estado'],0,0,'C');
      $pdf->Cell(6,5,$row['tipopago'],0,0,'C');
      //$pdf->Cell(5,5,$row['porc_descuento'],0,0,'R');
      $pdf->Cell(20,5,'$'.number_format($row['imp_total'],2),0,0,'R');
      $pdf->Cell(20,5,'$'.number_format($row['a_cuenta'],2),0,0,'R');
      $pdf->Cell(17,5,'$'.number_format($row['resta'],2),0,0,'R');
