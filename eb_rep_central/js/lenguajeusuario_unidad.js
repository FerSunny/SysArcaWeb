				...
				"columns":[
					...
					{ "data": "efectivo" },
					{
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='./reports/print_c_unidad.php?mes="+row['mes']+"&anio="+row['anio']+"&id_sucursal="+row['id_sucursal']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					}
				],
