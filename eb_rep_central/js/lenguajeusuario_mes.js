				...
				"columns":[
					...
					{ "data": "efectivo" },
					{
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='./reports/print_c_mes.php?mes="+row['mes']+"&anio="+row['anio']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					}
				],
