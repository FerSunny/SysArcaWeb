...
$("#form_productos").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/agregar_equipo_pza.php",                    
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_pieza)
				$("#frmedit  #pro").val(data.id_pieza)
				$("#frmedit  #codigo").val(data.id_pieza)

				$("#frmedit  #descripcion").val(data.desc_cambio)
				$("#frmedit  #cantidad").val(data.cantidad)
				$("#frmedit  #pieza").val(data.fk_id_producto)
				$("#frmedit  #autorizo").val(data.fk_id_usuario_aut)
...
$("#frmedit").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/editar_equipo_pza.php",                    
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar_equipo_pza.php", {'id_pieza' : data.id_pieza}  , function(data,status)
