		...
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				...
				var id_imagen = $("#frmedit #idimagen").val( data.id_imagen)
					   desc_imagen = $("#frmedit #edit1").val( data.fk_id_equipo)
					   desc_estudio = $("#frmedit #fi_desc_estudio").val( data.descripcion)
						nombre = $("#frmedit #fi_nombre").val( data.nombre)
						document.getElementById("img_01").src = "pdfs/"+data.fk_id_equipo+"/"+data.nombre
