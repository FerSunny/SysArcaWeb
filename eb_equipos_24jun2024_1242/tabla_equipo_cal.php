...
<head>
  ...
  <title>Equipos</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <?php
    ...
    include("formularios/formularios_equipo_cal.php"); // CAMBIO programa de la forma
  ...
  <div class="container" style="margin-top: 30px;">
    ...
    <h1 style="text-align: center;">Tabla de Mantenimientos  <!-- CAMBIO Se cambia el titulo de la tabla -->
      ...
      <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nuevo Evento</button> <!-- CAMBIO Se cambia el boton de altas -->

    </h1>

    <h3 style="text-align: center;">Mantenimientos programados para el equipo:  <?php echo $equipo ?> <!-- CAMBIO Se cambia el titulo de la tabla -->
  ...
  <script language="javascript" src="js/tabla_equipo_cal.js"></script>
