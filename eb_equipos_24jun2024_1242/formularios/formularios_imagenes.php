...
/*
  $sql="
  SELECT  eq.clave_id , eq.descripcion FROM eb_equipos_img eq
   ...
   <form name="AltasEstudio" action="controladores/registro_imagenes.php" method="post" enctype="multipart/form-data" id="fileforms">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h2 style="color:blue;text-align:center" class="modal-title">Nuevo Documento</h2>
...
<!-- Id nota -->
            <tr>
                <td class="renglon_titulo"> Equipo: </td>
                <td class="renglon_valor" class="form-control" >
                    <input type="text" name="fn_id_medico" id="fi_id_medico" readonly="readonly" maxlength="12" size="19" placeholder="Asignado por el sistema" value="<?php echo $id_equipo ?>" />
                </td>
            </tr>  
<!-- Id estudio 
            <tr>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="modalEliminarLabel">Ver Documento</h4>
            </div>
...
<!-- Nota -->              
              <div class="form-group">
                <label for="descripcion" class="col-sm-2 control-label">Equipo</label>
                <div class="col-sm-8">
...
<!-- nomb imagen -->              
              <div class="form-group">
                <label for="nombre_img" class="col-sm-2 control-label">PDF</label>
                <div class="col-sm-8">
...
-->
                  <iframe src="" id="img_01" type="application/pdf" width="150%" height="150%"></iframe>
                  <!--
