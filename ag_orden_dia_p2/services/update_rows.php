...
foreach($data as $objeto){
    ...
    $sql="INSERT INTO cr_plantilla_2_re(fk_id_empresa,fk_id_factura,fk_id_estudio,orden,tipo,concepto,valor,verificado,observaciones,num_imp,origen) VALUES (0,'$id_factura','$id_studio','$orden','$tipo','$concepto','$resultado','$verificado','$observaciones',1,'C')";
    //echo $sql;
