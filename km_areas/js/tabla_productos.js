					...
					success: function(data)            

						{
...

							{
								...
								swal('La clave del area ya existe')
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_area)

				$("#frmedit  #pro").val(data.id_area)

				$("#frmedit  #codigo").val(data.id_area)

				$("#frmedit  #clave").val(data.clave)

				$("#frmedit  #desc").val(data.desc_area)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_area}  , function(data,status)
