      ...
      <div class="modal-content">
        ...
        <div style="color:#000000;background:#EFFBF5" class="modal-body">
          ...
          <div class="col">
            <div class="md-form mt-0">
              <div class="md-form">
                  <input type="number" name="lote" id="lote" class="form-control" maxlength="100" required>
          ...
          <div class="col">
            <div class="md-form mt-0">
              <div class="md-form">
                  <input type="number" name="num_p" id="num_p" class="form-control" maxlength="100" >
          ...
          <div class="row">
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  <input type="date" value="01/01/2000" name="caducidad" id="caducidad" class="form-control" maxlength="100">
        ...
        <div class="modal-content">
          ...
          <div class="row">
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  <input type="date" name="caducidad" id="caducidad" class="form-control" maxlength="100" >
                  <label for="producto">Caducidad del producto</label>
                </div>
              </div>
            </div>
