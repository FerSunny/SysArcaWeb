		...
		var listar = function(){
			var table = $("#dt_cliente").DataTable({
				...
				"columns":[
					...
					{ "data": "afectacomision" },
					{ "data": "imp_total"},
					{"defaultContent" : "<button class='view btn btn-danger'><i class='fas fa-file-pdf'></i></button>"},
					{ "defaultContent" : "<button class='note btn btn-info'><i class='fas fa-sticky-note'></i></button>"}
