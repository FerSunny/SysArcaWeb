...
<div class="modal fade" id="myModals" role="dialog">
  <div class="modal-dialog">
      ...
      <!-- Modal content-->
   <form name="AltasPlantilla_2" action="controladores/registro_plantilla_2.php" method="post">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="frmEliminarvalor" action="controladores/eliminar_plantilla_2.php" method="POST">
