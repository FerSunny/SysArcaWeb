<?php
  ...
  $sql="SELECT  ui.id_imagen,ui.nombre FROM cr_plantilla_ekg_img ui
...
<div class="modal fade" id="myModals" role="dialog">
  <div class="modal-dialog">
      ...
      <!-- Modal content-->
   <form name="AltasEstudio" action="controladores/registro_imagenes.php" method="post" enctype="multipart/form-data">
...
<form id="frmedit" class="form-horizontal" action="controladores/actualizar.php" method="POST" enctype="multipart/form-data">
  <div class="row">
    <div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12 ocultar">
      <div class="modal fade modal"  id="modalEditar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="modalEliminarLabel"></h4>
            </div>
...
<!-- Imagen -->
              <div class="form-group">
                ...
                <div class="col-sm-8">
                  ...
                  <img src="" id="fi_imagen" alt="" width="400" >
