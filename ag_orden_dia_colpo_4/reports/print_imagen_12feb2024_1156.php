...
$sql_max="select count(id_imagen) as num_img FROM cr_plantilla_colpo_img
...
*/
    ...
    $this->SetFont('Arial','B',11);
    $this->SetXY(110,266); 
    $this->Write(0,'atencion.clientes@laboratoriosarca.com.mx');
    $this->SetTextColor(0,0,0);
...
$columna=13;
$renglon=53;
$sql_imagenes="select * FROM cr_plantilla_colpo_img
where estado = 'A' and fk_id_factura=".$numero_factura." and fk_id_estudio=".$studio;
//echo $sql_imagenes;
      ...
      if($num_img > 1){
        switch ($leido){
          case '1':
            ...
            $pdf->SetTextColor(0,64,255);
            $pdf->SetFillColor(255, 255, 51);
            $pdf->Cell(5,5,substr($nombre,0,1),0,0,'L',true);
            break;
          case '2':
            $columna=110;
            $renglon=53;
...
$pdf->SetXY(110,190);
$pdf->Cell(10,5,'1 Vulva',0,0,'L');
$pdf->Ln(5);
$pdf->Cell(100);
$pdf->Cell(10,5,'2 Vagina',0,0,'L');
$pdf->Ln(5);
$pdf->Cell(100);
$pdf->Cell(10,5,'3 Acido acetico',0,0,'L');
$pdf->Ln(5);
$pdf->Cell(100);
$pdf->Cell(10,5,'4 Filtro verde',0,0,'L');
$pdf->Ln(5);
$pdf->Cell(100);
$pdf->Cell(10,5,'5 Yodo lugol',0,0,'L');
