		...
		<form id="AltasEstudio" action="controladores/registro_colpos.php" method="post">
			<div class="modal-content">
				<div class="modal-header">
					...
					<h2 style="color:blue;text-align:center" class="modal-title">Registro de Nuevo Estudio</h2>
				</div>
				<div style="color:#000000;background:#EFFBF5" class="modal-body">
					<table border="0" align="center" BGCOLOR=#F5FBEF style="border-bottom:1px solid #819FF7">
						...
						<tr>
							<td><label></label></td>
							<td><input type="text" class="form-control" id="fi_titulo_desc" value="REPORTE DE COLPOSCOPIA" required name="fn_titulo_desc"  maxlength="50" size="50" placeholder="Titulo del estudio"></td>
						</tr>
						<tr>
							<td><label></label></td>
							<td>
			...
			<!-- Titulo otros allazgos -->
						<tr>
							<td><label></label></td>
							<td><input type="text" class="form-control" id="fi_t_allazgos" value="OTROS ALLAZGOS" required name="fn_t_allazgos"  maxlength="50" size="50" ></td>
						</tr>
			...
			<!-- Titulo otros diagnostico -->
						 <tr>
								<td><label></label></td>
								<td><input type="text" class="form-control" id="fi_t_diagnostico" value="DIAGNOSTICO COLPOSCOPICO" required name="fn_t_diagnostico"  maxlength="50" size="50" ></td>
						</tr>
			...
			<!-- Titulo comentarios y sugerencias -->
						 <tr>
								<td><label></label></td>
								<td><input type="text" class="form-control" id="fi_t_comenta" value="COMENTARIOS Y SUGUERENCIAS" required name="fn_t_comenta"  maxlength="50" size="50" ></td>
						</tr>
				...
				<div >
					<div class="modal-content">
						...
						<div class="modal-header">
						  ...
						  <h2 id="modalEliminarLabel" style="color:blue;text-align:center" class="modal-title">Modificar Estudio </h2>
						</div>
						...
						<div style="color:#000000;background:#EFFBF5" class="modal-body">
							<table border="0" align="center" BGCOLOR=#F5FBEF style="border-bottom:1px solid #819FF7">
								...
								<tr>
									<td><label></label></td>
									<td><input type="text" class="form-control" id="fi_titulo_desc" required name="fn_titulo_desc"  maxlength="50" size="50" placeholder="Titulo del estudio"></td>
								</tr>
								<tr>
									<td><label></label></td>
									<td>
					...
					<!-- Titulo otros allazgos -->
								<tr>
									<td><label></label></td>
									<td><input type="text" class="form-control" id="fi_t_allazgos" required name="fn_t_allazgos"  maxlength="50" size="50" ></td>
								</tr>
					<!-- descripcion otros allazgos -->
								<tr>
									<td><label></label></td>
					...
					<!-- Titulo otros diagnostico -->
								 <tr>
										<td><label></label></td>
										<td><input type="text" class="form-control" id="fi_t_diagnostico" required name="fn_t_diagnostico"  maxlength="50" size="50" ></td>
								</tr>
					<!-- descripcion diagnostico -->
								 <tr>
										<td><label></label></td>
					...
					<!-- Titulo comentarios y sugerencias -->
								 <tr>
										  <td><label></label></td>
										  <td><input type="text" class="form-control" id="fi_t_comenta" required name="fn_t_comenta"  maxlength="50" size="50" ></td>
								</tr>
					<!-- descripcion comentarios y sugerencias -->
								 <tr>
										<td><label></label></td>
      ...
      <div class="modal fade" id="modalEliminar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel">
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
              <h4 class="modal-title" id="modalEliminarLabel">Eliminar Estudio</h4>
            </div>
