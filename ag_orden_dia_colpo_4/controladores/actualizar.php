...
$query = " UPDATE  cr_plantilla_colpo_re SET titulo_desc='$fn_titulo_desc', descripcion='$fn_descripcion', t_otros_allazgos='$fn_t_allazgos', d_otros_allazgos = '$fn_d_allazgos', t_diagnostico='$fn_t_diagnostico',d_diagnostico='$fn_d_disgnostico',t_comentarios='$fn_t_comenta',d_comentarios='$fn_d_comenta'
...
if ($resultado) {
			...
			echo "<script>location.href='../tabla_colpo_papa.php'</script>";
		}
		else {
