...
$id_factura_new = $prefolio.substr("000{$ultimo_dia}", -$str_sucu);
 ...
 turno_hora,urgente,pendiente,fecha_ctl,cose_dia,id_factura_new,id_factura_old) 
 ...
 '$horaturno','$urgente_p','$pendiente_p',$prefolio,$ultimo_dia,$id_factura_new,0)";
// echo $sql;
