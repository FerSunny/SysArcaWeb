	...
	if($action == 'ajax'){
		if($fk_id_perfil=='1' or $fk_id_perfil=='45' or $fk_id_perfil=='33' or $fk_id_perfil=='46'){
		  ...
		  $sWhere.=" select id_factura,WHERE so_factura.fk_id_cliente=so_clientes.id_cliente and so_factura.fk_id_usuario=se_usuarios.id_usuario and so_factura.estado_factura!=5";
			...
			$sql="select  id_factura,numero_factura,fecha_factura,so_clientes.nombre,so_clientes.a_paterno,so_clientes.a_materno,so_factura.diagnostico,so_clientes.telefono_fijo,so_factura.estado_factura,so_factura.imp_total,so_clientes.anios as mail from so_factura, so_clientes, se_usuarios  WHERE so_factura.fk_id_cliente=so_clientes.id_cliente and so_factura.fk_id_usuario=se_usuarios.id_usuario and so_factura.estado_factura!=5 
                and DATE_SUB(CURDATE(), INTERVAL 45 DAY) <= DATE(so_factura.fecha_factura) 
