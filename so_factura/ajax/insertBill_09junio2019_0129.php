...
$fk_id_perfil=$_SESSION['fk_id_perfil'];
 ...
 $sql="INSERT INTO so_factura(fk_id_empresa,fk_id_sucursal,numero_factura,fecha_factura,fk_id_cliente,fk_id_medico,fk_id_usuario,afecta_comision,fk_id_tipo_pago,imp_subtotal,porc_descuento,porc_incremento,imp_total,a_cuenta,resta,observaciones,diagnostico,estado_factura,origen,fecha_hora_impresa,fecha_entrega,vmedico,estado_concilia,email_medico,email_paciente) VALUES (1,'$fk_id_sucursal','$numero_factura','$fecha_factura','$fk_id_cliente','$fk_id_medico','$fk_id_usuario','$afecta_comision','$fk_id_tipo_pago','$imp_subtotal','$porc_descuento','$porc_incremento','$imp_total','$a_cuenta','$resta','$observaciones','$diagnostico','$estado_factura','$origen','$fecha_factura','$fechaentrega','$medico_aux','A','$e_medico','$e_paciente')";
// echo $sql;
