...
$id_factura_new = $prefolio.substr("000{$ultimo_dia}", -$str_nota);
 ...
 turno_hora,urgente,pendiente,fecha_ctl,cose_dia,id_factura_new,id_factura_old,fk_id_conocio) 
 ...
 '$horaturno','$urgente_p','$pendiente_p',$prefolio,$ultimo_dia,$id_factura_new,0,$conocio)";
// echo $sql;
