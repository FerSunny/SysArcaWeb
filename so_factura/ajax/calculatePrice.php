...
for($i=0; $i<count($data['ids']); $i++) {
    ...
    //aplicando promocion
      $sqlPromocionXEstudio="select porcentaje,fecha_inicio,fecha_final,lunes,martes,miercoles,jueves,viernes,sabado,domingo,tuly,tuly2,greg,xochi,sant,pablo,pedro,teco,tete,tla,mil,estado from kg_promociones
