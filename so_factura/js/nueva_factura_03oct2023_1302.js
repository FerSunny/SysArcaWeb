            ...
            if ($('#form-factura').valid()) {
                ...
                if (new Date(newfecha) <= new Date($('#fechaentrega').val())) {
                    ...
                    if (jsonToInsert.saldo >= 0) {
                        ...
                        jsonToInsert.conocio = $('#conocio').val();
                        ...
                        var p7 = parseInt($('input:checkbox[name=whatsapp_p]:checked').val())
                        ...
                        if (p7 == 1) {
                            var val_pen = 1
                            jsonToInsert.whatsapp_p = val_pen
                        } else {
                            var val_pen = 0
                            jsonToInsert.whatsapp_p = val_pen
                        }
                                    ...
                                    setTimeout(function() {
                                        $.ajax({
                                            ...
                                            success: function(datas) {
                                                ...
                                                generateId = datas.id;
                                                idfacturanew = datas.id;
//console.log("idfacturanew-->", idfacturanew);
                                                $('#nombre_cliente').val('')
                                                $('#tel1').val('');
                                                $('#mail').val('');
                                                $('#correo').val('');
                            ...
                            idfacturanumber=parseInt(idfacturanew)
//console.log("idfacturanumber", idfacturanumber);
                            swal({
                                ...
                                cancelButtonText:
                                '<a style="color:white;text-color:white;" target="_blank" href="./reports/factura.php?numero_factura=' + idfacturanumber + '" onclick="openTikets(' + idfacturanumber  + ');"><span style="color:white;text-color:white;" class="glyphicon glyphicon-print"></span> Imprimir</a>',
