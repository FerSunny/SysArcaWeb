<?php
	...
	$sql="SELECT fk_id_cliente,fk_id_usuario,fk_id_medico,diagnostico,fecha_factura,afecta_comision,fecha_entrega,fk_id_tipo_pago,observaciones,estado_factura,imp_subtotal,porc_descuento,porc_incremento,a_cuenta,vmedico,email_medico,email_paciente,requiere_factura,publicidad,urgente,pendiente,whatsapp FROM  $table $where";
											...
											<div class="col-md-6 section_box">
												...
												<div style="display: inline-block; margin-right: 30px;">
													...
													<?php 
														...
														{
													?>
														<input type="checkbox" name="urgente_p" id="urgente_p" value="1" checked>
													<?php
														}
													?>
												</div>
												...
												<div style="display: inline-block; margin-right: 30px;">
													...
													<?php 
														...
														{
													?>
														<input type="checkbox" name="pendiente_p" id="pendiente_p" value="1" checked>
													<?php
														}
													?>
												</div>
												...
												<div style="display: inline-block; margin-right: 30px;">
													...
													<?php 
														...
														{
													?>
														<input type="checkbox" name="whatsapp_p" id="whatsapp_p" value="1" checked>
													<?php
														}
													?>
												</div>
