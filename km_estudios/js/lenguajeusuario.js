		...
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				...
				var id_estudio = $("#frmedit #idusuario ").val( data.id_estudio ),
						...
						estudio_orig=$("#frmedit #estudio_orig").val( data.fk_id_estudio_ori),
						estudio_maq=$("#frmedit #estudio_maq").val( data.fk_id_estudio_maq),
						...
						fk_id_plantilla = $("#frmedit #tipo_plantilla").val( data.fk_id_plantilla),
						...
						per_paquete = $("#frmedit #es_paq").val( data.per_paquete),
						...
						origen =$("#frmedit #edit16").val(data.origen),
						cubiculo =$("#frmedit #edit17").val(data.cubiculo),
						maquila =$("#frmedit #maquila").val(data.maquila),
						id_metodo =$("#frmedit #id_metodo").val(data.fk_id_metodo),
						id_area =$("#frmedit #id_area").val(data.fk_id_area),
						opcion = $("#frmedit #opcion").val("modificar");
