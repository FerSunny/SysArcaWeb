        ...
        <div class="modal-body">
         ...
         <tr>
                        ...
                        <tr>
                            ...
                            <td class="renglon_valor">
                                <select name="id_indicaciones" style="width:350px">
                                   <?php
                                      $sql="SELECT * FROM km_indicaciones WHERE activo = 'A'";
                                      $rec=mysqli_query($conexion,$sql);
                                      while ($row=mysqli_fetch_array($rec))
                                      {
                           ...
                           <tr>
                            ...
                            <td class="renglon_valor">
                                <select name="id_muestras" style="width:350px">
                                   <?php
                                      $sql="SELECT * FROM km_muestras WHERE estado = 'A'";
                                      $rec=mysqli_query($conexion,$sql);
                                      while ($row=mysqli_fetch_array($rec))
                                      {
            ...
            <div class="modal-body">
             ...
             <div class="form-group">
              ...
              <div class="col-sm-8"><input id="edit8" name="edit8" type="text" class="form-control" ></div>
                ...
                <div class="form-group">
                  <label for="apellidos" class="col-sm-2 control-label">P. Perfil</label>
