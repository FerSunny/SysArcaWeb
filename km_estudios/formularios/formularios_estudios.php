      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
         ...
         <tr>
                        ...
                        <tr>
                            <td class="renglon_titulo">Estudio Maquila: </td>
                            <td class="renglon_valor">
                                <select name="estudio_maq"style="width:350px" >
                                   <?php
                                      $sql="SELECT * FROM km_estudios WHERE estatus = 'A' AND grupo_estudio = 1";
                                      $rec=mysqli_query($conexion,$sql);
                                      while ($row=mysqli_fetch_array($rec))
                                      {
                                        echo "<option value='".$row['id_estudio']."' >";
                        ...
                        <tr>
                            ...
                            <td class="renglon_valor">
                                <input type="text" required name="desc_estudio" maxlength="100" size="50" placeholder="Descripcion"/>
                             </td>
                        </tr>
...
<!-- Metodo -->
                         <tr>
                          <td class="renglon_titulo">Metodo: </td>
                          <td class="renglon_valor">
                              <select name="id_metodo" name="id_metodo" style="width:350px" required>
                                 <?php
                                    $sql="SELECT * FROM km_metodos WHERE estado = 'A' ORDER BY desc_metodo";
                                    $rec=mysqli_query($conexion,$sql);
                                    while ($row=mysqli_fetch_array($rec))
                                    {
                                      echo "<option value='".$row['id_metodo']."' >";
                                      echo $row['desc_metodo'];
                                      echo "</option>";
                                    }
                                 ?>
                              </select>
...
<!-- Area -->
                         <tr>
                          ...
                          <td class="renglon_valor">
                              <select name="id_area" name="id_area" style="width:350px" required>
                                 <?php
                                    $sql="SELECT * FROM km_areas WHERE estado = 'A' ORDER BY desc_area";
                                    $rec=mysqli_query($conexion,$sql);
                                    while ($row=mysqli_fetch_array($rec))
                                    {
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <input type="hidden" id="idusuario" name="idusuario" value="0">
                ...
                <div class="form-group">
                      <label for="nombre" class="col-sm-2 control-label">Estudio Maquila</label>
                    
                          <select class="selectpicker" style="width:350px" name="estudio_maq" id="estudio_maq" required  >
                              <?php
                              $sql="SELECT * FROM km_estudios WHERE estatus = 'A' AND grupo_estudio = 1 order by desc_estudio";
                              $rec=mysqli_query($conexion,$sql);
                              while ($row=mysqli_fetch_array($rec))
                              {
...
<!-- Metodo -->
                         <tr>
                          <td class="renglon_titulo">Metodo: </td>
                          <td class="renglon_valor">
                              <select name="id_metodo" id="id_metodo" style="width:350px" required>
                                 <?php
                                    $sql="SELECT * FROM km_metodos WHERE estado = 'A' ORDER BY desc_metodo";
                                    $rec=mysqli_query($conexion,$sql);
                                    while ($row=mysqli_fetch_array($rec))
...
<!-- Metodo -->
                        <br>
                         <tr>
                          <td class="renglon_titulo">Area: </td>
                          <td class="renglon_valor">
                              <select name="id_area" id="id_area" style="width:350px" required>
                                 <?php
                                    $sql="SELECT * FROM km_areas WHERE estado = 'A' ORDER BY desc_area";
                                    $rec=mysqli_query($conexion,$sql);
                                    while ($row=mysqli_fetch_array($rec))
