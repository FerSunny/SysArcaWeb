...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
	...
	<title>Menus</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Tabla de Menus y Sub-menus  <!-- CAMBIO Se cambia el titulo de la tabla -->
          <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nuevo Menu</button> <!-- CAMBIO Se cambia el boton de altas -->
      </h1>
  </div>
		<div class="row">
	...
	<script language="javascript" src="js/tabla_menus.js"></script> <!-- CAMBIO este JS -->
	<script>
