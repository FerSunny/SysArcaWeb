...
$query= "INSERT INTO se_usuarios (fk_id_empresa,id_usuario,id_usr,fk_id_sucursal,pass,activo,fk_id_perfil,fk_id_servicio,nombre,a_paterno,a_materno,iniciales,telefono_fijo,telefono_movil,direccion,mail, entra, salida, entra_s, salida_s, entra_d, salida_d, entra_f, salida_f, fecha_registro,fecha_actualizacion, usr_conex) VALUES('$empresa','0','$fn_id_usr','$fn_sucursal','$fn_pass','$fn_estado','$fn_perfil','$fn_servicio','$fn_nombre','$fn_apaterno','$fn_amaterno','$fn_iniciales','$fn_tfijo','$fn_tmovil','$fn_direccion','$fn_mail', '$fn_entra', '$fn_salida', '$fn_entra_s', '$fn_salida_s', '$fn_entra_d', '$fn_salida_d', '$fn_entra_f', '$fn_salida_f', '$fn_falta','$fn_factualiza', '$fn_user')";
