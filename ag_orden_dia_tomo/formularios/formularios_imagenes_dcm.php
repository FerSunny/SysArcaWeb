...
<div class="modal fade" id="myModals" role="dialog">
  <div class="modal-dialog">
      ...
      <!-- Modal content-->
   <form name="AltasEstudio" action="controladores/registro_imagenes_dcm.php" method="post" enctype="multipart/form-data" id="fileforms">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h2 style="color:blue;text-align:center" class="modal-title">Nueva Imagen DICOM</h2>
             ...
             <tr>
                  <div class="form-group row" align="">
                    <div class="col-xs-8">
                      ...
                      <td><input type="file" class="form-control" id="fn_archivo"  webkitdirectory mozdirectory msdirectory odirectory directory required name="fn_archivo"  ></td>
                       webkitdirectory mozdirectory msdirectory odirectory directory 
                    </div>
                  </div>
            </tr>
          -->
<!-- nombre del fichero que se guarar en el cloud -->

            <tr>
              <td>  <label for="" class="col-sm-2 control-label">Carpeta:</label></td>
              <td>  <div class="form-group">
                <input type="text" name="fn_nombre_cloud" id="fn_nombre_cloud"  maxlength="20" size="20" value="<?php echo $numero_factura; ?>" placeholder="Nombre de la carpeta" />
              </div></td>
            </tr>
 
            <tr>
              Asegurese de insertar el CD que corresponde al folio
            </tr>            
...
<!--Editar imagenes-->
<form id="frmedit" class="form-horizontal" action="controladores/actualizar_dcm.php" method="POST" enctype="multipart/form-data">
  <div class="row">
...
<!-- nombre del fichero que se guarar en el cloud 
            ...
            <tr>
                <td>  <label for="" class="col-sm-2 control-label">Nombre CLOUD</label></td>
                <td>  <div class="form-group">
                  <input type="text" name="fn_nombre_cloud" id="fn_nombre_cloud"  maxlength="15" size="15" placeholder="Nombre de la carpeta" />
                </div></td>
            </tr>
-->              
              <div class="form-group">
...
<!-- Modal Eliminar-->
<form id="frmEliminarzona" action="controladores/eliminar_imagenes_dcm.php" method="POST">
