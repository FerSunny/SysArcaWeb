...
// listar datos en la tabla de perfiles
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				"ajax":{
					"method":"POST",
					"url": "listar_areas.php"
				},
				"columns":[
					{"data" : "id_estudio_area"},
          {"data" : "fk_id_clave_area"},
					{"data" : "desc_area"},     
...
var agregar= function(tbody, table) {
    $(tbody).on("click", "button.agregar", function() 
    {
        ...
        $("#form_productos  #dc").val(data.id_area)
        $("#form_productos  #dep").val(data.id_area)
...
var editar = function(tbody, table) {
    $(tbody).on("click", "button.editar", function() 
    {
        ...
        $("#frmedit  #codigo").val(data.id_estudio_area)
        $("#frmedit  #area").val(data.id_area)
...
var eliminar= function(tbody, table) {
    $(tbody).on("click", "button.eliminar", function() {
      ...
      swalWithBootstrapButtons({
        ...
        if (result.value) {
           $.post("./controladores/eliminar_producto.php", {'id_estudio_area' : data.id_estudio_area}  , function(data,status)
          {
            swalWithBootstrapButtons(
            'Eliminado!',
