...
<head>
  ...
  <title>Cervix</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <?php
    ...
    include("formularios/formularios_cervix.php"); // CAMBIO programa de la forma
  ...
  <div class="container" style="margin-top: 30px;">
    ...
    <h1 style="text-align: center;">Tabla Cervix  <!-- CAMBIO Se cambia el titulo de la tabla -->

      <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nuevo Cervix</button> <!-- CAMBIO Se cambia el boton de altas -->
  ...
  <script language="javascript" src="js/tabla_cervix.js"></script>
