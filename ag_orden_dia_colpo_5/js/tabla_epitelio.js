...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_epitelio)

				$("#form_productos  #pro").val(data.id_epitelio)
...
$("#form_productos").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/agregar_epitelio.php",                    
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_epitelio)

				$("#frmedit  #pro").val(data.id_epitelio)

				$("#frmedit  #codigo").val(data.id_epitelio)

				$("#frmedit  #epitelio").val(data.desc_epitelio)
...
$("#frmedit").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/editar_epitelio.php",                    
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar_epitelio.php", {'id_producto' : data.id_epitelio}  , function(data,status)
