...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_colpo)

				$("#form_productos  #pro").val(data.id_colpo)
...
$("#form_productos").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/agregar_colpo.php",                    
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_colpo)

				$("#frmedit  #pro").val(data.id_colpo)

				$("#frmedit  #codigo").val(data.id_colpo)

				$("#frmedit  #colpo").val(data.desc_colpo)
...
$("#frmedit").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/editar_colpo.php",                    
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar_colpo.php", {'id_producto' : data.id_colpo}  , function(data,status)
