...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_zona)

				$("#form_productos  #pro").val(data.id_zona)
...
$("#form_productos").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/agregar_zona.php",                    
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_zona)

				$("#frmedit  #pro").val(data.id_zona)

				$("#frmedit  #codigo").val(data.id_zona)

				$("#frmedit  #zona").val(data.desc_zona)
...
$("#frmedit").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/editar_zona.php",                    
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar_zona.php", {'id_producto' : data.id_zona}  , function(data,status)
