...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_borde)

				$("#form_productos  #pro").val(data.id_borde)
...
$("#form_productos").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/agregar_bordes.php",                    
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_borde)

				$("#frmedit  #pro").val(data.id_borde)

				$("#frmedit  #codigo").val(data.id_borde)

				$("#frmedit  #borde").val(data.desc_borde)
...
$("#frmedit").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/editar_bordes.php",                    
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar_bordes.php", {'id_producto' : data.id_borde}  , function(data,status)
