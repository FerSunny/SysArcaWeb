...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_cervix)

				$("#form_productos  #pro").val(data.id_cervix)
...
$("#form_productos").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/agregar_cervix.php",                    
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_cervix)

				$("#frmedit  #pro").val(data.id_cervix)

				$("#frmedit  #codigo").val(data.id_cervix)

				$("#frmedit  #cervix").val(data.desc_cervix)
...
$("#frmedit").on('submit', function (e) 

	{
			...
			$.ajax({
					...
					url: "controladores/editar_cervix.php",                    
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar_cervix.php", {'id_producto' : data.id_cervix}  , function(data,status)
