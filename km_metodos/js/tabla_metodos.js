...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_metodo)

				$("#form_productos  #pro").val(data.id_metodo)
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_metodo)

				$("#frmedit  #pro").val(data.id_metodo)

				$("#frmedit  #codigo").val(data.id_metodo)

				$("#frmedit  #desc_larga").val(data.desc_metodo)

				$("#frmedit  #desc_corta").val(data.desc_corta)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_metodo' : data.id_metodo}  , function(data,status)
