...
CASE
  WHEN fk_id_estudio in (5,274,963,988,69,459,1029) THEN
        CONCAT(valor_refe) 
  ELSE
...
// termina valor
      ...
      //Obtiene la cadena para encriptacion
      $cadena = "";
      ...
      $pdf->Cell(70,5,'Codigo de seguridad ARCA',0,0,'L');
      $pdf->ln(6);
      $pdf->MultiCell(200,5,base64_encode($cadena),0,'L');
      if($hay_obs=='1'){
          $pdf->ln(4);
          $pdf->Cell(9);
