...
//LPAD(valor ,12,' ') -- CONCAT(valor,'  ',unidad_medida,verificado) as 
    $sql="(select valor as valor_solo,tipo,orden,concepto,concat(LPAD(trim(valor),17,' '),' ',unidad_medida,verificado) as valor,concat(unidad_medida,verificado) as unidad_medida,verificado,observaciones,CASE
