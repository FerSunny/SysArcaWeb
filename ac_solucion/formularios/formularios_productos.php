						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<label for="descripcion">Describa detalladamente la situacion</label>
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<textarea class="form-control" id="procede" name="procede"rows="1"required readonly></textarea>

									<label for="observaciones">Procede</label>
									...
									<option value="" class="z-depth-5">Seleccione</option>
										...
										<?php 
												...
												$query = $conexion -> query("SELECT id_estatus, desc_estatus FROM kg_queja_estatus 
													WHERE estado = 'A' AND id_estatus IN (8,7,3) ");
