			...
			var table=$('#dt_agenda').DataTable({
				...
				"columns":[
					...
					},
					{
						render:function(data,type,row){
							...
							if(perfil==1){
							    ...
							    return "<form-group style='text-align:center;'>"+
    							"<button  id='out'  type='button' class='btn btn-info btn-md'><span  class='fa fa-hand-paper-o fa-1x'></span></button>"+
    							"</form-group>";
					...
					},
					{
						render:function(data,type,row){
							...
							if(perfil==1){
							    ...
							    return "<form-group style='text-align:center;'>"+
    							"<a id='out' style='color:white;' class='btn btn-info btn-md' role='button'><span  class='fa fa-hand-paper-o '></span></a>"+
    							"</form-group>";
							}
							},
					},
					{
						render:function(data,type,row)
						{
							return "<form-group class='btn_print' style='text-align:center; display:none;'>"+
									...
									"</form-group> <form-group class='btn_noprint' style='text-align:center; display:none;'>"+
								"<a id='printer' target='_blank'  class='clikc_btn btn btn-warning btn-md' role='button'><span  class='fa fa-ban'></span></a>"+
								"</form-group>";
						},
					}
					/*,
					{
						render:function(data,type,row){
							return "<form-group style='text-align:center;'>"+
							"<a id='mail' target='_blank' href='./reports/print_result_mail.php?numero_factura="+row['id_factura']+"&studio="+row['fk_id_estudio']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-envelope'></span></a>"+
							"</form-group>";
							},
					}
					*/
