				...
				"columns":[
					...
					},
					{
						render:function(data,type,row){
							...
							if(perfil==1){
    							return "<form-group style='text-align:center;'>"+
    							"<button  id='edit'  type='button' class='btn btn-info btn-md'><i class='fas fa-pencil-alt'></i></button>"+
    							"</form-group>";
							}else{
							    return "<form-group style='text-align:center;'>"+
					...
					},
					{
						render:function(data,type,row)
						{
							return "<form-group class='btn_print' style='text-align:center; display:none;'>"+
								...
								"<a id='printer' target='_blank'  class='clikc_btn btn btn-warning btn-md' role='button'><i class='fas fa-ban'></i></a>"+
								"</form-group>";
						},
					},
					{
