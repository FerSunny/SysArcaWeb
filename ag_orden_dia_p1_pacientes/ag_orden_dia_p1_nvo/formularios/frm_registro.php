...
<html lang="en">
  ...
  <div class="container">
      ...
      <div class="card-body">
        ...
        <table id="t_plantilla2" class="compact cell-border hover table-responsive" style="width:100%">
            <thead>
              <tr>
                <th> Orden </th>
                <th> Tipo </th>
            ...
            <tbody>
              ...
              ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <input class="form-control" type="text" required name="fn_resultado<?php echo $i?>" id="fi_resultado<?php echo $i?>" maxlength="20" size="20" placeholder="Escriba el valor" value="<?php if($id_estudio == '274' or $id_estudio == '963' or $id_estudio == '988'){
                                                          switch ($concepto) {
                                                              case 'DENSIDAD':
                                                                  $default_v='1.030';
                                                                  break;
