...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_ingreso)

				$("#form_productos  #pro").val(data.id_ingreso)
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_ingreso)

				$("#frmedit  #pro").val(data.id_ingreso)

				$("#frmedit  #codigo").val(data.id_ingreso)

				$("#frmedit  #nota").val(data.nota)

				$("#frmedit  #costo").val(data.importe)

				$("#frmedit  #gasto").val(data.fk_id_gasto)

				$("#frmedit  #cajero").val(data.fk_id_usuario_caj)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_ingreso' : data.id_ingreso}  , function(data,status)
