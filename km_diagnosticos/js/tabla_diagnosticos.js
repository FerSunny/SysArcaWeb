...
// listar datos en la tabla de comisiones
		var listar = function(){
			...
			obtener_data_editar("#dt_diagnostico tbody", table);
			obtener_id_eliminar("#dt_diagnostico tbody", table);
		}
// editamos estado civil
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				var data = table.row( $(this).parents("tr") ).data();
				var id_diagnostico = $("#frmedit #id_diagnostico").val( data.id_diagnostico),
					   desc_diagnostico= $("#frmedit #fi_diagnostico").val( data.desc_diagnostico),
...
// eliminndo la comision
		var obtener_id_eliminar = function(tbody, table){
			$(tbody).on("click", "button.eliminar", function(){
				var data = table.row( $(this).parents("tr") ).data();
				var id_diagnostico = $("#frmEliminaredocivil #id_diagnostico").val( data.id_diagnostico );
				 desc_diagnostico =$("#frmEliminaredocivil #fi_diagnostico").val(data.desc_diagnostico);
