				...
				"columns":[
					...
					{ "data": "participacion" },
					{
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='reports/participa_resumen_unidad.php?id_sucursal="+row['id_sucursal']+"&periodo="+row['periodo']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					},
					{
						render:function(data,type,row){
							return "<form-group style='text-align:center;'>"+
							"<a id='printer' target='_blank' href='reports/recibos_pago_unidad.php?id_sucursal="+row['id_sucursal']+"&periodo="+row['periodo']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					},
					{
						render:function(data,type,row){
							return "<form-group style='text-align:center;'>"+
							"<a id='printer' target='_blank' href='reports/participa_firmas_unidad.php?id_sucursal="+row['id_sucursal']+"&periodo="+row['periodo']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
							"</form-group>";
							},
					}
