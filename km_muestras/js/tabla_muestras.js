		...
		var obtener_data_editar = function(tbody, table){
			$(tbody).on("click", "button.editar", function(){
				...
				var id_muestra = $("#frmedit #idusuario").val( data.id_muestra ),
						id_muestra = $("#frmedit #edit1").val( data.id_muestra ),
						desc_muestra = $("#frmedit #edit2").val( data.desc_muestra),
						 recoleccion= $("#frmedit #edit3").val( data.recoleccion),
						 cantidad = $("#frmedit #edit4").val( data.cantidad),
						 estado = $("#frmedit #edit5").val(data.estado);
						console.log(data);
		...
		var obtener_id_eliminar = function(tbody, table){
			$(tbody).on("click", "button.eliminar", function(){
				var data = table.row( $(this).parents("tr") ).data();
				var id_muestra= $("#frmEliminarUsuario #idusuario").val( data.id_muestra );
				 desc_muestra =$("#frmEliminarUsuario #usuario").val(data.desc_muestra);
