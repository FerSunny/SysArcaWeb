...
<head>
	<meta charset="UTF-8">
	<title>Administracion de Muestras</title>
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  include("formularios/formularios_muestras.php");
  ?>

  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Tabla de Muestras
          <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nueva Muestra</button>
      </h1>
  </div>
		<div class="row">
	...
	<script language="javascript" src="js/tabla_muestras.js"></script>
	<script>
