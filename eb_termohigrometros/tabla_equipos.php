...
<head>
  ...
  <title>termohigrometros</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    ...
    <h1 style="text-align: center;">Tabla de Termohigrometros  <!-- CAMBIO Se cambia el titulo de la tabla -->

      <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nuevo Termohigrometros</button> <!-- CAMBIO Se cambia el boton de altas -->
      ...
      <table id="dt_productos" class="table table-bordered table-hover" cellspacing="1" width="100%">
        ...
        <thead>
          ...
          <tr>
            ...
            <th>Proveedor</th>
            <th>Temperatura de Calibracion</th>
            <th>Humedad</th>
            <th>Exactitud</th>
            <th>Editar</th>
            <th>Eliminar</th>
