...
$permitidos = array("image/gif","image/png","image/jpeg","image/jpg","image/bmp");
$limite_kb = 1500;
...
{ 
	...
	$query = "INSERT INTO cr_plantilla_usg_img(fk_id_empresa,fk_id_factura,fk_id_estudio,id_imagen,nombre,ruta,fecha_registro,estado,alto,ancho,img_x_hoja) VALUES ('$empresa','$numero_factura','$studio',0,'$nombre','$ruta',NOW() ,'$estado','$alt','$anc','$img_x_hoja')";
