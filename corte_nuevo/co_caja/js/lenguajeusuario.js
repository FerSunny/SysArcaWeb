...
// y cualquier otro usuario, solo puede imprimir, del dia.
						...
						render:function(data,type,row){
							...
							if(id_perfil == 1)
							{
								...
								"<a id='printer' target='_blank' href='./reports/print_c_diario.php?id_sucursal="+row['id_sucursal']+"&fecha_factura="+row['fecha_factura']+"&fk_id_usuario="+row['fk_id_usuario']+"' class='btn btn-warning btn-md' role='button'><span  class='fa fa-print'></span></a>"+
								"</form-group>";
							}else
							{
								if(se_imprime == 1 )
								...
								{
									return "<form-group style='text-align:center;'>"+
									"<a id='printer'  class='btn btn-warning btn-md' role='button'> <span   class='fa fa-stop'>  </span></a>"+
									"</form-group>";
								}
							}
