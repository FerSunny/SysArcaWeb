...
$sql="select su.`desc_sucursal` AS unidad,
...
// Segunda linea
    ...
    $this->Cell(2);
    $this->SetFont('Arial','',10);
    $this->Cell(32,5,'Pendiente Ingreso:',0,0,'L');
    $this->SetFont('Arial','',10);
...
// titulos 
    ...
    $this->Cell(5,5,'#',0,0,'R');
    $this->Cell(25,5,'Unidad',0,0,'C');
    $this->Cell(9,5,'Fols',0,0,'C');
    $this->Cell(10,5,'Can',0,0,'C');
    $this->Cell(23,5,'Importe',0,0,'C');
    $this->Cell(21,5,'Saldo',0,0,'C');
    $this->Cell(23,5,'Caja',0,0,'C');
    $this->Cell(23,5,'Pago Efec.',0,0,'C');
    $this->Cell(18,5,'Pago Cheq.',0,0,'C');
    $this->Cell(18,5,'Pago Tran.',0,0,'C');
    $this->Cell(18,5,'Pago Cred.',0,0,'C');
    $this->ln(1);
    $this->Cell(9);
...
$sql="select date(fa.fecha_factura) fecha_factura,
...
*/
      ...
      $pdf->Cell(25,5,$row['fecha_factura'],0,0,'L');
