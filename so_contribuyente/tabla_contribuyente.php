...
<head>
	...
	<title>Tabla de Contribuyentes</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  	...
  	<div class="container" style="margin-top: 30px;">
      	<h1 style="text-align: center;">Tabla de Contribuyentes  <!-- CAMBIO Se cambia el titulo de la tabla -->
      <!--    	<button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nuevo Uso</button> 
	...
	<div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12"> <!-- REVISAR -->
		...
		<div class="container table-responsive">
			<table id="dt_contribuyente" class="table table-bordered table-hover" cellspacing="1" width="100%">
				<thead>
					<tr>
	...
	<script language="javascript" src="js/tb_contribuyente.js"></script>
</body>
</html>
<?php
