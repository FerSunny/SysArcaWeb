...
<head>
  ...
  <title>Hidromometros</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    ...
    <h1 style="text-align: center;">Tabla de Hidromometros  <!-- CAMBIO Se cambia el titulo de la tabla -->

      <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Nuevo Hidromometro</button> <!-- CAMBIO Se cambia el boton de altas -->
