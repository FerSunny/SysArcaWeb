...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_hidro)

				$("#frmedit  #pro").val(data.id_hidro)

				$("#frmedit  #codigo").val(data.id_hidro)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_hidro}  , function(data,status)
