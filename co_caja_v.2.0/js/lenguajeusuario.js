		...
		var listar = function(){
			...
			var table = $("#dt_cliente").DataTable({
				...
				"columns":[
					...
					{ "data": "cerrada" },
					{
// se aplica la rutina para que el admin pueda imprimir, cual quier dia
// y cualquier otro usuario, solo puede imprimir, del dia.

						render:function(data,type,row){
							var id_perfil=row['id_perfil']
							var se_imprime=row['se_imprime']
							var cerrada=row['cerrada']
							...
							if(cerrada == 'N'){
								...
								if(id_perfil == 1)
								{
									...
									"<a id='printer' target='_blank' href='./reports/print_c_diario.php?id_sucursal="+row['id_sucursal']+"&fecha_factura="+row['fecha_factura']+"&fk_id_usuario="+row['fk_id_usuario']+"' class='btn btn-success btn-md' role='button'><span  class='fa fa-print'></span></a>"+
									"</form-group>";
								}else
								{
									if(se_imprime == 1 )
									...
									{
										return "<form-group style='text-align:center;'>"+
										"<a id='printer'  class='btn btn-danger btn-md' role='button'> <span   class='fa fa-stop'>  </span></a>"+
										"</form-group>";
									}
								}
							}else{
								return "<form-group style='text-align:center;'>"+
								"<a id='printer' disable class='btn btn-danger btn-md' role='button'> <span   class='fa fa-stop'>  </span></a>"+
								"</form-group>";
							}
