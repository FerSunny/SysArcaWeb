...
session_start();
  ...
  //$fk_id_sucursal=$_SESSION['fk_id_sucursal'];
	...
	$query = "SELECT su.id_sucursal,
  su.desc_sucursal AS unidad, 
...
GROUP BY su.id_sucursal,su.desc_sucursal,YEAR(fa.fecha_factura),MONTH(fa.fecha_factura),CONCAT(MONTHNAME(fa.fecha_factura),'-',YEAR(fa.fecha_factura))
";
