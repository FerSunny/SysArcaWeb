...
// listar datos en la tabla de perfiles
		...
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				//	{"defaultContent": "<button type='button' class='editar btn btn-success btn-md'><i class='fa fa-check'></i></button>"},

					{
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank' href='../so_entregas/tabla_detalle.php?id_sucursal="+row['id_sucursal']+"&servicio="+row['id_tipo_estudio']+"' class='btn btn-success btn-md'  role='button'><span class='fa fa-check' style='color:white;'></span></a>"+
							"</form-group>";
...

					{
						render:function(data,type,row){
							...
							return "<form-group style='text-align:center;'>"+
							"<a id='printer' target='_blank' href='../so_entregas/reports/report_detalle.php?id_sucursal="+row['id_sucursal']+"&servicio="+row['id_tipo_estudio']+"' class='btn btn-primary btn-md'  role='button'><span class='fa fa-envelope' style='color:white;'></span></a>"+
							"</form-group>";
					...
					//{"defaultContent":"<button type='button' class='eliminar btn btn-primary btn-md'><i class='fa fa-envelope'></i></button>"}
