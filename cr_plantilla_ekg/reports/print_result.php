...
$sql="select nombre_plantilla,titulo_desc,descripcion,firma FROM cr_plantilla_ekg
...
*/
        ...
        $pdf->MultiCell(185,5,utf8_decode($row['descripcion']),0,'J');
        $pdf->ln(5);

        $pdf->SetFont('Arial','B',10);
        $pdf->MultiCell(170,5,utf8_decode(trim($row['firma'])),0,'L');
