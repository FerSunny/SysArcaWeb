...
$query = "UPDATE  cr_plantilla_ekg SET nombre_plantilla = '$fn_nombre',fk_id_medico='$fn_medico',fk_id_estudio = '$fn_estudio',titulo_desc='$fn_titulo_desc' ,descripcion = '$fn_descripcion' , estado='$fn_estado',firma='$fn_firma' WHERE fk_id_empresa = 1 and  id_plantilla='$id_plantilla'";
...
if ($resultado) {
			...
			echo "<script>location.href='../tabla_plantilla.php'</script>";
		}
		else {
			echo $query;
