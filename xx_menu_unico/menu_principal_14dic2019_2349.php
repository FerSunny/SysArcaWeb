    ...
    <div class="collapse navbar-collapse" id="basicExampleNav">
      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link" id="navbarDropdownMenuLink"></a>
        </li>
        <li class="nav-item dropdown">
      ...
      <!--Slides-->
        <div class="carousel-inner" role="listbox">
          ...
          <div class="carousel-item active">
            <div class="view">
              <img class="d-block w-100" src="../so_carrucel/<?php echo $img['ruta_img']; ?>"
                alt="">
            </div>
            <div class="carousel-caption">
              <h3 class="h3-responsive" style=" color:black; font-weight: 900;"><?php echo  $img['titulo']; ?></h3>
              <p style="color:black; font-weight: 900;"><?php echo $img['subtitulo']; ?></p>
            </div>
          </div>
          <?php
                }else
          ...
          <div class="carousel-item active">
            <div class="view">
              <img class="d-block w-50" src="../so_carrucel/<?php echo $img['ruta_img']; ?>"
