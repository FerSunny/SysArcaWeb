...
<head>
  ...
  <title>Analitos</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  <?php
    ...
    include("formularios/formularios_analitos.php"); // CAMBIO programa de la forma
  ?>

  <div class="container" style="margin-top: 30px;">
    <h1 style="text-align: center;">Tabla de Analitos  <!-- CAMBIO Se cambia el titulo de la tabla -->
      <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-heart" aria-hidden="true"></i>&nbsp;Nuevo Analito</button> <!-- CAMBIO Se cambia el boton de altas -->
    </h1>
  </div>
  ...
  <script language="javascript" src="js/tabla_analitos.js"></script>
</body>
</html>
<?php
