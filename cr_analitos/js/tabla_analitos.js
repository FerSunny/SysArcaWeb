...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_analito)

				$("#form_productos  #pro").val(data.id_analito)
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_analito)

				$("#frmedit  #codigo").val(data.id_analito)

				$("#frmedit  #pro").val(data.id_analito)

				$("#frmedit  #desc_analito").val(data.desc_analito)

				$("#frmedit  #abreviacion").val(data.abreviacion)

				$("#frmedit  #fk_id_sexo").val(data.fk_id_sexo)

				$("#frmedit  #edad_inicial").val(data.edad_inicial)

				$("#frmedit  #edad_final").val(data.edad_final)

				$("#frmedit  #limite_inferior").val(data.limite_inferior)

				$("#frmedit  #limite_superior").val(data.limite_superior)

				$("#frmedit  #fk_id_unidad_medida").val(data.fk_id_unidad_medida)

				$("#frmedit  #qs_680").val(data.qs_680)

				$("#frmedit  #xn_550").val(data.xn_550)
