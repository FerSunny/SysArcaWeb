...
session_start();
$id_factura=$_GET['numero_factura'];
//$studio=$_GET['studio'];
//
$_SESSION['id_factura']=$id_factura;

//echo 'en tabla-->'.$id_factura;
...
<head>
  ...
  <title>Recoleccion</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  <?php
    ...
    include("formularios/formularios_agenda.php"); // CAMBIO programa de la forma
  ?>

  <div class="container" style="margin-top: 30px;">
    <h1 style="text-align: center;">Tabla de medios de recoleccion FOLIO #<?php echo $id_factura; ?>  <!-- CAMBIO Se cambia el titulo de la tabla -->
      <!--
  ...
  <input type="hidden" name="factura" id="factura" value="<?php echo $id_factura ?> "> 
  <input type="hidden" name="studio" id="studio" value="<?php echo $studio ?> "> 
...
-->
  ...
  <script language="javascript" src="js/tabla_tubos.js"></script>
</body>
</html>
