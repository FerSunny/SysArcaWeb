					...
					success: function(data)            

						{
...

							{
								...
								swal('El codigo del turno ya existe')
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_turno)

				$("#frmedit  #pro").val(data.id_turno)

				$("#frmedit  #codigo").val(data.codigo)

				$("#frmedit  #turno").val(data.desc_turno)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_turno' : data.id_turno}  , function(data,status)
