...
<form method="post" action=".././contradores/agregar_internet.php">
...
<br>
<h3 align="right"><font id="pg">Que sucursal desea evaluar?</font> <font style="color: aliceblue;"> sasasasa</font> 
</h3>
<br>

                
<br>
<h3 align="right"><font id="pg">¿Como fue la atención que le brindamos?</font> <font style="color: aliceblue;"> sasasasa</font> 
</h3>
<br>
...
"  >
 ...
 <br>
 <br>
                         <select name="fn_sucursal"class="btn btn-light" id="fi_sucursal">
                          <option value="1">Tulyehualco</option>
                          <option value="2">Tulyehualco 2</option>
                          <option value="3">San Gregorio</option>
                          ...
                          <option value="8">Tecomitl</option>
                          <option value="9">Tetelco</option>
                        </select>  
  <br>
  <br>
  <br>
