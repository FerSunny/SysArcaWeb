...
function focus_btn()
{
	$("input#productos.form-control").focus();
}
...
var editar = function(tbody, table) {
		$(tbody).on("click", "button.editar", function() 
		{
				...
				$("#frmedit  #id_unidades").val(data.id_unidades)
				$("#frmedit  #proveedor").val(data.fk_id_proveedor)
				$("#frmedit  #producto").val(data.fk_id_producto)
				$("#frmedit  #exis").val(data.existencias)
				$("#frmedit  #min").val(data.min)
				$("#frmedit  #max").val(data.max)
				$("#frmedit  #fech").val(data.fecha_actualizacion)
...
var eliminar= function(tbody, table) {
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 $.post("./controladores/eliminar.php", {'id_unidades' : data.id_unidades}  , function(data,status)
					{
						swalWithBootstrapButtons(
						'Eliminado!',
