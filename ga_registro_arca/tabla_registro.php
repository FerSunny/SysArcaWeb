...
<head><meta http-equiv="Content-Type" content="text/html; charset=gb18030">
	...
	<title>Registro</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  include("formularios/formularios_registro.php"); // CAMBIO programa de la forma
  ?>

  <div class="col-sm-12 col-md-12 col-lg-12">
      <h1>Tabla de registro  <!-- CAMBIO Se cambia el titulo de la tabla -->
		...
		<div class="row">
			<div id="cuadro1" class="col-sm-12 col-md-12 col-lg-12"> <!-- REVISAR -->
				...
				<!-- REVISAR -->
					<table id="dt_registro" class="table table-bordered table-hover" cellspacing="1" width="100%">
						<thead>
							<tr>
	...
	<script language="javascript" src="js/tabla_registro.js"></script> <!-- CAMBIO este JS -->
	<script>
