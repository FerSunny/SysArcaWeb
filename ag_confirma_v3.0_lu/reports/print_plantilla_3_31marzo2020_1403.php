    ...
    while($row = $result->fetch_assoc())
      {
        ...
        if($row['tipo']=='P' && strlen($row['valor'])==0 and ($studio=='231' or $studio=='234' or $studio=='275' or $studio=='276' or $studio=='278' or $studio=='720' or $studio=='876' or $studio=='909' or $studio=='721' or $studio=='214' or  $studio=='923' or $studio=='941' or $studio=='947' or $studio=='948' or $studio=='949' or $studio=='950' or $studio=='960' or $studio=='961' or $studio=='1014' or $studio=='1015' or $studio=='1016' or $studio=='1017' or $studio=='1018' or $studio=='1019' or $studio=='1020' or $studio=='1021' or $studio=='1022' or $studio=='1023' or $studio=='1024' or $studio=='1025'   or $studio=='1202' or $studio=='1225')){
            $nle+=1;
            $nle-=1;
        }else{
        $pdf->Cell($row['posini']);
        ...
        if ($row['tipo']=='T' and ($studio=='1016' or $studio == '275' or $studio == '961' or $studio == '1202')){
