...
if ($result = mysqli_query($con, $sql_max)) {
  while($row = $result->fetch_assoc())
  {
      $veces=$row['num_imp']+1;
      //echo $veces;
      $sql_update="UPDATE cr_plantilla_col_re SET num_imp = '".$veces."'
      where fk_id_factura=".$numero_factura." and fk_id_estudio=".$studio;
      //echo $sql_update;
...
function Header()
{
   ...
   $this->SetTextColor(0,100,0);
    ...
    //$this->Cell(195,5,'BLVD San Buena aventura, Col. La Venta, Ixtapaluca Edo. Mex.',0,0,'C');
    $this->Ln(3);
...
// Tercer linea
    ...
    $this->SetFont('Arial','',11);
    $this->MultiCell(87,5,utf8_decode($estudio2),0,'L');
...
// Pie de página
  function Footer()
  {
    ...
    global $studio,$con,$verificado,$tamfuev,$tipfuev,$posiniv,$firma,$fk_id_medico;
    ...
    switch ($fk_id_medico) {
      ...
      case 17:
          ...
          break;
      case 27:
          $this->Image('../imagenes/firma_dra_lizeth.png',77,223,38,0);
          break;
      case 37:
          $this->Image('../imagenes/firma_dra_silvia.jpg',77,200,50,0);
          break;
      case 46:
          $this->Image('../imagenes/firma_dr_misael.jpeg',77,200,55,0);
          break;
      case 54:
        $this->Image('../imagenes/dr_tabare.jpg',77,220,55,0);
        break;
      case 62:
        $this->Image('../imagenes/firma_dra_maritza_angulo.jpg',77,220,55,0);
        break;
      case 67:
        $this->Image('../imagenes/firma_dr_jose_roberto.jpg',77,220,55,0);
        break;
      case 72:
          $this->Image('../imagenes/dra_Rosa.Delgado.jpg',77,208,55,0);
          break;			
      default:
          $this->Image('../imagenes/firmajoaquinramirez.jpg',77,222,55,0);
          break;
