...
<?php 
 ...
 ?>
<form id="frmedit"  action="controladores/registro_plantilla_colpo.php" method="POST">
  <div class="row">
    <!-- REVISAR -->
...
<!-- INICIA EL BODY -->
            <div style="color:#000000;background:#EFFBF5" class="modal-body">
              ...
              <table border="0" align="center" BGCOLOR=#F5FBEF style="border-bottom:1px solid #819FF7">
          <!-- Id plantilla -->
                <tr> <!-- primer linea de la tabla -->
                    <td class="renglon_titulo"> Id Plantilla: </td>
                    <td class="renglon_valor" class="form-control" >
                      <input type="text" name="fn_id_plantilla" id="fi_id_plantilla" readonly="readonly" maxlength="3" size="3""/>
                    </td>
            ...
            <!-- Nombre de la plantilla -->
                    ...
                    <td class="renglon_titulo">Nombre:</td>
                    <td class="renglon_valor" class="form-control">
                        <input type="text" name="fn_nombre_plantilla" id="fi_nombre_plantilla" readonly="readonly" maxlength="35" size="35" />
                     </td>
            ...
            <!-- Titulo de la plantilla -->
                    ...
                    <td class="renglon_valor" class="form-control">
                        <input type="text" name="fn_titulo_desc" id="fi_titulo_desc" readonly="readonly" maxlength="35" size="35" />
                    </td>

                </tr>
<!-- LINEA DOS (DATOS DEL PACIENTE -->
                <tr>
                  <td colspan="7" class="renglon_valor" class="form-control">
                    <label class="font-weight-normal lead">Paciente: <?php echo $nombre." -- Edad:".$edad." --dx:".$diagnostico ?>   </label> <br>
                  </td> 
                </tr>

                <tr> <!-- segunda linea de la tabla -->
                    <td colspan="7" class="renglon_valor" class="form-control">
                      <textarea name="fn_descripcion" id="fi_descripcion" rows="22" cols="150" wrap="soft" >
                      </textarea>
                    </td>
                </tr>
