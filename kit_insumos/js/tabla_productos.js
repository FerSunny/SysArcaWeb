...
// listar datos en la tabla de perfiles
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				"ajax":{
					"method":"POST",
					"url": "listar_productos.php?studio="+studio
				},
				"columns":[
					{"data" : "id_insumo_estudio"},
					{"data" : "desc_producto"},
					{"data" : "cantidad"},
					{"data" : "precio"},
					{"data" : "fecha_registro"},
...
var editar = function(tbody, table) {
		$(tbody).on("click", "button.editar", function() 
		{
				...
				$("#frmedit  #id_costo_estudio").val(data.id_insumo_estudio)
				$("#frmedit  #articulo").val(data.fk_id_producto)
...
//alert (data.id_folio_producto)
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_insumo_estudio}  , function(data,status)
					{
						swalWithBootstrapButtons(
						'Eliminado!',
