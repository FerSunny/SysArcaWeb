					...
					success: function(data)            

						{
...

							{
								...
								swal('La clave del rechazo ya existe')
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_rechazo)

				$("#frmedit  #pro").val(data.id_rechazo)

				$("#frmedit  #codigo").val(data.id_rechazo)

				$("#frmedit  #clave").val(data.clave)

				$("#frmedit  #desc").val(data.desc_rechazo)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_rechazo}  , function(data,status)
