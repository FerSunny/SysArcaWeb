...
MIN(fa.fecha_factura) AS fecha_factura,
MAX(p1.fecha_registro) AS fecha_registro,
MAX(p1.fecha_validacion) AS fecha_validacion,
MIN(fa.fecha_entrega) AS fecha_entrega,
MIN(p1.fecha_impresion) AS fecha_impresion,
DATEDIFF(MIN(p1.fecha_impresion),MIN(fa.fecha_entrega)) dias,
TIMEDIFF(MIN(p1.fecha_impresion),MIN(fa.fecha_entrega)) horas
