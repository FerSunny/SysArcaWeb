  ...
  <div class="modal-dialog modal-lg" role="document" style="">
    ...
    <div class="modal-content">
      ...
      <div class="modal-header">
        ...
        <h5  style="color:blue;text-align:center" class="modal-title" id="exampleModalLabel">Nueva Plantilla Tomo</h5>
              ...
              <div class="md-form">
                 ...
                 <select class="form-control" name="fn_estudio" id="fi_estudio" >
                    ...
                    <?php
                      ...
                      $sql="SELECT * FROM km_estudios where estatus = 'A' and fk_id_plantilla = 8 order by desc_estudio";
