...
$query= "INSERT INTO cr_plantilla_usg (fk_id_empresa,fk_id_medico,id_plantilla, nombre_plantilla,fk_id_estudio,titulo_desc,descripcion,firma,estado) VALUES('$empresa','$fn_medico','0','$fn_nombre','$fn_estudio','$fn_titulo_desc','$fn_descripcion','$fn_firma','$fn_estado')";
...
if ($resultado) 
		{
			header("location: ../tabla_plantilla_usg.php");
