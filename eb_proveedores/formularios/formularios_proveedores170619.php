            ...
            <div class="modal-content">
                ...
                <div style="color:#000000;background:#EFFBF5" class="modal-body">
                  ...
                  <div class="col">
                     <div class="md-form mt-0">
                       <div class="md-form">
                          <input type="text" name="n_cel" id="n_cel" class="form-control" maxlength="20" required>
                          <label for="n_cel">Número celular</label>
                    </div>
                  </div>
                </div>
                </div>
                  ...
                  <div class="col">
                    <div class="md-form mt-0">
                      <div class="md-form">
                        <input type="number" name="cp" id="cp" class="form-control" maxlength="5" required>
                ...
                <div class="col">
                  <div class="md-form mt-0">
                    <div class="md-form">
                      <input type="tel" name="tel" id="tel" class="form-control" maxlength="20" required>
              ...
              <div class="row">
                <div class="col">
                  ...
                  <div class="col">
                     <div class="md-form mt-0">
                       <div class="md-form">
                          <input type="url" name="web" id="web" class="form-control" laceholder="https://example.com" pattern="https://.*" size="30">
        ...
        <div class="modal fade" id="form_editar" tabindex="-1" role="dialog" aria-labelledby="modalEliminarLabel">
            <div class="modal-dialog" role="document">
                    ...
                    <div class="col">
                       <div class="md-form mt-0">
                         <div class="md-form">
                          ...
                          <label for="n_cel">Número de celular</label>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="col">
                  <div class="md-form mt-0">
                    <div class="md-form">
                        <input type="text" name="tel" id="tel" class="form-control" maxlength="20" required>
                        <label for="tel">Teléfono</label>
                    </div>
                  </div>
                </div>
