...
if($row = mysqli_fetch_array($resultado))
{
	if($row['pass'] == $pass)
	{
		...
		$insert="INSERT INTO au_session (fk_id_sucursal,fk_id_usuario,ip_publica,nombre_pc,fecha_inicio,fecha_fin,navegador,ip_local) VALUES('$fk_id_sucursal','$usuario','$ip_publica','$nombre_host',NOW(),NOW(),'$navegador','$ip_local')";
