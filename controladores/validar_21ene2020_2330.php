...
//echo $insert;
		...
		if($fk_id_sucursal_usr == $fk_id_sucursal){
  		...
  		if( $row['fk_id_perfil'] == 1 || $row['fk_id_perfil'] == 11 || $row['fk_id_perfil'] == 13 || $row['fk_id_perfil'] == 27 || $row['fk_id_perfil'] == 28 || $row['fk_id_perfil'] == 29 || $row['fk_id_perfil'] == 30 || $row['fk_id_perfil'] == 31 )
  		{
