...
//se valida el horario de acceso al sistema, por sucursal y dia
		if($row['fk_id_perfil'] == '1' or $row['fk_id_perfil'] == '12' or $row['fk_id_perfil'] == '14' or $row['fk_id_perfil'] == '19' or $row['fk_id_perfil'] == '21' or $row['fk_id_perfil'] == '45' or $row['fk_id_perfil'] == '46' or $row['fk_id_perfil'] == '50' or $row['fk_id_perfil'] == '51'){
...
// fin
		...
		$_SESSION['fk_id_servicio']=$row['fk_id_servicio'];
...
//echo $insert;
		...
		if($fk_id_sucursal_usr == $fk_id_sucursal){
  		...
  		if( $row['fk_id_perfil'] == 1 || $row['fk_id_perfil'] == 11 || $row['fk_id_perfil'] == 12 || $row['fk_id_perfil'] == 13 || $row['fk_id_perfil'] == 14 || $row['fk_id_perfil'] == 27 || $row['fk_id_perfil'] == 28 || $row['fk_id_perfil'] == 29 || $row['fk_id_perfil'] == 30 || $row['fk_id_perfil'] == 31 || $row['fk_id_perfil'] == 33 || $row['fk_id_perfil'] == 19 || $row['fk_id_perfil'] == 36 || $row['fk_id_perfil'] == 25 || $row['fk_id_perfil'] == 35 ||
  		      $row['fk_id_perfil'] == 9 || $row['fk_id_perfil'] == 21 || $row['fk_id_perfil'] == 37 || $row['fk_id_perfil'] == 38 ||
              $row['fk_id_perfil'] == 39 || $row['fk_id_perfil'] == 40 || $row['fk_id_perfil'] == 41 || $row['fk_id_perfil'] == 42 || $row['fk_id_perfil'] == 43 || $row['fk_id_perfil'] == 45 || $row['fk_id_perfil'] == 46 
		   || $row['fk_id_perfil'] == 47 || $row['fk_id_perfil'] == 48 || $row['fk_id_perfil'] == 49 || $row['fk_id_perfil'] == 50 || $row['fk_id_perfil'] == 51)
  		{
