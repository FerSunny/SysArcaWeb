				...
				"columns":[
					...
					{ "data": "muestras" },
					{
						render:function(data,type,row){
							var tipoestudio = row['clave']
							var desc_area = row['desc_area']

							switch (desc_area) {
								case 'sin area':
									return "<form-group style='text-align:center;'>"+
									"<a id='printer'  href='' disabled  class='btn btn-danger btn-md'  role='button'><span class='far fa-check-square' style='color:white;'></span></a>"+
									"</form-group>";
									break;
							
								default:
									return "<form-group style='text-align:center;'>"+
									"<a id='printer' target='_blank' href='tabla_revisa.php?clave="+row['clave']+"&desc_area="+row['desc_area']+"&fecha="+row['fecha']+"' class='btn btn-success btn-md'  role='button'><span class='far fa-check-square' style='color:white;'></span></a>"+
									"</form-group>";									
									break;
							}
