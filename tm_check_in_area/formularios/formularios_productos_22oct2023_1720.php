			...
			<div class="modal-content">
				...
				<div style="color:#000000;background:#EFFBF5" class="modal-body">
					...
					<div class="md-form">
						...
						<label for="codigo">Escriba el numero de orden de impresion</label>
					...
					<div class="row">
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="tulye" id="tulye" class="form-control" maxlength="5" value="0"  required>
						...
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="tlahuac" id="tlahuac" class="form-control" maxlength="5" value="0" required>
						...
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="gregorio" id="gregorio" class="form-control" maxlength="5" value="0" required>
					...
					<div class="row">
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="xochimilco" id="xochimilco" class="form-control" maxlength="5" value="0" required>
						...
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="dino" id="dino" class="form-control" maxlength="5" value="0" required>
						...
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="santiago" id="santiago" class="form-control" maxlength="5" value="0" required>
					...
					<div class="row">
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="pablo" id="pablo" class="form-control" maxlength="5" value="0" required>
						...
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="pedro" id="pedro" class="form-control" maxlength="5" value="0" required>
						...
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="milpa" id="milpa" class="form-control" maxlength="5" value="0" required>
					...
					<div class="row">
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="tecomitl" id="tecomitl" class="form-control" maxlength="5" value="0" required>
						...
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="text" name="tetelco" id="tetelco" class="form-control" maxlength="5" value="0" required>
