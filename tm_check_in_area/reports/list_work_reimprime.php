    ...
    global $usuario, $desc_area, $clave;
      ...
      switch ($clave) {
        case 'QC':      
          ...
          $this->Cell(55,10,'Observaciones',0,0,'L');
          $this->Cell(35,10,'Diagnostico',0,0,'L');
          $this->Ln(1);
        ...
        case 'BA': 
          ...
          $this->Ln(5);
          $this->SetFont('Arial','B',12);
          $this->Cell(150,10,'LISTA DE TRABAJO (re-Impresion)',0,0,'C');
        ...
        case 'HM':      
            $this->Cell(240,5,'LABORATORIOS CLINICOS ARCA (re-Impresion)',0,0,'C');
            $this->Ln(5);
            $this->SetFont('Arial','B',12);
            $this->Cell(142,10,'LISTA DE TRABAJO',0,0,'R');
            $this->Cell(120,10,'AR-F001',0,0,'R');
        ...
        case 'BA': 
          ...
          case 'IN':      
              ...
              $this->Ln(5);
              $this->SetFont('Arial','B',12);
              $this->Cell(142,10,'LISTA DE TRABAJO (re-Impresion)',0,0,'R');
              $this->Cell(120,10,'AR-F001',0,0,'R');
              $this->Ln(10);
              $this->SetFont('Arial','B',10);
              $this->Cell(10,10,'Area: ',0,0,'L');
          ...
          case 'UR':      
            ...
            $this->SetFont('Arial','B',12);
            $this->Cell(142,10,'LISTA DE TRABAJO (re-Impresion)',0,0,'R');
            $this->Cell(120,10,'FOR-GEN-13',0,0,'R');
            $this->Ln(10);
            $this->SetFont('Arial','B',10);
            $this->Cell(10,10,'Area: ',0,0,'L');
            $this->SetFont('Arial','',9);
            ...
            $this->Cell(17,10,'Folio',0,0,'C');
            $this->Cell(12,10,'Edad',0,0,'C');
            $this->Cell(65,10,'Paciente',0,0,'C');
            $this->Ln(5);
            //$this->Cell(1);
            //$this->SetFont('Arial','',6);
            $this->Cell(8,10,'D',0,0,'C');
            $this->Cell(8,10,'PH',0,0,'C');
            $this->Cell(8,10,'LEU',0,0,'C');
            $this->Cell(8,10,'NIT',0,0,'CL');
            $this->Cell(8,10,'PRO',0,0,'CL');
            $this->Cell(8,10,'GLU',0,0,'CL');
            $this->Cell(8,10,'CCT',0,0,'CL');
            $this->Cell(8,10,'URO',0,0,'CL');
            $this->Cell(8,10,'BIL',0,0,'C');
            $this->Cell(8,10,'MIA',0,0,'C');
            $this->Cell(8,10,'CA',0,0,'C');
            $this->Cell(8,10,'CRE',0,0,'C');
            $this->Cell(8,10,'VC',0,0,'C');
            $this->Cell(8,10,'SAN',0,0,'C');
            $this->Cell(8,10,'COL',0,0,'C');
            $this->Cell(8,10,'OL',0,0,'C');
            $this->Cell(8,10,'ASP',0,0,'C');
            $this->Cell(8,10,'SED',0,0,'C');
            $this->Cell(90,10,'SEDIMENTO',0,0,'C');
            /*
           ...
           // $this->Cell(7,10,'CLB',0,0,'C');
            $this->Ln(1);
            $this->Cell(250,10,'______________________________________________________________________________________________________________________________________________________________________________________________',0,0,'L');
            // Salto de línea
            $this->SetFont('Arial','B',7);
            $this->Ln(5);
            break;
...
while($row = $result->fetch_assoc())
  {
      ...
      switch ($clave) {
        case 'QC':
            ...
            if ($v_nombre <> $row['id_factura'])
            {
              $pdf->Cell(60,5,utf8_decode(strtolower(substr($row['paciente'],0,55))),0,0,'L');
              $v_nombre = $row['id_factura'];
            }else
            {
              $pdf->Cell(60,5,' ',0,0,'L');
            }
              
            $pdf->Cell(90,5,utf8_decode(substr($row['iniciales'],0,15)),0,0,'L');
        ...
        case 'UR':
          ...
          //  $pdf->Rect(12, 49.7,95,35);
            ...
            $pdf->Cell(8,5,$row['ceva'],'L,T,R,B');
            $pdf->Cell(8,5,$row['ceva'],'L,T,R,B');
            $pdf->Cell(90,5,$row['ceva'],'L,T,R,B');
            /*
