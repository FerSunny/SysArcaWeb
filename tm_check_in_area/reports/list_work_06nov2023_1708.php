      ...
      switch ($clave) {
        ...
        case 'BA': 
          ...
          case 'UR':      
            ...
            $this->Cell(7,10,'NIT',0,0,'CL');
            $this->Cell(7,10,'PRO',0,0,'CL');
            $this->Cell(7,10,'GLU',0,0,'CL');
            $this->Cell(7,10,'CCT',0,0,'CL');
            $this->Cell(7,10,'URO',0,0,'CL');
            $this->Cell(7,10,'BIL',0,0,'C');
            $this->Cell(7,10,'MIA',0,0,'C');
            $this->Cell(7,10,'CA',0,0,'C');
            $this->Cell(7,10,'CRE',0,0,'C');
            $this->Cell(7,10,'VS',0,0,'C');
            $this->Cell(7,10,'SAN',0,0,'C');
            $this->Cell(7,10,'COL',0,0,'C');
            $this->Cell(7,10,'OL',0,0,'C');
            $this->Cell(7,10,'ASP',0,0,'C');
            $this->Cell(7,10,'SED',0,0,'C');
            $this->Cell(35,10,'SEDIMENTO',0,0,'C');
            /*
      ...
      switch ($clave) {
        ...
        //    $pdf->Ln(4);
          ...
          //  $pdf->Rect(12, 49.7,95,35);
            ...
            $pdf->Cell(7,5,$row['ceva'],'L,T,R,B');
            $pdf->Cell(7,5,$row['ceva'],'L,T,R,B');
            $pdf->Cell(35,5,$row['ceva'],'L,T,R,B');
            /*
            $pdf->Cell(7,5,$row['ceva'],'L,T,R,B');
            $pdf->Cell(7,5,$row['ceva'],'L,T,R,B');
            $pdf->Cell(7,5,$row['ceva'],'L,T,R,B');
