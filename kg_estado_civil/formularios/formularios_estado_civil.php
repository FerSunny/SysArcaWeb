    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Nueva Estado Civil</h4>
        </div>
        <div class="modal-body">
          <table>
            <form id="login-form" class="text-left" action="controladores/registro_estado_civil.php" method="post">

            <tr>
            <div class="form-group row" align="">
              <div class="col-xs-8">
                <td><label>Estado Civil:</label></td>
                <td><input type="text" class="form-control" id="edit1" required name="edit1"  maxlength="50" size="40" placeholder="Estado Civil"></td>
              </div>
            </div>
            </tr>
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input type="hidden" id="idestado_civil" name="idestado_civil" value="0">
...
<!-- Modal Eliminar-->
<form id="frmEliminaredocivil" action="controladores/eliminar_estado_civil.php" method="POST">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                ¿Está seguro de eliminar el Estado Civil?<strong data-name=""></strong>
                    <input type="hidden" id="idestado_civil" name="idestado_civil" value="">
                    <input type="hidden" id="opcion" name="opcion" value="eliminar">
                    <div class="form-group">
                      <div class="col-sm-8">
                        <input id="estado_civil" name="estado_civil" type="text" class="form-control" maxlength="8" >
                      </div>
                    </div>
            </div>
            <div class="modal-footer">
