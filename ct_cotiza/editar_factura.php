<?php
	...
	$table=" so_factura_pre";
	$where=" where id_factura=".$id_factura;
	$sql="SELECT fk_id_cliente,fk_id_usuario,fk_id_medico,diagnostico,fecha_factura,afecta_comision,fecha_entrega,fk_id_tipo_pago,observaciones,estado_factura,imp_subtotal,porc_descuento,porc_incremento,a_cuenta,vmedico,email_medico,email_paciente,requiere_factura,publicidad FROM  $table $where";
	...
	if ($result = mysqli_query($con, $sql)) {
				...
				$table=" km_estudios inner join so_detalle_factura_pre";
				//$where=" km_estudios.id_estudio=so_detalle_factura_pre.fk_id_estudio and numero_factura=".$numero_factura;
				$where=" where km_estudios.id_estudio=so_detalle_factura_pre.fk_id_estudio and id_factura=".$id_factura;
		...
		//echo $sql;
				if ($resultado = mysqli_query($con, $sql)) {
						...
						//	echo json_encode($out);
							...
							//obtenemos el nombre del cliente de acuerdo al id, debido a que el jquery autocomplete busca por nombre no por id
							...
							<div class="form-group row">
							 ...
							 <div class="form-group row">
									...
									<div class="col-md-3">
										...
										// and fk_id_sucursal = ".$fk_id_sucursal);
							 ...
							 <div class="form-group row">
								...
								-->
										...
										<div class="form-group row box_check">
											<div class="col-md-6 section_box">
												...
												<div style="display: inline-block; margin-right: 30px;">
													...
													<?php 
														...
														{
													?>
														<input type="checkbox" name="acepta_p" id="acepta_p" value="1" checked>
													<?php
														}
													?>
												</div>
