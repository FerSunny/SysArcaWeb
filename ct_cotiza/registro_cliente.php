...
$fn_fecha_nac = $data['fn_fecha_nac'];

//echo $fn_municipio;

$query = "INSERT INTO so_clientes(fk_id_empresa,id_cliente,rfc,nombre,a_paterno,a_materno,anios,meses,dias,fk_id_sexo,fk_id_estado_civil,fk_id_ocupacion,telefono_fijo,telefono_movil,mail,fk_id_estado,fk_id_municipio,fk_id_localidad,colonia,cp,calle,numero_exterior,fecha_registro,fecha_actualizacion,activo,fecha_nac) VALUES('$empresa','0','$fn_rfc','$fn_nombre','$fn_apaterno','$fn_amaterno','$fn_anios','$fn_meses','$fn_dias','$fn_sexo','$fn_estado_civil','$fn_ocupacion','$fn_tfijo','$fn_movil','$fn_mail','$fn_Estado','$fn_municipio','$fn_Localidad','$fn_colonia','$fn_cp','$fn_calle','$fn_numero','$fn_factualiza','$fn_factualiza','$estado_reg','$fn_fecha_nac')";
