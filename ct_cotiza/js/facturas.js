						...
						{"data":"imp_total"},
						{
						 render:function(data,type,row){
							...
							if (numero_factura == '2'){
								 ...
								 return "<form-group style='text-align:center;'>"+
				                     "<button disabled id='edit'  type='button' class='btn btn-info btn-sm'><span  class='fa fa-pencil fa-1x'></span></button>"+
				                     "<button disabled id='delete_factura'  type='button' class='btn btn-danger btn-sm' style='margin-left:10px;'><span  class='fa fa-times fa-1x'></span></button>"+
				                     "</form-group>";				                	
				                }
					 }
				 }
