	      	...
	      	// 		console.log(response);
			    ...
			    // },
	                ...
	                searchable: true
                     ...
                     "<button  id='delete_factura'  type='button' class='btn btn-success btn-sm' style='margin-left:20px;'><span  class='fa fa-hand-o-up fa-1x'></span></button>"+
                     "</form-group>";
					 }
				 }
			...
			$('#data_facturas tbody').on( 'click', '#delete_factura ', function () {
					...
					var numero_factura=data.id_factura;
							...
							swal({
									...
									text: "La cotizacion será convertida",
