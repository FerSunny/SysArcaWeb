...
if ($fk_id_sucursal <1 || $fk_id_sucursal > 10){
  $err_empresa=1;
  $err_modulo='so_factura_pre/ajax/insertBill.php';
...
// actualiza la edad del paciente
      ...
      $sql_cli2="UPDATE so_factura_precion SET fk_id_factura= ".$last_id."
