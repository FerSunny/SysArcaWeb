...
require_once ("../config/conexion.php");//Contiene funcion que conecta a la base de datos
 ...
 header('Content-Type: application/json');
    if( isset($_POST['numero_factura']) ) {
      ...
      $del1="update so_factura_pre set estado_factura=5 where id_factura='".$numero_factura."'";
      //$del2="delete from so_detalle_factura_pre where numero_factura='".$numero_factura."'";
