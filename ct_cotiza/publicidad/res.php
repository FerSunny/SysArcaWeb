...
require_once ("../../so_factura_pre/config/db.php");//Contiene las variables de configuracion para conectar a la 
require_once ("../../so_factura_pre/config/conexion.php");//Contiene funcion que conecta a la base de datos
$factura=$_GET['factura'];


$query = "SELECT CONCAT(cl.nombre,' ',cl.a_paterno,' ',cl.a_materno) paciente FROM so_factura_pre fa
