  ...
  <div class="container">
        <div class="panel panel-info">
            <div class="panel-heading">
                <h4><i class='glyphicon glyphicon-edit'></i> Version 2.0.0  Nueva Cotizacion <?php echo $_SESSION['fk_id_sucursal']?>
                </h4>
            </div>
...
<!-- lina de direccion de cliente -->
            ...
            <div class="row">
                    <div class="col-md-4" well tal>
                        ...
                        <label  class="control-label">Estado de la Cotizacion</label>
            ...
            <button id="btnSaveBill" type="button" class="btn btn-success btn-lg pull-right" id="recalculate">
                 <span class="fa fa-floppy-o" aria-hidden="true"></span> Guardar Cotizacion
            </button>
            <div class="row-fluid">
                <div class="col-md-12">
                </div>
