                ...
                <!-- <div class ="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class ="form-group col-md-4">
                                ...
                                <div class="right-inner-addon ">
                                    <input  id="fi_anios" readonly name="fi_anios" type="number" min="0" max="105" class="form-control" maxlength="35"  placeholder="Anios" />
                                </div>
                            </div>
                            ...
                            <div class ="form-group col-md-4">
                                ...
                                <div class="right-inner-addon ">
                                    <input  id="fi_meses" readonly name="fi_meses" type="number"  min="0" max="11" class="form-control" maxlength="35"  placeholder="meses" />
                                </div>
                            </div>
                            ...
                            <div class ="form-group col-md-4">
                                ...
                                <div class="right-inner-addon ">
                                    <input  id="fi_dias" readonly="" name="fi_dias" type="number" min="0" max="30" class="form-control" maxlength="35"  placeholder="Dias" />
                                </div>
                            </div>
                            ...
                            <div class ="form-group col-md-4">
                                ...
                                <div class ="form-group col-md-4">
                                        <p class="text-muted">fecha Nacimiento:</p>
                                                <input type="date" required name="fecha_nac" id="fecha_nac" class="form-control" maxlength="17" size="20">

                                                <i class="fa fa-calculator" style="cursor:pointer;" onclick="CalcularEdad()"></i>
                                                <label for="fecha_nac">Calcula Edad</label>
                                </div>
...
-->
                        ...
                        <div class="row">
                            ...
                            <div class ="form-group col-md-6">
                                ...
                                <div class="right-inner-addon ">
                                    <input  id="fi_rfc" name="fn_rfc" type="text" class="form-control" maxlength="15"  placeholder="RFC" value="XAXX010101000"/>
                                </div>
                            </div>
                            ...
                            <div class ="form-group col-md-6">
                                ...
                                <div class="right-inner-addon ">
                                <select name="fi_ocupacion" id="fi_ocupacion" style="width: 100%;">
                                    <?php
                        ...
                        <div class="row">
                            ...
                            <div class ="form-group col-md-4">
                                <div class="right-inner-addon ">
                                    <p class="text-muted">Acepta Publicidad:</p> 
                                    Si: <input type="checkbox" class="" name="ap" id="ap" value="1">
                                </div>
                            </div>  
