...
*/
					{
						render:function(data,type,row){
							...
							"<a id='printer'  target='_blank' href='../vm_google_maps/index.php?fk_id_usuario="+row['fk_id_usuario']+"&anio="+row['anio']+"&mes="+row['mes']+"&dia="+row['dia']+"' class='btn btn-success btn-md' role='button'><span class='fas fa-stethoscope' style='color: white;'></span></a>"+
							"</form-group>";
						},
