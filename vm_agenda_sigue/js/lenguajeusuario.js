...
*/
					{
						render:function(data,type,row){
							...
							//"<a id='printer'  href='../ww_precios_estudios/tabla_conceptos.php?numero_factura="+row['id_factura']+"&studio="+row['fk_id_estudio']+"' class='btn btn-success btn-md' role='button'><span class='fas fa-stethoscope' style='color: white;'></span></a>"+
							//"<a id='printer'  href='../ww_precios_estudios/tabla_conceptos.php?studio="+row['id_estudio']+"&plantilla="+row['fk_id_plantilla']+"' class='btn btn-success btn-md' role='button'><span class='fas fa-stethoscope' style='color: white;'></span></a>"+
							"<a id='printer'  href='../vm_agenda_sigue/tabla_conceptos.php?fk_id_usuario="+row['fk_id_usuario']+"&anio="+row['anio']+"&mes="+row['mes']+"' class='btn btn-success btn-md' role='button'><span class='fas fa-stethoscope' style='color: white;'></span></a>"+
							"</form-group>";
						},
