...
// Tercer linea
   ...
   $cadena = "";
    ...
    $this->Cell(70,5,'Codigo de seguridad ARCA',0,0,'L');
    $this->ln(3);
    $this->MultiCell(160,5,base64_encode($cadena),0,'L');
    $this->ln(-1);
...
// Pie de página
  function Footer()
  {
    ...
    global $studio,$con,$verificado,$tamfuev,$tipfuev,$posiniv,$numero_factura;
      ...
      while($row = $result->fetch_assoc())
        {
          ...
          $firma=$row['concepto'];
          $this->Image('../imagenes/firma.gif',153,210,40,0);
    ...
    $this->Cell(6);
    $this->SetTextColor(0,0,255);
    $this->Cell(185,5,'____________________________________________________________________________________________________________________________________',0,0,'L');
