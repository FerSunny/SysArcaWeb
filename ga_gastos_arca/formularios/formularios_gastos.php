...
<!-- lasifica el gasto -->
              <tr>
                <td class="col-sm-2 control-label">Tipo Gasto: </td>
                <td class="renglon_valor" class="form-control">
                  <select name="fn_tipo_concepto" id="fi_tipo_concepto">
                    <?php
                      $sql="SELECT * FROM ga_tipo_concepto where estado = 'A'";
                      $rec=mysqli_query($conexion,$sql);
                      while ($row=mysqli_fetch_array($rec))
                        {
                          echo "<option value='".$row['id_tipo_concepto']."' >";
                          echo $row['desc_tipo_concepto'];
                          echo "</option>";
                        }
                    ?>
                  </select>
              ...
              <tr>
                <td class="col-sm-2 control-label">Tipo Mov.: </td>
                <td class="renglon_valor" class="form-control">
