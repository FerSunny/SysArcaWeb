...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_prospecto)

				$("#form_productos  #pro").val(data.id_prospecto)
					...
					success: function(data)            

						{
...

							{
								...
								swal('El codigo del prospecto ya existe')
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_prospecto)

				$("#frmedit  #pro").val(data.id_prospecto)

				$("#frmedit  #codigo").val(data.id_prospecto)

				$("#frmedit  #nombre").val(data.nombre)

				$("#frmedit  #apaterno").val(data.a_paterno)

				$("#frmedit  #amaterno").val(data.a_materno)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_producto' : data.id_prospecto}  , function(data,status)
