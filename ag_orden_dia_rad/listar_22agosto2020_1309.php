...
LEFT OUTER JOIN cr_plantilla_rx_rad_re p2 ON (p2.fk_id_factura = fa.id_factura AND p2.fk_id_estudio = pa.fk_id_estudio)
...
LEFT OUTER JOIN so_clientes cl ON (fa.fk_id_cliente  = cl.id_cliente)
LEFT OUTER JOIN kg_sucursales su ON (fa.fk_id_sucursal  =  su.id_sucursal)
LEFT OUTER JOIN cr_plantilla_rx_rad_re p2 ON (p2.fk_id_factura = fa.id_factura AND p2.fk_id_estudio = df.fk_id_estudio and p2.estado = 'A')
