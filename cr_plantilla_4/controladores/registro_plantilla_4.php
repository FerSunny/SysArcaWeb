...
$query= "INSERT INTO cr_plantilla_4 (fk_id_empresa,id_valor,orden,fk_id_estudio,tipo,concepto,posini,tamfue,tipfue,estado) VALUES('$empresa','0','$fn_orden','$fn_estudio','$fn_tipo','$fn_concepto','$fn_posini','$fn_tamfue','$fn_tipfue','$fn_estado')";
...
if ($resultado) 
		{
			header("location: ../tabla_plantilla_4.php");
