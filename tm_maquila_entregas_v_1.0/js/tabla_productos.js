		...
		var listar = function(){
			...
			var table = $("#dt_productos").DataTable({
				...
				"columns":[
					...
					{"defaultContent":"<button type='button' class='editar btn btn-success btn-md'><i class='fas fa-file-medical-alt'></i></button>"}
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #producto").val(data.fk_id_medio)

				$("#frmedit  #desc_p").val(data.fk_id_equipo)
		});
