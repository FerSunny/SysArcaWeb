...
if($fk_id_perfil == 1 OR $fk_id_perfil==13 OR $fk_id_perfil == 27 OR $fk_id_perfil == 28 OR $fk_id_perfil == 29 OR $fk_id_perfil == 30 OR $fk_id_perfil == 33 OR $fk_id_perfil == 45 OR $fk_id_perfil == 46 OR $fk_id_perfil == 33)
{
	$condicion = '> 0';
}
else
