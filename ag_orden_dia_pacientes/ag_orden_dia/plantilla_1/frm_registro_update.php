            ...
            <?php
              ...
              ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <input class="form-control" type="text" required name="fn_refe<?php echo $i?>" id="fi_refe" maxlength="40" size="20" placeholder="Escriba el valor" value="<?php echo trim($valor_refe); ?>"/>
                          </td>
