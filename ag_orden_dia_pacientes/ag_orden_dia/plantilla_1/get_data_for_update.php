...
$comentarios="";
	...
	$sql="SELECT
	valor,verificado,observaciones
	FROM cr_plantilla_1_re
	WHERE fk_id_factura = ".$data['id_factura']." AND fk_id_estudio = ".$data['id_estudio']." ORDER BY orden";

    //$sql="SELECT valor,verificado,observaciones FROM cr_plantilla_1_re WHERE fk_id_factura=".$data['id_factura'];
//    $sql="SELECT valor FROM cr_plantilla_1_re WHERE fk_id_factura=3504";
