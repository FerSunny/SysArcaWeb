            ...
            <tbody>
              ...
              ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <input class="form-control" type="text" required name="fn_resultado<?php echo $i?>" id="fi_resultado<?php echo $i?>" maxlength="25" size="25" placeholder="Escriba el valor" value="<?php if($id_estudio == '274' or $id_estudio == '963' or $id_estudio == '988' or $id_estudio == '1029' or $id_estudio == '1201' or $id_estudio == '2432' or $id_estudio == '2577'){
                            switch ($concepto) {
                                case 'DENSIDAD':
                                    $default_v='1.030';
                                    break;
                          ...
                          <td>
                            <?php
                              ...
                              {
                            ?>
                            <input class="form-control" type="text" required name="fn_refe<?php echo $i?>" id="fi_refe<?php echo $i?>" maxlength="40" size="20" placeholder="Escriba el valor" value="<?php echo trim($valor_refe); ?>"/>
                            <?php   
                              }else
                              {
                            ?>
                            <input class="form-control" type="text" required name="fn_refe<?php echo $i?>" id="fi_refe<?php echo $i?>" maxlength="40" size="20" placeholder="Escriba el valor" value="<?php echo trim($valor_refe); ?>" readonly/>
                            <?php 
                              }
                            ?>
                          </td>
