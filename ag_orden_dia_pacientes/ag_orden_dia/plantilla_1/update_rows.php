...
foreach($data as $objeto){
    ...
    if($flag!=true){
        $sql_delete_rows="delete from cr_plantilla_1_re where fk_id_factura=".$id_factura." and fk_id_estudio=".$id_studio;
    ...
    $sql="INSERT INTO cr_plantilla_1_re(fk_id_empresa,fk_id_factura,fk_id_estudio,orden,tipo,concepto,valor,verificado,valor_refe,unidad_medida,observaciones,num_imp,tamfue,tipfue,
    posini,origen,fecha_registro) VALUES (1,'$id_factura','$id_studio','$orden','$tipo','$concepto','$resultado','$verificado','$valor_refe','$unidad_medida','$observaciones',0,'$tamfue','$tipfue','$posini','C','$fecha')";
    //echo $sql;
