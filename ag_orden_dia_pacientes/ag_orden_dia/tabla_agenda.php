  ...
  <body background="../../imagenes/logo_arca_sys_web.jpg">
	...
	<div class="panel-heading">
	  <div class="btn-group pull-right">
	  	<p style="font-size: 24px;">Paciente: </p>
		...
		<h2><i class="fas fa-search">Lista de Estudios</i></h2>
	</div>
	<table id="dt_agenda"class="table table-bordered table-hover table-responsive" cellspacing="1" style="width:100%">
		<thead>
			<tr>
				<th>Plnatilla</th>
				<th>ID</th>
