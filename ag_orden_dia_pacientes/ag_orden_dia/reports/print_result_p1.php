...
// linea de encavezados (metodo)
    ...
    switch ($studio) {
      ...
      case '476': //PERFIL TIROIDEO BASICO I
          //$this->Ln(10);
		  $this->Ln(-19); // se subieron los titulos, solicitado por dmom el dia 17ene20223.
...
CASE
  WHEN fk_id_estudio in (274,963,988,69,459,1029,49,1717,2432,2577,186,402 ) THEN
        CONCAT(valor_refe) 
  ELSE
  ...
  CASE
  WHEN fk_id_estudio in (274,963,988,1029,2432,186,402) THEN
...
*/
        if($studio=='274' or $studio =='467' or $studio =='215' or $studio=='963' or $studio=='988' or $studio=='1029' or $studio=='1097' or $studio =='435' or $studio=='1201' or $studio=='1717' or $studio=='1781' or $studio=='1694' or $studio=='2432' or $studio=='2577' or $studio=='186' or $studio=='402'){
          $justifica='C';
        }else{
          $justifica='R';
        }

        if($row['tipo']=='P' && strlen($row['valor_solo'])==0 and ($studio=='274' or $studio=='151' or $studio=='152' or $studio=='153' or $studio=='348' or $studio=='904' or $studio=='905' or $studio=='494' or $studio=='279' or $studio=='395' or $studio=='117' or $studio=='525' or $studio=='527' or $studio=='528' or $studio=='526' or $studio=='963' or $studio=='956' or $studio=='957' or $studio=='958' or $studio=='983' or $studio=='987' or $studio=='988' or $studio=='989' or $studio=='990' or $studio=='1027' or $studio=='1028' or $studio=='1029' or $studio=='202' or $studio=='1201' or $studio=='1194' or $studio=='1195' or $studio=='1196' or $studio=='1211' or $studio=='1226' or $studio=='1227' or $studio=='304' or $studio=='1204' or $studio=='1673' or $studio=='1830' or $studio=='1717' or $studio=='1854' or $studio=='1730' or $studio=='1961' or $studio=='1959' or $studio=='1962' or $studio=='1963' or $studio=='1748' or $studio=='1213' or $studio=='1766' or $studio=='1718' or $studio=='2152' or $studio=='2153' or $studio=='2154' or $studio=='2151' or $studio=='2427' or $studio=='2428' or $studio=='2429' or $studio=='2461' or $studio=='2432' or $studio=='2441' or $studio=='2429' or $studio=='2524' or $studio=='2577' or $studio=='2596' or $studio=='2597' or $studio=='2598' or $studio=='2617' or $studio=='2627' or $studio=='2609' or $studio=='2699' or $studio=='186' or $studio=='402'))   {
            $nle+=1;
            $nle-=1;
        }else{
             // $this->ln(5)
