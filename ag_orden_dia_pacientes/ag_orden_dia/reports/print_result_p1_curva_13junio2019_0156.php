...
if ($result = mysqli_query($con, $sql_max)) {
  while($row = $result->fetch_assoc())
  {
      ...
      //echo $veces;
      $sql_update="UPDATE cr_plantilla_1_re SET num_imp = $veces, fecha_impresion = $fecha_impresion WHERE fk_id_factura = $numero_factura AND fk_id_estudio = $studio";
      //echo $sql_update;
...
// termina valor
      ...
      $pdf->ln(30);
      	$pdf->Image('../../../pdf_graficas/'.$numero_factura.'_'.$studio.'.png',0,130,200,0);
  }
