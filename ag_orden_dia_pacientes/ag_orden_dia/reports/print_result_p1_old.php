...
CASE
  ...
  (SELECT null,p2.tipo,p2.orden,p2.concepto,null,null,null,null,
  CASE
  WHEN fk_id_estudio in (274,963,988,1029,2432) THEN
    case
      when p2.fk_id_estudio = 742 and $numero_factura = 242841 then 
        '19.0 - -156.3'
      else
         CONCAT(valor_refe)
      end valor_refe
