...
<html lang="en">
  ...
  <div class="container">
      <div class="card">
        <h4 class="card-header">Edicion de resultados</h4>
        <div class="card-body">
  ...
  $( "#btn_update" ).click(function()
  {
    ...
    Swal.fire({
      ...
      if (result.value)
      {
       setTimeout(function() {
            $.ajax({
              url:"./plantilla_3/actualizar.php",
              type: 'POST',
