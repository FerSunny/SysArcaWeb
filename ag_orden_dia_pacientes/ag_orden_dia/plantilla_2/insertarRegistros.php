...
}else
{
    ...
    foreach($data as $objeto)
    {
        ...
        if($id_studio == 307 || $id_studio == 939 || $id_studio == 1147 || $id_studio == 485 || $id_studio == 486 || $id_studio == 964 || $id_studio == 969 || $id_studio == 1205 || $id_studio == 1209 || $id_studio == 2436 || $id_studio == 2440 || $id_studio == 2608 || $id_studio == 2604)
        {
            $validado = 0;
        }else
        {
