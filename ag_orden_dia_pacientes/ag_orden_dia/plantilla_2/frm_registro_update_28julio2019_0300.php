              ...
              ?>
                      ...
                      <?php if(strlen($concepto)>0  && $tipo=='P'){?>
                        <tr>
                          ...
                          <td>
                            <input style="color:red;font-weight: bold;" class="form-control" type="text" required name="fn_verificado<?php echo $i?>" id="fi_verificado" maxlength="3" size="3" placeholder="*"/>
                          </td>
                        </tr>
                      <?php?>
            <?php } }?>
