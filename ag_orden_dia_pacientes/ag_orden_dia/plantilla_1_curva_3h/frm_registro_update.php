...
<html lang="en">
  <head>
    <title>Modificar Resultados Curva 3H</title>
    <!-- Required meta tags -->
    <meta charset="utf-8">
            ...
            <?php
              ...
              ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <input class="form-control" type="text" required name="fn_resultado<?php echo $i?>" id="fi_resultado" minlength="80" size="20" placeholder="Escriba el valor"/>
                          </td>
...
<script>
    function res()
    {
        $('#tb_plantilla1 tbody tr').each(function () 
        {
            ...
            $.ajax({
                type: "POST",                 
                url: "./plantilla_1_curva_3h/editar_datos.php",                    
                data: parametros,
                beforeSend: function(){
                },
            ...
            Swal.fire({
                ...
                text: "Vamos a crear la grafica, Click continuar",
                type: 'success',
