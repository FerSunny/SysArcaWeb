            ...
            <tbody>
              ...
              ?>
                        ...
                        <tr>
                          ...
                          <td>
                            <input class="form-control" type="text" required name="fn_resultado<?php echo $i?>" id="fi_resultado" maxlength="20" size="20" placeholder="Escriba el valor" value="<?php if($id_estudio == '274' or $id_estudio == '963' or $id_estudio == '988'){
                                                          switch ($concepto) {
                                                              case 'DENSIDAD':
                                                                  $default_v='1.030';
                                                                  break;
 ...
 <script>
    function res()
    {
        $('#tb_plantilla1 tbody tr').each(function () 
        {
            ...
            $.ajax({
                type: "POST",                 
                url: "./plantilla_1_curva_3h/guardar_datos.php",                    
                data: parametros,
                beforeSend: function(){
                },
    ...
    function grafica()
    {
        var factura = $("#id_factura").val()
        var estudio = $("#id_estudio").val()
        $.post("./plantilla_1_curva_3h/datos_graficas.php", {'factura' : factura, 'estudio' : estudio},function(data, status){
            ...
            function drawChart() {
              ...
              var options = {
                  title: 'CURVA TOLERANCIA A LA GLUCOSA',
                  width: 1200,
                  height: 700,
                  pointSize: 20,
                axes: {
                 ...
                 vAxis: {
                  title: 'CONCENTRACION DE GLUCOSA EN SUERO'
                }
              };
              ...
              google.visualization.events.addListener(chart, 'ready', function () {
                 ...
                 $.ajax({
                    type: "POST",                 
                    url: "./plantilla_1_curva_3h/guardar_img.php",                    
                    data: parametros,
                    beforeSend: function(){
                    },
                    success: function(data)            
