...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    <h1 style="text-align: center;">Tabla de muestras <?php date_default_timezone_set('America/Chihuahua'); echo date("F j, Y, g:i a"); ?>  <!-- CAMBIO Se cambia el titulo de la tabla -->
      <!--
