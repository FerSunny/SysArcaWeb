...
<!-- Folio del estudio a reasignar -->						
						<div class="md-form">
							...
							<input type="text" name="control" id="control" class="form-control" readonly="">
							<label for="codigo">Folio</label>
						</div>

						<div class="md-form">
						    <input type="text" name="id_estudio" id="id_estudio" class="form-control" readonly="">
							<input type="text" name="estudio" id="estudio" class="form-control" readonly="">
							<input type="text" name="muestra" id="muestra" class="form-control" readonly="">
							<label for="codigo">Estudio/Muestra</label>
						</div>
						...
						<div class="row">
							<div class="col">
								<div class="md-form mt-0">
									<label for="">Cubiculo </label>
								</div>
							</div>
							
							<div class="col-9">
								<div class="md-form mt-0">
								<input type="text" name="cubiculo" id="cubiculo" class="form-control" maxlength="25" required>
								</div>
							</div>
					...
					<div class="row">
						...
						<div class="col">
							<div class="md-form mt-0">
								<div class="md-form">
									<input type="time" name="hora_usg" id="hora_usg" class="form-control" maxlength="10" required>
									<label for="producto">Hora Estudio</label>
								</div>
							</div>
						</div>
					</div>
