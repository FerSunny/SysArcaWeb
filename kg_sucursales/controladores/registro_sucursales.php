...
colonia,
calle,numero,estado,desc_corta,lunes,martes,miercoles,jueves,viernes,sabado,domingo,fk_id_grupo,fk_id_zona) VALUES (1,'$fn_desc','$fn_usuario','$fn_telefono','$fn_tel','$fn_celular', '$fn_ha', '$fn_hc', '$fn_sa', '$fn_sc', '$fn_da', '$fn_dc', 

 '$fn_descuento', '$fn_skype','$fn_mail', '$fn_fk_pais', '$fn_est', '$fn_municipio', '$fn_localidad', '$fn_cp', 
'$fn_colonia',
'$fn_calle','$fn_numero','$fn_estado','$fn_corta','$fn_do', '$fn_lu', '$fn_ma', '$fn_mi', '$fn_ju', '$fn_vi', '$fn_sab', '$fn_grupo','$fn_zona')";
