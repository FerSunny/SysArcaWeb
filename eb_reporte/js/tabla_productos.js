...
var agregar= function(tbody, table) {
...

		{
				...
				$("#form_productos  #dc").val(data.id_reporte)

				$("#form_productos  #pro").val(data.id_reporte)
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #dc").val(data.id_reporte)
				$("#frmedit  #pro").val(data.id_reporte)
				$("#frmedit  #codigo").val(data.id_reporte)


				$("#frmedit  #dequipo").val(data.desc_equipo)

				$("#frmedit  #problema").val(data.desc_reporte)

				$("#frmedit  #fecha").val(data.fecha_reporte)

				$("#frmedit  #prioridad").val(data.prioridad)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_reporte' : data.id_reporte}  , function(data,status)
