				...
				"columns":[
					...
					//{"defaultContent":"<button type='button' target='_blank'href='../se_modulos/tabla_modulos.php' class='btn btn-danger btn-md'><i class='fas fa-crutch'></i></button>"}
					{
						render:function(data,type,row){
							...
							v_existe=row['lote'];
							if(v_existe==null){
								return "<button type='button' class='registrar btn btn-warning btn-md'> <i class='fas fa-clipboard-check'></i></button>"
							}else{
								return "<button type='button' class='registrar btn btn-warning btn-md' disabled> <i class='fas fa-clipboard-check'></i></button>"
							}
							},
