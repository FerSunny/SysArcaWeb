...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    <h1 style="text-align: center;">Tabla de asignacion al lote Num. <?php echo $lote ?> <!-- CAMBIO Se cambia el titulo de la tabla -->
      ...
      <button type="button" class="btn btn-primary pull-right menu" data-toggle="modal" data-target="#myModals"><i class="fa fa-user-plus" aria-hidden="true"></i>&nbsp;Asignar Completo</button>
      <!-- CAMBIO Se cambia el boton de altas -->
    </h1>
  </div>
<!--
  <input type="hidden" name="lote" id="lote" value="<?php echo $lote ?> "> 
  <input type="hidden" name="lote_max" id="lote" value="<?php echo $lote_max ?> ">
 --> 
  ...
  <script language="javascript" src="js/tabla_lotes.js"></script>
</body>
</html>
<?php
