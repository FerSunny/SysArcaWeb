						...
						<nav class="navbar navbar-light" style="background-color: #e3f2fd; color: #fff;">
								<div class="container-fluid">
										<div class="navbar-header">
													<a class="navbar-brand" href="menu_22"><i class="fa fa-home" aria-hidden="true"></i>    Inicio</a>
										</div>
												<ul class="nav navbar-nav">
														<li>
																<li>
																<li>
																		<li><a href="../cr_plantilla_4/tabla_plantilla_4">Plantillas</a></li>
																</li>
																	<li>
																			<li><a href="../ag_orden_dia_colpo_4/tabla_colpo_papa">Reportes</a></li>
																	</li>
															  </li>
													  </li>
												</ul>
