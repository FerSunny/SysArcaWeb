                    ...
                    <div class="container-fluid">
                        ...
                        <ul class="nav navbar-nav">
                          ...
                          <!-- Plantillas -->  
                            ...
                            <li class="dropdown">
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-users" aria-hidden="true"></i>    Plantillas<span class="caret"></span></a>
                              <ul class="dropdown-menu" role="menu">
                                <li><a href="../cr_plantilla_1/tabla_plantilla_1.php">Grupo 1</a></li>
