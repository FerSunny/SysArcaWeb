            ...
            <nav class="navbar navbar-light" style="background-color: #e3f2fd; color: #fff;">
              <div class="container-fluid">
                <div class="navbar-header">
                  <a class="navbar-brand" href="menu_19"><i class="fa fa-home" aria-hidden="true"></i>    Inicio</a>
                </div>
                  <ul class="nav navbar-nav">
                      <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><i class="fa fa-sticky-note" aria-hidden="true"></i>Contaduria<span class="caret"></span></a>
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="../co_facturas/tabla_contador">Reportes</a></li>
                            <li><a href="../fa_nota_factura/tabla_notafac">Asignación Folio</a></li>
                            <li><a href="../kg_grupos/tabla_grupos">Grupos</a></li>
                            <li><a href="../kg_sucursales_co/tabla_sucursales">Sucursales</a></li>
                        </ul>
                      </li>
                  </ul>
                  <div class="navbar-right">
                     <a class="navbar-brand" href="../includes/logout">
