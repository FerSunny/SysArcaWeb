      ...
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="../ag_orden_dia_colpo_4/tabla_colpo_papa">Orden del dia (colpo/ppn)</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown"
          ...
          <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
            <a class="dropdown-item" href="../eb_agenda/tabla_agenda">Agenda</a>
            <a class="dropdown-item" href="../eb_almacen_central/tabla_almacen">Almacen central</a>
            <a class="dropdown-item" href="..//tabla_.php">Balances</a>
            <a class="dropdown-item" href="../eb_categoria/tabla_categoria">Categoria</a>
            <a class="dropdown-item" href="../eb_crear_central/tabla_solicitudes">Crear solicitud</a>
            <a class="dropdown-item" href="../eb_departamento/tabla_departamento">Departamento</a>
            <a class="dropdown-item" href="../eb_historial/tabla_historial">Historial solicitudes</a>
            <a class="dropdown-item" href="../eb_productos/tabla_productos">Productos</a>
            <a class="dropdown-item" href="../eb_proveedores/tabla_proveedores">Proveedores</a>
            <a class="dropdown-item" href="../eb_solicitudes_central/tabla_solicitudes">Solicitudes</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink" data-toggle="dropdown"
            aria-haspopup="true" aria-expanded="false">Total general</a>
          <div class="dropdown-menu dropdown-primary" aria-labelledby="navbarDropdownMenuLink">
        ...
        <ul class="nav-menu">
            <li class="menu-has-children"><a href=""> Agenda </a>
                <ul style="display:none">
                    <li><a href="../ag_orden_dia_colpo_4/tabla_colpo_papa">Orden del dia (colpo/ppn) </a></li>
                </ul>
            </li>
            <li class="menu-has-children"><a href=""> Almacen </a>
                <ul style="display:none">
                    ...
                    <li><a href="../eb_historial/tabla_historial">Historial solicitudes</a></li>
            ...
            <li class="menu-has-children"><a href=""> Total general </a>
                <ul style="display:none">
                </ul>
            </li>
