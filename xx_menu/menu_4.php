                ...
                <nav class="navbar navbar-light" style="background-color: #e3f2fd; color: #fff;">
                    <div class="container-fluid">
                        <div class="navbar-header">
                          <a class="navbar-brand" href="menu_10.php"><i class="fa fa-home" aria-hidden="true"></i>    Inicio</a>
                        </div>
 ...
 <!-- Plantillas -->
                            ...
                            <li>
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">Colposcopias<b class="caret"></b></a>
                                    <ul class="dropdown-menu">  
                            ...
                            <li>
                             ...
                             <ul class="dropdown-menu" role="menu">
                                 <li><a href="../ag_orden_dia_colpo_4/tabla_colpo_papa.php">Orden del Dia (Colpo)</a></li>
                             </ul>
                           </li>                     
