...
<body background="../imagenes/logo_arca_sys_web.jpg">
	<div class="container">
												...
												<ul class="nav navbar-nav">
														<li>
																...
																<li>
																	...
																	<li><a href="../eb_unidad_medida/tabla_unidad_m">Unidades de medida</a></li>
																		</ul>
																</li>
																 ...
																 <li>
																	...
																	<li><a href="../eb_solicitudes_central/tabla_solicitudes">Gestión de solicitudes</a></li>
																	<li><a href="../eb_historial/tabla_historial">Consulta de Solicitudes</a></li>
																		</ul>
																	</li>
																...
																<li>
																	...
																	<ul class="dropdown-menu">
																	<li><a href="../eb_agenda/tabla_agenda">Crear evento</a></li>
															
																		</ul>
																 </li>

																<li>
																	<a href="#" class="dropdown-toggle" data-toggle="dropdown">Almacen Central<b class="caret"></b></a>
																	<ul class="dropdown-menu">
																	<li><a href="../eb_almacen_central/tabla_almacen">Existencias</a></li>
																	<li><a href="../eb_almacen_central/tabla_almacen">Inventarios</a></li>
																...
																<li>
																	...
																	<ul class="dropdown-menu">
																	<li><a href="../eb_almacen_central/tabla_almacen">Control de existencias</a></li>
																	<li><a href="../eb_almacen_central/tabla_almacen">Inventarios fisicos</a></li>
																	<li><a href="../eb_almacen_central/tabla_almacen">Movimientos</a></li>
	 ...
	 <div class="container center" id="centro">
			<h2 align="center"> Bienvenido(a) <?php echo $_SESSION['nombre_completo']?> al sistema de control de inventarios
			</h2>
