                ...
                <nav class="navbar navbar-light" style="background-color: #e3f2fd; color: #fff;">
                    <div class="container-fluid">
                        <div class="navbar-header">
                          <a class="navbar-brand" href="menu_12.php"><i class="fa fa-home" aria-hidden="true"></i>    Inicio</a>
                        </div>
...
<!-- REPORTES  -->
                          <li>
                            ...
                            <ul class="dropdown-menu">
                              <li>
                                ...
                                <ul class="dropdown-menu">
                                    <li><a href="../pa_participaciones/lista_participa.php">Lista Participaciones</a></li>
                          ...
                          <li>
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                              <i class="fa fa-heartbeat" aria-hidden="true"></i>Consulta Externa<b class="caret"></b></a>

                            <ul class="dropdown-menu">
                              <li>
                                <a href="https://laboratoriosarca.com.mx/sysce/" target="_blank">Acceso</a>
                                </ul>
                              </li>
                            </ul>
                          </li>
