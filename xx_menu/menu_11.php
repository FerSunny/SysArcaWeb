                ...
                <nav class="navbar navbar-light" style="background-color: #e3f2fd; color: #fff;">
                    <div class="container-fluid">
                        <div class="navbar-header">
                          <a class="navbar-brand" href="menu_11.php"><i class="fa fa-home" aria-hidden="true"></i>    Inicio</a>
                        </div>
                          ...
                          -->
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a target='_blank' href='../op_maquila/maquila_unidades_lab.php?usuario=<?php echo $para?>'>Unidad (Laboratorio)</a></li>
                                    </ul>
                                </li>
                            ...
                            <li>
                             ...
                             <ul class="dropdown-menu" role="menu">
                                 ...
                                 <li><a href="../ag_orden_dia_ekg/tabla_agenda.php">Orden del Día (EKG)</a></li>
                                 <li><a href="../ag_orden_dia_colpo_4/tabla_colpo_papa.php">Orden del Día (COLPO/PPN - 4)</a></li>
                                 <li><a href="../ag_orden_dia_pacientes/tabla_p1"> <font color="blue" face="Comic Sans MS,arial,verdana">Orden del Día Pacientes </font> </a></li>
                             </ul>
...
<!-- GASTOS -->
                          ...
                          <li>
                              ...
                              <ul class="dropdown-menu" role="menu">
                                  <li><a href="../ga_beneficiarios/tabla_beneficia.php">Beneficiarios</a></li>
...
<!-- CIERRE  -->
                           <li>
                              <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">Cortes <span class="caret"></span></a>
                              <ul class="dropdown-menu" role="menu">
                          ...
                          -->
                            ...
                            <li>
                              ...
                              <ul class="dropdown-menu" role="menu">
                                  <li><a href="../eb_crear_unidad/tabla_solicitudes">Crear Solicitud</a></li>
                                  <li><a href="../eb_solicitudes_unidades/tabla_solicitudes">Solicitudes</a></li>
                                  <li><a href="../eb_almacen_unidades/tabla_almacen">Almacen Unidad</a></li>
                              </ul>
                            </li>
                            ...
                            <li>
                              ...
                              <ul class="dropdown-menu" role="menu">
                                  <li><a href="../reporte_resultados/tabla_reporte">Situación Resultados</a></li>
                              </ul>
                           </li>
