                          ...
                          <!-- notas -->
                            ...
                            <li>
                             ...
                             <ul class="dropdown-menu" role="menu">
                                ...
                                <li><a href="../ag_confirma_v2.0/tabla_validar"> <font color="red" face="Comic Sans MS,arial,verdana">Valida Resultados - V.2.0</font> </a></li>

                                <li><a href="../ag_confirma_interface/tabla_validar"> <font color="red" face="Comic Sans MS,arial,verdana">Valida Resultados Interfase</font> </a></li>
                                ...
                                <li><a href="../ag_confirma_v3.0/tabla_validar"> <font color="blue" face="Comic Sans MS,arial,verdana">Validar Resultados</font> </a></li>

                                <li><a href="../ag_orden_dia_pacientes/tabla_p1"> <font color="blue" face="Comic Sans MS,arial,verdana">Orden del Dia Pacientes </font> </a></li>
...
<!-- CIERRE-->
                           ...
                           <li>
                              ...
                              <ul class="dropdown-menu" role="menu">
                                  <li><a href="../eb_crear_solicitudes/tabla_solicitudes.php">Crear Solicitud</a></li>
                                  <li><a href="../eb_solicitudes/tabla_solicitudes.php">Solicitudes</a></li>
                                  <li><a href="../eb_almacen_central/tabla_almacen.php">Almacen Central</a></li>
                                  <li><a href="../eb_productos/tabla_productos.php">Productos</a></li>
                                  <li><a href="../eb_proveedores/tabla_proveedores.php">Proveedores</a></li>
                                  <li><a href="../eb_departamento/tabla_departamento.php">Departamento</a></li>
                                  <li><a href="../eb_categoria/tabla_categoria.php">Categoria</a></li>
                              </ul>
                           </li>
