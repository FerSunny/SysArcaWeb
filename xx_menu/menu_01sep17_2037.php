                            ...
                            <li>
                              ...
                              <ul class="dropdown-menu">
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li><a href="../cr_plantilla_1/tabla_plantilla_1.php">Grupo CVRMMUM</a></li>
                                        <li><a href="../cr_plantilla_2/tabla_plantilla_2.php">Grupo C</a></li>
                                        <li><a href="../cr_plantilla_cvr/tabla_plantilla_cvr.php">Grupo CVR</a></li>
                                        <li><a href="">Grupo Libre</a></li>
                                        <li><a href="">Grupo Cultivos</a></li>
                                    </ul>
                                </li>
