    ...
    <ul class="nav-menu">
      <li class="menu-has-children"><a href="">Administracion</a>
        <ul style="display:none">
          ...
          <li><a href="../se_menus/tabla_menus">Menus</a></li>
          <li><a href="../se_c_perfiles/tabla_perfiles">Crear Perfil</a></li>
        </ul>
      </li>
      ...
      <li class="menu-has-children"><a href=""> Rutas </a>
        <ul style="display:none">
        ...
        <ul style="display:none">
          ...
          <li class="menu-has-children"> <a> Participaciones </a> 
            <ul style="display:none">
              ...
              <li><a href="../pa_participaciones/lista_zona_tabla.php">Informes por zona</a></li>     
              <li><a href="../pa_participaciones/lista_individual_tabla.php">Informe Individual</a></li>
            </ul>
          </li>
          ...
          <li class="menu-has-children"> <a> Participaciones His </a> 
            <ul style="display:none">
              ...
              <li><a href="../pa_participaciones_his/lista_zona_tabla.php">Informes por zona</a></li>         
              <li><a href="../pa_participaciones_his/lista_individual_tabla.php">Informe Individual</a></li>
            </ul>
          </li>
      ...
      <li class="menu-has-children"><a href="">Almacén</a>
        <ul style="display:none">
          ...
          <li><a href="../eb_graficas/tabla_graficas">Balances</a></li>
      ...
      <li class="menu-has-children"><a href=""> Química Clínica </a>
        <ul style="display:none">
          <li><a href=""> Bitácora de carga </a></li>
          <li><a href=""> Interface de ingreso de estudios al equipo DIRUI CS-T240 </a></li>
          <li><a href=""> Interface de extracción de resultados al equipo DIRUI CS-T240 </a></li>
          <li><a href=""> Validación y/o corrección de resultados procesados </a></li>
          <li><a href=""> Bitácora de proceso </a></li>
          <li><a href=""> Interface de resultados al SYSARCAWEB </a></li>
          <li><a href=""> Actualización al monitor de muestras (resultados listos) </a></li>
        </ul>
      </li>
      <li class="menu-has-children"><a href=""> Contador </a>
        <ul style="display:none">
          <li><a href=""> Relacionar Nota – factura </a></li>
          <li><a href=""> Visualizar los datos del contribuyente </a></li>
          <li><a href=""> Reportes de resúmenes contables por periodo </a></li>
          <li><a href=""> Ingresos vs egresos por unidad </a></li>
          <li><a href=""> Detalles y acumulados </a></li>
        </ul>
      </li>
      <li class="menu-has-children"><a href=""> Visitador Médico </a>
        <ul style="display:none">
          <li><a href=""> Relacionar Nota – factura </a></li>
        </ul>
      </li>
      <li class="menu-has-children"><a href=""> Asietncia </a>
        <ul style="display:none">
          <li><a href=""> Relacionar Nota – factura </a></li>
        </ul>
      </li>
