						...
						<nav class="navbar navbar-light" style="background-color: #e3f2fd; color: #fff;">
							<div class="container-fluid">
								<div class="navbar-header">
									<a class="navbar-brand" href="menu_23"><i class="fa fa-home" aria-hidden="true"></i> Inicio</a>
								</div>
								<ul class="nav navbar-nav">
									<li>
										<li>
											<li>
												<li><a href="../se_asistencia/tabla_asistencia">Historial Asistencia</a></li>
											</li>
											<li>
												<li><a href="../se_reporte_asistencia/tabla_reporte">Reportes</a></li>
											</li>
										</li>
									</li>
								</ul>
