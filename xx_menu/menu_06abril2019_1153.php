                          ...
                          <!-- notas -->
                            ...
                            <li>
                             ...
                             <ul class="dropdown-menu" role="menu">
                                 ...
                                 <li><a href="../ag_orden_dia_usg/tabla_agenda.php">Orden del Dia (USG)</a></li>
                                 <!--
                                ...
                                <li><a href="../ag_confirma/tabla_validar.php">Valida Resultados</a></li> 
                                <li><a href="../ag_confirma_i/tabla_validar.php">Interfase</a></li> 
                                <li><a href=""> <font color="red" face="Comic Sans MS,arial,verdana">Valida Resultados - V.2.0</a> </font> </li>

                                <li><a href=""> <font color="red" face="Comic Sans MS,arial,verdana"> Orden del Dia (P1) - V.5.3 </font> </a></li>

                                <li><a href=""> <font color="red" face="Comic Sans MS,arial,verdana">Orden del Dia (P1) - NVO - V.1.3 </font> </a></li>
