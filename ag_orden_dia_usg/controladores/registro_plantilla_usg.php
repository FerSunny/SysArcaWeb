...
$nombre_plantilla=$_POST["fn_nombre_plantilla"];
$titulo_desc=$_POST["fn_titulo_desc"];
...
$sql_max="SELECT  us.* FROM cr_plantilla_usg us WHERE id_plantilla=".$fn_id_plantilla;
// echo $sql_max;
$veces='0';
...
$query= "INSERT INTO cr_plantilla_usg_re
            (fk_id_empresa,
             fk_id_medico,
             fk_id_plantilla,
             fk_id_factura,
