            ...
            <div class="col">
              <div class="md-form mt-0">
                ...
                <select name="especialidad" id="fi_especialidad" class="form-control">
                    <?php
                      $sql="SELECT * FROM km_especialidades where estado = 'S'";
                      $rec=mysqli_query($conexion,$sql);
                      while ($row=mysqli_fetch_array($rec))
                        {
            ...
            <div class="col">
              <div class="md-form mt-0">
                ...
                <select name="Estado" id="fi_estado"  class="form-control">
                    <?php
                      $sql="SELECT * FROM ku_estados where estado = 'S'";
                      $rec=mysqli_query($conexion,$sql);
                      while ($row=mysqli_fetch_array($rec))
                        {
              ...
              <div class="md-form mt-0">
                ...
                Visitador Médico   
                  <select  name="fn_visitador" id="fi_visitador"  class="form-control">
                    ...
                    <?php
                      $sql=" SELECT id_usuario, CONCAT(nombre, ' ', a_paterno, ' ', a_materno)AS nombre FROM se_usuarios WHERE fk_id_perfil in (12,42) AND activo = 'S'";
                      $rec=mysqli_query($conexion,$sql);
                      while ($row=mysqli_fetch_array($rec))
                        {
            ...
            <div class="col">
              <div class="md-form mt-0">
                ...
                <select name="fn_sucursal" id="fi_sucursal" class="form-control">
                    <?php
                      $sql="SELECT * FROM kg_sucursales where estado = 'S'";
                      $rec=mysqli_query($conexion,$sql);
                      while ($row=mysqli_fetch_array($rec))
                        {
        ...
        <div style="color:#000000;background:#EFFBF5" class="modal-body">
          ...
          <div class="row">
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  Nombre
                  <input type="text" required name="fn_nombre" id="fi_nombre" maxlength="35" readonly= "true" class="form-control">
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  A. Paterno
                  <input type="text" required name="fn_apaterno" id="fi_apaterno" maxlength="35" readonly= "true" class="form-control">
                </div>
              </div>
            </div>
            ...
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  A. Materno
                  <input type="text" required name="fn_amaterno" id="fi_amaterno" maxlength="35" readonly= "true" class="form-control ">
                </div>
              </div>
            </div>
          </div>
            ...
            <div class="col">
              <div class="md-form mt-0">
                ...
                <select name="movi" id="movi" class="form-control">
                    <?php
                      $sql="SELECT * FROM kg_tipo_baja where estado = 'A'";
                      $rec=mysqli_query($conexion,$sql);
                      while ($row=mysqli_fetch_array($rec))
                        {
                          echo "<option value='".$row['id_tipo_baja']."' >";
                          echo $row['desc_tipo'];
                          echo "</option>";
                        }
                    ?>
            ...
            <div class="col">
              <div class="md-form mt-0">
                ...
                <select name="motivo" id="motivo" class="form-control">
                    <?php
                      $sql="SELECT * FROM kg_motivo_baja where estado = 'A'";
                      $rec=mysqli_query($conexion,$sql);
                      while ($row=mysqli_fetch_array($rec))
                        {
                          echo "<option value='".$row['id_motivo']."' >";
                          echo $row['desc_motivo'];
                          echo "</option>";
                        }
                    ?>
                  </select>
          ...
          <div class="row">
            <div class="col">
              <div class="md-form mt-0">
                <div class="md-form">
                  Descripcion detallada del movimiento
                  <textarea class="form-control" name="fn_mbaja" id="fi_mbaja" rows="1"></textarea>
