...

					{
						render:function(data,type,row){
							...
							if(baja == '0' || baja == '' ){
								...
								return "<button  type='button' disabled class='editar btn btn-primary' data-toggle='modal' data-target='#modalEditar'><i class='fa fa-edit'></i></button>"
							}
...
/*
					{
						render:function(data,type,row){
							...
							{
								return "<button type='button' disabled=true class='eliminar btn btn-danger' data-toggle='modal' data-target='#modalEliminar' ><i class='fa fa-trash-alt'></i></button>"
							}
