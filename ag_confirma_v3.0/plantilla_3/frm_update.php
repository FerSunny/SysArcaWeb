...
<html lang="en">
  <head>
    ...
    <!-- Required meta tags -->
    <title>Editar Resultados Plantilla 3</title>
    <meta charset="utf-8">
            ...
            <tbody>
              <?php
                $query="SELECT  p2.orden,
                        ...
                        WHERE fk_id_estudio = ".$fk_estudio." AND estado ='A' AND tipo = 'P'
                      ORDER BY orden";
              ...
              <tr>
                ...
                <td>
                  <input class="form-control" type="text" required name="fn_resultado" id="fi_resultado<?php echo $i?>" maxlength="800" size="40" placeholder="Escriba el valor"/>
                </td>
                <td></td>
              </tr>
            <?php } }?>
