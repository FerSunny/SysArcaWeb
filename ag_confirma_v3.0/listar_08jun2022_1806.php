...
AND DATE(fa.fecha_factura) BETWEEN DATE_SUB(CURDATE(), INTERVAL 30 DAY) AND DATE_ADD(CURDATE(), INTERVAL 25 DAY)
AND fa.fk_id_sucursal$condicion
...
AND DATE(fa.fecha_factura) BETWEEN DATE_SUB(CURDATE(), INTERVAL 35 DAY) AND DATE_ADD(CURDATE(), INTERVAL 35 DAY)
AND fa.fk_id_sucursal$condicion");
