            ...
            <div class="card-body table-responsive">
                ...
                <input type="hidden" name="id_estudio" id="id_estudio" value="<?php echo $_GET['estudio']; ?>">
                    <table id="t_plantilla2" class="table table-bordered table-hover" cellspacing="1" width="100%">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input style="color:red;font-weight: bold;" class="form-control" type="text" required name="fn_verificado" id="fi_verificado<?php echo $i?>" maxlength="3" size="3" placeholder="*"/>
                                </td>
                            </tr>
                            <?php
                                    }
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control" id="observaciones" rows="1" maxlength="200" size="200" ></textarea>
                    </div>
                    <?php
                        if($i>0)
                        { ?>
