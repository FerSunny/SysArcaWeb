        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h4 class="modal-title" id="modalEliminarLabel">Editar Tipo de Servicio</h4>
            </div>
            <div class="modal-body">
                ...
                <input type="hidden" id="opcion" name="opcion" value="modificar">
                    <div class="form-group">
                      ...
                      <div class="col-sm-8"><input id="servicio" name="servicio" maxkength="50" required type="text" class="form-control" ></div>
                    </div>
