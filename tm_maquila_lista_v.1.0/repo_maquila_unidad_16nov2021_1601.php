...
// Cabecera de página
  function Header()
  {
    ...
    global $sucursal;
      ...
      $this->Cell(120,10,'ECSB-F001',0,0,'R');
      $this->Ln(10);
...
FROM tm_tomas tm, so_factura fa, so_clientes cl, km_estudios es, km_muestras mu, kg_sucursales su, so_medicos me
...
-- AND tm.fk_id_usuario ='".$id_usuario."'
 AND DATE(tm.fecha_toma) = CURDATE()
