 ...
 if ($row = mysqli_fetch_array($result)) 
 {
	...
	}else
	{
		$query ="INSERT INTO eb_departamento
            (fk_id_empresa,fk_id_sucursal,desc_departamento,descripcion,responsable,fk_sucursal,fecha_registro,fecha_actualizacion)
		VALUES (1,'$sucursal','$depto','$descrip','$respon','$suc','$fecha_registro','$fecha_actualizacion')";
