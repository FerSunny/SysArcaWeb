...
$stmt = $conexion->prepare("SELECT sol.id_solicitud,pt.desc_producto,pro.razon_social,sol.cantidad,pt.costo_total,sol.fk_id_sucursal,sol.fk_id_producto,sol.fk_id_proveedor,sol.cantidad,
