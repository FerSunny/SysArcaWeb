...
{
	$query = "UPDATE eb_almacen_central SET existencias = $cantidad, fecha_actualizacion = NOW()
...
{
	$query = "INSERT INTO eb_almacen_central (															fk_id_empresa,fk_id_sucursal,fk_id_producto,fk_id_proveedor,existencias,min,max,fecha_actualizacion,estado)
