...
// se incluye la fecha-Hora de impresion del resultado
    ...
    $sql="INSERT INTO cr_plantilla_1_re(fk_id_empresa,fk_id_factura,fk_id_estudio,orden,tipo,concepto,valor,verificado,valor_refe,unidad_medida,observaciones,num_imp,tamfue,tipfue,posini,fecha_registro,fecha_impresion) VALUES (1,'$id_factura','$id_studio','$orden','$tipo','$concepto','$resultado','$verificado','$valor_refe','$unidad_medida','$observaciones',0,'$tamfue','$tipfue','$posini','$fecha_registro', null )";
    //echo $sql;
