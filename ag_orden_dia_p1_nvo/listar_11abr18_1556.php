...
LEFT OUTER JOIN cr_plantilla_1_re p2 ON (p2.fk_id_factura = res.id_factura AND p2.fk_id_estudio = res.fk_id_estudio)
  UNION
...
LEFT OUTER JOIN cr_plantilla_1_re p2 ON (p2.fk_id_factura = df.id_factura AND p2.fk_id_estudio = df.fk_id_estudio),
km_estudios es
