...
*/
        if($studio=='274' or $studio =='467' or $studio =='215'){
          $justifica='C';
        }else{
          $justifica='R';
        }

        if($row['tipo']=='P' && strlen($row['valor_solo'])==0 and ($studio=='274' or $studio=='151' or $studio=='152' or $studio=='153' or $studio=='904' or $studio=='905' or $studio=='494' or $studio=='279' or $studio=='395' or $studio=='117' or $studio=='525' or $studio=='527' or $studio=='528' or $studio=='526')){
            $nle+=1;
            $nle-=1;
        }else{
             // $this->ln(5)
