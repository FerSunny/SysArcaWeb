				...
				"columns":[
...

					{
						render:function(data,type,row){
							...
							"<a id='printer' target='_blank'  href='./tabla_numeral_2.php?id_doc="+row['id_doc']+"&id_numeral_1="+row['num_version']+"&desc_numeral_1="+row['desc_doc']+"' class='btn btn-success btn-md'  role='button'><span class='fas fa-file' style='color: white;'></span></a>"+
							"</form-group>";
