...
<head>
  ...
  <title>Cotizaciones</title> <!-- CAMBIO  Titulo de la forma -->
...
<body background="../imagenes/logo_arca_sys_web.jpg">
  ...
  <div class="container" style="margin-top: 30px;">
    ...
    <h1 style="text-align: center;">Tabla de Cotizaciones  <!-- CAMBIO Se cambia el titulo de la tabla -->
<!--
