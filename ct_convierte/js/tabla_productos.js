			...
			var table = $("#dt_productos").DataTable({
				...
				"columns":[
...

					{
						...
						{
							var numero_factura = row['numero_factura']
...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #importe").val(data.imp_total)

				$("#frmedit  #pago").val(data.imp_total)

				$("#frmedit  #sucursal").val(data.fk_id_sucursal)

				$("#frmedit  #tpago").val(data.fk_id_tipo_pago)

				$("#frmedit  #comision").val(data.afecta_comision)




				$("#frmedit  #ffactura").val(data.fecha_factura)
