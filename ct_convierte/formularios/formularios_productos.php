						...
						<div class="row"><br>
							...
							<div class="col-9">
								...
								<div class="md-form mt-0">
									...
									<select class="form-control form-control-sm" name="vendedor" readonly disabled  

									id="vendedor" required>

										<option value="" disabled class="z-depth-5">Seleccione</option>

											<?php 

													$query = $conexion -> query("SELECT u.*,
							...
							<div class="col">
								...
								<div class="md-form mt-0">
									...
									<div class="md-form">
										...
										<input type="number" name="importe" id="importe" class="form-control" value="0" step="0.01" readonly required>

										<label for="utilidad">Importe</label>
							...
							<div class="col">
								...
								<div class="md-form mt-0">
									...
									<div class="md-form">
										...
										<input type="number" name="pago" id="pago" class="form-control" step="0.000000000001" required>

										<label for="c_total" id="lbl_total">Su pago</label>
						...
						<div class="row"><br>
							...
							<div class="col">
								...
								<div class="md-form mt-4">
									...
									<label for="">Sucursal que atiende</label>
									...
									id="sucursal" required>
										...
										<option value="" class="z-depth-5">Seleccione</option>
											...
											<?php 
													...
													$query = $conexion -> query("SELECT s.*
																		FROM kg_sucursales s
																		WHERE s.`estado` = 'A'");
						...
						<div class="row"><br>
							...
							<div class="col-9">
								...
								<div class="md-form mt-0">
									...
									<select class="form-control form-control-sm" name="tpago" 
									...
									id="tpago" required>
										...
										<option value="" class="z-depth-5">Seleccione</option>
											...
											<?php 
													...
													$query = $conexion -> query("SELECT p.* FROM kg_tipo_pago p
																					WHERE p.`estado` = 'A'");
...

													{
															...
															echo "<option value =".$res['id_tipo_pago'].">
						...
						<div class="row"><br>
							...
							<div class="col-9">
								...
								<div class="md-form mt-0">
		                            ...
		                            <select class='form-control form-control-sm' id="comision" name="comision">
						...
						<div class="col">
							...
							<div class="md-form mt-0">
								...
								<div class="md-form">
									...
									<input type="datetime-local" name="fentrega" id="fentrega" class="form-control"  required>

									<label for="producto">Fecha Entrega</label>
