...
orden,
concepto,
concat(LPAD(trim(valor),15,' '),' ',unidad_medida,verificado) as valor,
concat(unidad_medida,verificado) as unidad_medida,
verificado,
observaciones,
CASE
  WHEN fk_id_estudio in (274,963,988,69,459,1029,49) THEN
        CONCAT(valor_refe) 
  ELSE
  ...
  WHERE p2.fk_id_estudio =".$studio." AND p2.estado = 'A' AND p2.tipo IN ('V','T','B','P')) ORDER BY orden";
