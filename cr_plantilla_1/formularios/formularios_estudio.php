  ...
  <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        <div class="modal-header">
            <h2 style="color: blue; margin-left: auto; text-align: center;">Nuevo Estudio<br><small style="font-size: 14px">Registro de estudio</small></h2>
...
-->
              <!-- interface
              <tr>
                  <td class="renglon_titulo">Interface: </td>
                  <td class="renglon_valor" class="form-control">
...
-->
              ...
              <tr>
                  ...
                  <td class="renglon_valor" class="form-control">
                        <input type="text"  name="fn_concepto" id="fi_concepto" maxlength="80" size="50" placeholder="Concepto"/>
                  </td> 
              </tr>
-->
              <!-- vr_minimo
