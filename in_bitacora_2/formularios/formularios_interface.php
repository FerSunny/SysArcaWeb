...
<div class="modal fade" id="myModals" role="dialog">
  <div class="modal-dialog">
      ...
      <!-- Modal content-->
   <form name="AltasMedico" action="controladores/registro_interface.php" method="post">
      <div class="modal-content">
        <div class="modal-header">
          <button type="button" class="close" data-dismiss="modal">&times;</button>
          <h2 style="color:blue;text-align:center" class="modal-title">Nuevo proceso</h2>
          <h5 style="color:blue;text-align:center" class="modal-title">Datos de proceso</h5>
        </div>
        <div style="color:#000000;background:#EFFBF5" class="modal-body">
          <table border="0" align="center" BGCOLOR=#F5FBEF style="border-bottom:1px solid #819FF7">
              <!-- Id proceso -->
              <tr>
                <td class="renglon_titulo"> Id proceso: </td>
                <td class="renglon_valor" class="form-control" >
                    <input type="text" name="fn_id_proceso" id="fi_id_proceso" readonly="readonly" maxlength="12" size="19" placeholder="Asignado por el sistema"/>
                </td>
              </tr>

              <!-- Fecha de alta -->
              <tr>
                  <td class="renglon_titulo">Pat rack: </td>
                  <td class="renglon_valor" class="form-control">
                        <input type="number" required name="fn_pat_disk" id="fi_pat_disk" maxlength="1" size="1" placeholder="Rack"/>
                  </td> 
              </tr>

              <!-- Fecha de actualización -->
              <tr>
                  <td class="renglon_titulo">Fecha test: </td>
                  <td class="renglon_valor" class="form-control">
                        <!--<input type="text" readonly="readonly" disabled  value="<?php //echo $FechaHoy;?>" name="fn_fproceso" id="fi_fproceso" maxlength="15" size="20" placeholder="Fecha proceso"/>
                        -->

                        <input type="date" required name="fn_ftest" id="fi_ftest" maxlength="15" size="20" placeholder="Fecha test"/>
                  </td> 
              </tr>
              ...
              <!-- folio -->
              <tr>
                  <td class="renglon_titulo">Folio Nota:</td>
                  <td class="renglon_valor" class="form-control">
                      <input type="text" required name="fn_folio" id="fi_folio" maxlength="10" size="10" placeholder="Folio"/>
                   </td>
              </tr>
              ...
              <tr>
                ...
                <td class="renglon_valor" class="form-control">
                  <select name="fn_estudio" id="fi_estudio">
                    <?php
                      $sql="SELECT * FROM km_estudios where estatus = 'A' and origen = 'I'";
        ...
        <div class="modal-dialog" role="document">
          <div class="modal-content">
            <div class="modal-header">
              ...
              <h2 style="color:blue;text-align:center" class="modal-title" id="modalEliminarLabel">Editar Medicos</h2>
              <h5 style="color:blue;text-align:center" class="modal-title">Datos Generales</h5>
            </div>
            <!-- INICIA EL BODY -->
            <div style="color:#000000;background:#EFFBF5" class="modal-body">
             <input type="hidden" id="idmedico" name="idmedico" value="0">
             ...
             <table border="0" align="center" BGCOLOR=#F5FBEF style="border-bottom:1px solid #819FF7">
              ...
              <tr>
                ...
                <td class="renglon_valor" class="form-control">
                  <select name="especialidad" id="fi_especialidad">
                    <?php
              ...
              <tr>
                ...
                <td class="renglon_valor" class="form-control">
                  <select name="Estado_fed" id="fi_estado_fed">
                    <?php
              ...
              <tr>
                ...
                <td class="renglon_valor" class="form-control">
                  <select name="Municipio" id="fi_municipio">
                    <?php
              ...
              <tr>
                ...
                <td class="renglon_valor" class="form-control">
                  <select name="Localidad" id="fi_localidad">
                    <?php
...
ORDER BY desc_localidad";
              ...
              <tr>
                <td>Adscrito:</td>
                <td>
                    <select class="" id="fi_adscrito" name="adscrito" id="fi_estado">
