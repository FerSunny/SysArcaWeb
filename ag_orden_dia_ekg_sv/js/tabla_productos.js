...
var editar = function(tbody, table) {
...

		{
				...
				$("#frmedit  #id_signos").val(data.id_signos)
				$("#frmedit  #fk_id_estudio").val(data.fk_id_estudio)
				$("#frmedit  #fk_id_usuario").val(data.fk_id_usuario)

				$("#frmedit  #id_medico").val(data.fk_id_medico)

				
				
				$("#frmedit  #folio").val(data.id_factura)

				$("#frmedit  #fecha").val(data.fecha)

				$("#frmedit  #peso").val(data.peso)

				$("#frmedit  #talla").val(data.talla)

				$("#frmedit  #diabetes").val(data.diabetes)

				$("#frmedit  #dislpemia").val(data.dislpemia)

				$("#frmedit  #hipertension").val(data.hipertension)

				$("#frmedit  #infartos").val(data.infartos)

				$("#frmedit  #angina").val(data.angina_pecho)

				$("#frmedit  #palpitaciones").val(data.palpitaciones)

				$("#frmedit  #dolor").val(data.dolor)

				$("#frmedit  #fuma").val(data.fuma)

				$("#frmedit  #alcohol").val(data.alcohol)
		...
		$(tbody).on("click", "button.eliminar", function() {
			...
			swalWithBootstrapButtons({
				...
				if (result.value) {
					 ...
					 $.post("./controladores/eliminar.php", {'id_signos' : data.id_signos}  , function(data,status)
